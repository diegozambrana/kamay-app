# Graph Report - kamay-app  (2026-09-17)

## Corpus Check
- 1348 files · ~1,359,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12156 nodes · 20255 edges · 904 communities (876 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1abbf5f9`
...
4. `getOwnerContext()` - 84 edges
5. `Input()` - 64 edges
6. `RENDER` - 59 edges
7. `Redirect` - 54 edges
8. `BusinessLine` - 47 edges
9. `Badge()` - 42 edges
10. `test` - 38 edges
...
- `setState()` --calls--> `useSearchReset()`  [INFERRED]
  specs/design/# Kamay, gestión operativa/support.js → hooks/use-filter-state.ts
...
- `renderSection()` --calls--> `RENDER`  [INFERRED]
  features/settings/statuses/statuses-section.test.tsx → lib/monitoring/instrumentation.test.ts

## Communities (904 total, 28 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (125): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), useSignOut(), UserMenu(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn (+117 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (89): ProfileForm(), relatedTasksFor(), HistoryEntry(), RecordHistory, ACTION_LABELS, AssetDetailsForm(), FormValues, schema (+81 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (86): estado, Redirect, selectBusinessLine(), loadRecordHistory(), NotFound(), AssetsPage(), metadata, getSessionContext() (+78 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (109): a(), B(), D(), g(), i(), k(), Q(), y() (+101 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (83): unarchiveFromEvent(), ActivityRow(), ActivityRowItem, Detail(), ORIGIN_LABELS, EventDetail, UnarchiveFromEvent(), isUnarchivable() (+75 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (82): assetDetailsSchema, LINE_COLOR_LABELS, ContactFieldValues, TaskFields(), TaskFieldsProps, assignees, lines, onSave (+74 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (76): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createItemCategory(), createSalesChannel(), createUnit(), entities (+68 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (62): FormValues, schema, ActionResult, ACTION_LABELS, ActivityFiltersProps, FilterOption, METHOD_LABELS, InviteDialog() (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (53): itemVariantFormSchema, VariantFormDialog(), ContactFields(), ClosingDialogProps, EntryState, useOnlineStatus(), useReturnFocus(), ConsumptionDialog() (+45 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (61): ActivityFilterBar(), ActivityDay, ActivityList(), ActivityPage, ActivityService, decodeCursor(), encodeCursor(), RecentActivityEntry (+53 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (5): ProfileError(), RouteError(), RouteErrorProps, SectionError(), SectionErrorProps

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (58): DeclarableAsset, DeclareAssetDialog(), LoginForm(), ContactCombobox(), CustomerPickerDialog(), CostForm(), occurredAtForDate(), lineIssuesOf() (+50 more)
...
Cohesion: 0.05
Nodes (69): 10. Inventario, 11. Vistas derivadas, 12. Tareas, 13. Adjuntos, 14. Bitácora de actividad, 15. Notificaciones, 16. Seguridad a nivel de fila (RLS), 17. Sincronización sin conexión (+61 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (45): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, resolveSearch(), AllocationRuleService, CsvContext (+37 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (39): ActivityListProps, ItemPhotos(), DataTableProps, FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), formatFileSize() (+31 more)
...
Cohesion: 0.05
Nodes (44): ChangePair, DETAIL_MARKERS, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds(), RenderContext (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (41): TasksScreen(), CATALOG_FILTERS, CatalogScreen(), ITEM_KIND_FIELDS, ItemFormDialog(), ItemForm(), ITEM_CATEGORY_COPY, ITEM_KIND_COPY (+33 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (38): client, [payload], primero, segundo, client, update, client, patch (+30 more)
...
Cohesion: 0.05
Nodes (47): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: A rejected submission keeps the dialog open, Requirement: Archived entries are listed in their own table, Requirement: Configuration lists are tables with a row actions menu, Requirement: Creating a configuration entry happens in a dialog, Requirement: Dialogs return focus to what opened them (+39 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (44): ADDED Requirements, MODIFIED Requirements, project-foundation Specification, project-foundation Specification (delta), Purpose, REMOVED Requirements, Requirement: Application boots to sign-in with theme switching in the shell, Requirement: Application shell boots with theme switching (+36 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (31): AppShell(), AppSidebar(), Header(), AVISO, bell, menu, renderHeader(), MobileContextBar() (+23 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (37): activity, bell, box, button, comparison, deliveries, dialogo, fab (+29 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (36): ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock(), DirectSaleInput, consumptionSchema (+28 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (35): admin, casos, CREDENCIALES, filtrosVacios, ids, inicio, owner, plan (+27 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (30): signOutButton, errors, match, form, more, rows, bar, copy (+22 more)
...
Cohesion: 0.05
Nodes (26): aviso, compartido, detalle, evento, fila, filas, form, nombre (+18 more)
...
Cohesion: 0.07
Nodes (23): filas, catalogo, clientes, detalle, filas, medida, opciones, archivar (+15 more)
...
Cohesion: 0.06
Nodes (29): registerDirectSale(), RegisterDirectSaleResult, BestSellerRow, FairProduct, FairSaleService, ProductRow, captureSale, channels (+21 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (20): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), NO_MONEY, OrderFilters, OrderRow, OrderService (+12 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (35): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+27 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (26): AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema, selectOrganization(), updatePassword() (+18 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (28): first, row, chunks, csv, download, link, section, started (+20 more)

### Community 45 - "Community 45"
Cohesion: 0.09
Nodes (19): comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon } (+11 more)
...
Cohesion: 0.08
Nodes (28): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), paymentErrorMessage(), entry (+20 more)

### Community 48 - "Community 48"
Cohesion: 0.13
Nodes (30): addAccountByEmail(), AddUserResult, addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue(), inviteToOrganization() (+22 more)
...
Cohesion: 0.12
Nodes (29): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue(), revalidateOrders(), setArchived() (+21 more)

### Community 53 - "Community 53"
Cohesion: 0.12
Nodes (22): RetentionJobDeps, emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron() (+14 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (31): archiveTask(), attachmentIdSchema, closeTaskSchema, closeTaskWithDeliverables(), closingEntrySchema, completeTask(), completeTaskSchema, createTask() (+23 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (21): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), DEFAULT_PREFERENCES, PreferencesRow (+13 more)

### Community 56 - "Community 56"
Cohesion: 0.1
Nodes (18): EmailMessage, FailingMailer, Mailer, MemoryMailer, emailFor(), escape(), html(), DESTINATARIO (+10 more)
...
Cohesion: 0.13
Nodes (16): ActivityLayout(), ClientOrigin, originFromUserAgent(), RootPage(), defaultLandingPath(), isMobileUserAgent(), isProtectedPath(), PROTECTED_PREFIXES (+8 more)

### Community 62 - "Community 62"
Cohesion: 0.1
Nodes (26): MobileNav(), barra, block, mas, panel, pathname, renderNav(), barHrefOf() (+18 more)

### Community 63 - "Community 63"
Cohesion: 0.13
Nodes (19): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, renderPanel(), uno (+11 more)

### Community 64 - "Community 64"
Cohesion: 0.11
Nodes (17): { result }, signOut(), countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items (+9 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (23): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+15 more)
...
Cohesion: 0.07
Nodes (16): aviso, cola, despues, enEspera, enProceso, filas, noCola, porCobrar (+8 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (15): UserDetailPage(), client, row, service, UserAdminService, UserListFilters, UserRow, activeMemberships() (+7 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (23): renderMenu(), renderScreen(), task(), item(), renderDetail(), renderWithCategories(), renderOwner(), declareDeliverable (+15 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (22): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, memberLinesSchema (+14 more)
...
Cohesion: 0.12
Nodes (14): CatalogScope, ContactScope, joinsCatalogWindow(), joinsContactWindow(), all, archived, conCategoria, CONTACT (+6 more)
...
Cohesion: 0.13
Nodes (22): ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps, closesWithoutDeliverables(), declarableTypes(), Deliverable, DELIVERABLE_DEFINITIONS, DELIVERABLE_TYPES (+14 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (19): OrderFormState, antes, CHANNELS, CLIENTA, { container, user }, defaults(), field, file (+11 more)
...
Cohesion: 0.1
Nodes (21): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Desarchivar devuelve el registro intacto, Requirement: El catálogo no almacena nada derivado, Requirement: La búsqueda por nombre tolera acentos y mayúsculas (+13 more)
...
Cohesion: 0.1
Nodes (23): id, MoveOrderInput, moveOrderSchema, numeric, optionalDeliveryMode, optionalDueDate, optionalId, optionalText (+15 more)
...
Cohesion: 0.09
Nodes (15): OrganizationList(), organizations, renderList(), rows, search, table, MembershipEmbed, OrganizationAdminService (+7 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (18): barPercent(), comparisonScale(), LineCashFlow, NO_CASH_FLOW, ALFARERIA, flows, rows, scale (+10 more)
...
Cohesion: 0.2
Nodes (12): AccountLayout(), NoOrganizationNotice(), AppLayout(), getRequestAccess, getRequestMemberships, getRequestPlatformAdmin, getRequestUser, FairLayout() (+4 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (16): linkTask(), searchLinkTargets(), unlinkTask(), LinkSearch(), LinkSearchProps, buscar(), linkTask, onLinked (+8 more)
...
Cohesion: 0.15
Nodes (17): AssetCard(), LineBadge(), AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetRowView, RecoveryBar(), mark (+9 more)
...
Cohesion: 0.1
Nodes (12): InvitationRow, InvitationService, MembershipRow, client, failing, input, invitationRow, [payload] (+4 more)
...
Cohesion: 0.14
Nodes (17): plan, RUN, sinCorreo, summaries, tasks, adminClient(), countNotifications(), serviceRoleKey() (+9 more)

### Community 109 - "Community 109"
Cohesion: 0.12
Nodes (11): itemKindSchema, archive(), list(), listActive(), listAll(), patch(), unarchive(), ItemCategoryRow (+3 more)

### Community 110 - "Community 110"
Cohesion: 0.1
Nodes (7): MODIFIED Requirements, Requirement: Adjuntos del pedido, Scenario: Adjuntar sin conexión, Scenario: Alta con imagen de referencia, Scenario: Archivo demasiado pesado, Scenario: La subida falla pero el pedido queda, Scenario: Quitar un adjunto desde la edición
...
Cohesion: 0.14
Nodes (14): ProfileView, ROLE_LABELS, organization, view, AccessInput, AccessResolution, ActiveAccess, resolveAccess() (+6 more)
...
Cohesion: 0.1
Nodes (10): count, duraciones, enlaces, gestos, inicio, primera, primeras, productos (+2 more)
...
Cohesion: 0.11
Nodes (14): ADDED Requirements, Purpose, Requirement: Entradas al alta y a la edición, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: Cantidad no positiva (+6 more)

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Las consultas de ingresos incluyen las ventas directas, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: El cobrado también suma, Scenario: El orden persiste (+11 more)

### Community 121 - "Community 121"
Cohesion: 0.1
Nodes (20): Requirement: Aislamiento, roles y archivado de pedidos, Requirement: Edición de pedido, Scenario: Cambiar fecha y agregar una línea, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita (+12 more)
...
Cohesion: 0.13
Nodes (16): VariantRow, contactEmail, ContactFormValues, hasARole(), itemFieldsSchema, itemFormSchema, ItemFormValues, ItemVariantFormValues (+8 more)
...
Cohesion: 0.11
Nodes (18): Context, D10 · Índices, y medir antes de añadir más, D1 · El periodo se resuelve una vez, en el servidor, y viaja en la dirección, D2 · Los agregados son funciones SQL con parámetros, no vistas, D3 · El recorte al dueño va dentro de cada función, D4 · La agregación en SQL, el reparto en TypeScript, D5 · El redondeo se cierra por resto mayor, D6 · El costo de materiales sale de los egresos asignados, y su ausencia se declara (+10 more)

### Community 133 - "Community 133"
Cohesion: 0.11
Nodes (18): Context, D10 · La tarjeta de insumos bajo mínimo hereda la ranura del marcador, y con ella muere el componente de marcador, D10 · La tarjeta de insumos bajo mínimo hereda la ranura del marcador y las dos composiciones, D11 · El distintivo del catálogo es binario, y la cifra vive en el detalle, D1 · La entrada automática es un trigger sobre `expense_items`, no una rama de `create_expense`, D2 · La idempotencia la impone el índice único; el trigger absorbe el conflicto, D3 · La inmutabilidad es un privilegio que no se concede, no un trigger que la vigila, D4 · La vista `item_balances` se crea literalmente como la define el esquema (+10 more)
...
Cohesion: 0.12
Nodes (7): NotificationRow, NotificationService, client, groups, [payload], [rows, options], NOTIFICATION_TYPES

### Community 136 - "Community 136"
Cohesion: 0.15
Nodes (12): ChartDatum, ReportChartImpl, ChartConfig, ChartContainer(), ChartContext, ChartContextProps, ChartLegendContent(), ChartTooltipContent() (+4 more)

### Community 137 - "Community 137"
Cohesion: 0.16
Nodes (3): ProfileLoading(), RouteLoadingProps, CardsSkeleton()

### Community 138 - "Community 138"
Cohesion: 0.15
Nodes (15): ActionResult, UNARCHIVERS, unarchiveSchema, ActionResult, archiveSchema, ContactResult, createContact(), createContactInline() (+7 more)
...
Cohesion: 0.13
Nodes (14): Administradores de la plataforma (KAM-26), Agendada con el Cron de Vercel (KAM-23), Cómo auditar una tabla nueva, code:sql (select vault.create_secret('https://<dominio de producción>'), code:sql (select status, return_message, start_time), code:bash (curl -fsS -H "Authorization: Bearer $CRON_SECRET" https://<d), code:bash (# Nombrar (crea la cuenta si no existe, con la contraseña de), El resumen diario lo agenda Supabase Cron (KAM-23) (+6 more)
...
Cohesion: 0.14
Nodes (12): SETTINGS_SECTIONS, SettingsGroup, SettingsNav(), SettingsSection, abiertas, enDisco, enMenu, layout (+4 more)

### Community 172 - "Community 172"
Cohesion: 0.18
Nodes (12): Row, EXCLUDED_COLUMNS, EXCLUDED_TABLES, EXPORT_TABLES, ExportTable, catalog, catalogTables(), expected (+4 more)
...
Cohesion: 0.12
Nodes (16): Requirement: Líneas desde el catálogo con precio prellenado y editable, Scenario: Acciones al final de las líneas, Scenario: Agregar deshabilitado sin selección, Scenario: Cancelar descarta la selección, Scenario: El filtro conserva lo marcado, Scenario: El filtro ignora acentos y mayúsculas, Scenario: El filtro ignora acentos y mayúsculas, Scenario: El precio editado es el que se guarda (+8 more)
...
Cohesion: 0.17
Nodes (3): RouteLoading(), BoardSkeleton(), DetailSkeleton()
...
Cohesion: 0.27
Nodes (10): AssistantDashboardProps, LowStockCard(), LowStockItem, PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard() (+2 more)
...
Cohesion: 0.15
Nodes (11): ExpenseCard(), ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpenseWithTotal, EXPENSE_FILTERS (+3 more)
...
Cohesion: 0.19
Nodes (7): balanceFromRow(), BalanceRow, movementFromRow(), MovementRow, MovementService, toNullableNumber(), toNumber()
...
Cohesion: 0.15
Nodes (11): teamOf(), actions, dialog, duena, ex, [first, second], [member], organization (+3 more)

### Community 236 - "Community 236"
Cohesion: 0.18
Nodes (10): ScopeItem, shortfallRatio(), sortByUrgency(), balances, critico, holgado, huerfano, items (+2 more)
...
Cohesion: 0.15
Nodes (12): expenses Specification, Requirement: Egresos solo en el menú del dueño y redirección por dirección directa, Requirement: Semilla de egresos de Geeko Store, Requirement: Una compra necesita al menos una línea, Requirements, Scenario: Ayudante por dirección directa, Scenario: Guardado atómico, Scenario: Intento contra la operación de guardado (+4 more)
...
Cohesion: 0.24
Nodes (9): columns, dataRows(), decode(), exportBytes(), exportFor(), index, parseCsv(), PERFORMANCE (+1 more)
...
Cohesion: 0.18
Nodes (10): Requirement: Password recovery is available, Requirement: Session is refreshed on every request, Requirement: Unauthenticated access is redirected to login, Requirements, Scenario: Active session stays alive, Scenario: Anonymous visitor is redirected, Scenario: No public sign-up exists, Scenario: Original destination is restored after login (+2 more)
...
Cohesion: 0.18
Nodes (10): activity-log Specification, Requirement: Action kind is derived from the nature of the change, Requirement: Activity log table stores every audited event, Requirement: Existing tables are audited and future tables must opt in at creation, Requirements, Scenario: Archiving is logged as archived, not updated, Scenario: Changes to organizations are logged, Scenario: Invalid action is rejected (+2 more)
...
Cohesion: 0.2
Nodes (9): OwnerDashboard(), OwnerDashboardProps, activity, card, comparison, { container }, deliveries, LOW_STOCK (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [ref=f1e1]:), code:ts (1   | import { geeko } from "./helpers/seed-copies";), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: expect(locator).toContainText(expected) failed), code:yaml (- combobox "Estado" [disabled]: Imprimiendo), code:ts (1   | import { geeko } from "./helpers/seed-copies";), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [ref=f1e1]:), code:ts (1   | import { geeko } from "./helpers/seed-copies";), code:ts (1   | import { geeko } from "./helpers/seed-copies";), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active] [ref=f1e1]:), code:ts (144 |     await expect(archived).toHaveAttribute("data-archi), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Error: expect(locator).toBeHidden() failed), code:yaml (- dialog "Registrar cliente":), code:ts (1   | import { expect, type Page } from "./test";), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (25  |), code:ts (27  | test.describe("catálogo y directorio (V10, V11, V13)",), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { geeko } from "./helpers/seed-copies";), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:ts (54  |     await page.goto("/my-tasks");), code:ts (39  |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (6): MODIFIED Requirements, Requirement: Every INSERT on an audited table produces a created event, Scenario: A record created offline keeps its real time in the log, Scenario: Audited table without a client-set time, Scenario: Insert is logged with author, organization and content, Scenario: Later changes are dated when they arrive
...
Cohesion: 0.22
Nodes (6): ADDED Requirements, Purpose, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta, Scenario: Gasto en General
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForResponse: Test timeout of 30000ms exceede), code:yaml (- generic [ref=f2e1]:), code:ts (82  |   return page.getByTestId("task-row").count();), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 424 - "Community 424"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 425 - "Community 425"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=e4]:), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 120000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 120000ms exceeded.), code:yaml (- generic [active] [ref=f3e1]:), code:ts (34  |  * los proyectos de escritorio y móvil corren a la vez), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 120000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 120000ms exceeded.), code:yaml (- generic [ref=f1e2]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 440 - "Community 440"
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: net::ERR_ABORTED; maybe frame was detached), code:ts (1  | import { test as base, type Page } from "@playwright/te), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 120000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 120000ms exceeded.), code:yaml (- main [ref=f3e3]:), code:ts (34  |  * los proyectos de escritorio y móvil corren a la vez), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=e4]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded while running "beforeEach" ), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (52  |  */), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 451 - "Community 451"
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 452 - "Community 452"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 453 - "Community 453"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (73  |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Error: expect(locator).toBeEnabled() failed), code:yaml (- button "Línea de negocio" [disabled]: Sublimación), code:ts (1   | import { geekoForBlock } from "./helpers/seed-copies";), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f1e2]:), code:ts (213 |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f2e1]:), code:ts (27  | test.describe("catálogo y directorio (V10, V11, V13)",), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Error: expect(locator).toBeEnabled() failed), code:yaml (- button "Línea de negocio" [disabled]: Sublimación), code:ts (1   | import { geeko } from "./helpers/seed-copies";), code:ts (51  |     let interactions = 0;), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 485 - "Community 485"
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:ts (1   | import { expect, test, type Page } from "@playwright/t), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.33
Nodes (3): ItemVariantService, toNumber(), variantFromRow()

### Community 494 - "Community 494"
Cohesion: 0.22
Nodes (8): QUICK_DESTINATIONS, consumo, labels, navegan, pendientes, tarea, venta, vivos
...
Cohesion: 0.25
Nodes (5): ADDED Requirements, Purpose, Requirement: Successive edits by the same author are merged, Scenario: Edits by different users are not merged, Scenario: Two edits within five minutes produce one event
...
Cohesion: 0.22
Nodes (8): dashboard Specification, Requirement: El panel carga dentro de su presupuesto, Requirement: El panel es utilizable en un teléfono, Requirements, Scenario: Doce meses sembrados, Scenario: El aterrizaje no cambia, Scenario: Nada se precalcula en una columna, Scenario: Una columna en 390 px
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [ref=f1e1]:), code:ts (132 |       await page.goto("/settings/lines");), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.25
Nodes (6): entregado, moved, order, registrado, renderDetail(), OrderWithTotal
...
Cohesion: 0.25
Nodes (7): org-configuration Specification, Requirement: A new business line is usable immediately, Requirement: Geeko Store is seeded with its real lines and channels, Requirements, Scenario: Existing test organizations survive the seed, Scenario: New line appears in the selector with its color, Scenario: Reset leaves Geeko Store ready
...
Cohesion: 0.25
Nodes (7): fair-mode Specification, Requirement: Aislamiento y roles en el modo feria, Requirements, Scenario: El ayudante vende, Scenario: Intento de borrado, Scenario: La cuadrícula no cruza organizaciones, Scenario: Miembro de otra organización
...
Cohesion: 0.25
Nodes (7): platform-administration Specification, Requirement: A platform admin's profile reflects platform access, Requirement: Platform views fit a phone, Requirements, Scenario: Platform views at 390 px, Scenario: Profile inside a foreign organization, Scenario: Profile without an active organization

### Community 586 - "Community 586"
Cohesion: 0.25
Nodes (7): Requirement: Los campos de la tarea se editan y se guardan uno a uno, Requirements, Scenario: Cada cambio deja rastro, Scenario: Cambiar el responsable no exige guardar nada más, Scenario: El título no puede quedar vacío, Scenario: Un recordatorio necesita fecha límite, task-detail Specification
...
Cohesion: 0.25
Nodes (7): notifications Specification, Requirement: La bitácora nunca genera notificaciones, Requirement: La generación privilegiada se limita al trabajo programado y a la creación de avisos, Requirements, Scenario: Actividad intensa, bandeja tranquila, Scenario: Cada aviso a su organización, Scenario: Disparo sin credencial
...
Cohesion: 0.25
Nodes (7): 1. Regla de destino de la raíz, 2. Proxy, 3. Página raíz, 4. Pruebas e2e, 5. Sin organización: cerrar sesión, 5. Verificación, 6. Verificación
...
Cohesion: 0.29
Nodes (6): enterOrganization, [geeko], options, ORGANIZATIONS, renderSwitcher(), trigger
...
Cohesion: 0.33
Nodes (3): ItemLastCost, ItemLastCostService, toNumber()
...
Cohesion: 0.29
Nodes (6): Requirement: Las columnas del tablero salen del juego de estados de la línea, Requirements, Scenario: Columnas de una línea con juego propio, Scenario: Columnas de una línea sin juego propio, Scenario: Un estado nuevo aparece como columna, tasks Specification
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: A platform admin without an active organization gets the platform shell, Scenario: Organization-scoped routes need an organization, Scenario: The platform shell omits organization controls
...
Cohesion: 0.29
Nodes (7): Requirement: El Markdown rendido se sanea, Scenario: El formato legítimo sobrevive, Scenario: El HTML escrito a mano no se rinde, Scenario: Un atributo de evento se retira, Scenario: Un cuerpo antiguo también se sanea, Scenario: Un enlace con esquema peligroso no navega, Scenario: Un script no se ejecuta
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: Sin fecha límite no hay aviso de vencimiento, Scenario: Se le pone fecha, Scenario: Tarea sin fecha, sin avisos
...
Cohesion: 0.29
Nodes (6): reports Specification, Requirement: Exportación de cualquier informe con sus filtros y su contexto, Requirements, Scenario: Cifras utilizables, Scenario: El archivo se explica solo, Scenario: Exporta lo que se ve
...
Cohesion: 0.47
Nodes (5): Indicator(), IndicatorCards(), IndicatorProps, money(), marginOf()

### Community 708 - "Community 708"
Cohesion: 0.33
Nodes (5): button, change, { onOpen }, { onOpen, onClear }, renderField()
...
Cohesion: 0.33
Nodes (5): button, consumo, gasto, pathname, renderButton()
...
Cohesion: 0.33
Nodes (6): Requirement: El estado de pago se deriva de los pagos registrados, Scenario: El estado no se guarda, Scenario: Monto parcial fuera de rango, Scenario: Registrado como pagado, Scenario: Registrado como parcial, Scenario: Registrado como pendiente
...
Cohesion: 0.4
Nodes (4): area, { onSave }, renderEditor(), user
...
Cohesion: 0.5
Nodes (4): Requirement: Exactly one shared business line exists and cannot be archived, Scenario: A second shared line is rejected, Scenario: The shared line cannot be archived, Scenario: The shared line is not offered for archiving in the interface
...
Cohesion: 0.5
Nodes (4): Requirement: Users with multiple organizations must choose one, Scenario: A platform admin never gets the selection screen, Scenario: Multi-organization user selects before continuing, Scenario: Single-organization user skips selection
...
Cohesion: 0.67
Nodes (3): Requirement: Updates record only the fields that changed, Scenario: Single-field update stores only that field, Scenario: Touching only updated_at produces no event
...
## Knowledge Gaps
- **6538 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+6533 more)
...
- **Why does `useSearchReset()` connect `Community 18` to `Community 16`, `Community 4`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 16` to `Community 18`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 136`, `Community 11`, `Community 15`, `Community 18`, `Community 24`, `Community 283`, `Community 40`, `Community 171`, `Community 52`, `Community 62`, `Community 64`, `Community 707`, `Community 195`, `Community 210`, `Community 86`, `Community 96`?**
...
- **What connects `config`, `config`, `eslintConfig` to the rest of the system?**
  _6538 weakly-connected nodes found - possible documentation gaps or missing edges._
