...
## Corpus Check
- 599 files · ~778,745 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5621 nodes · 9590 edges · 430 communities (409 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `935f8dce`
...
1. `cn()` - 196 edges
2. `getOwnerContext()` - 62 edges
3. `Button()` - 60 edges
4. `getSessionContext()` - 57 edges
5. `BusinessLine` - 35 edges
6. `Input()` - 35 edges
7. `ADDED Requirements` - 33 edges
8. `Badge()` - 29 edges
9. `Requirements` - 28 edges
10. `lineCookieName()` - 27 edges
...
## Communities (430 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (58): CatalogRow, LINE, push, UNIT, { unmount }, user, ACTION_LABELS, item() (+50 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (52): ContactCombobox(), ContactComboboxRole, CategoryChips(), AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+44 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (52): backoffDelay(), hasExhaustedAttempts(), esperas, capture(), CaptureDeps, CaptureResult, drain, draining (+44 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (59): useIsMobile(), AppSidebar(), nav, pathname, cn(), AlertAction(), DialogOverlay(), DropdownMenu() (+51 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (48): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+40 more)
...
Cohesion: 0.05
Nodes (37): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta], DirectSaleInput (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (40): ACCEPTED_TYPES, ActionResult, archiveExpense(), attachReceipt(), createExpense(), CreateExpenseResult, createPurchase(), revalidateExpenses() (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (29): ActionResult, ACTION_LABELS, DetailBody(), ReceiptView, ExitFairMode(), salida, formatCalendarDate(), formatDateTime() (+21 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (41): CLASSES, isLineColor(), LINE_COLOR_LABELS, METHOD_LABELS, DELIVERY_LABELS, OrderCard(), OrderCardData, shortDate() (+33 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (34): createTask(), BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd(), created, link (+26 more)
...
Cohesion: 0.07
Nodes (31): barra, mas, panel, pathname, MEMBERSHIP, ORG, USER, UserProvider() (+23 more)
...
Cohesion: 0.1
Nodes (34): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+26 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (30): ExpenseCard(), KIND_LABELS, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), LineBadge(), UploadIndicator(), ExpenseRowView (+22 more)
...
Cohesion: 0.08
Nodes (18): client, contactRow, inserted, itemRow, productRow, ItemDetail(), ItemFilters, ItemRow (+10 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (29): CatalogScreen(), contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name, optionalAmount, optionalText (+21 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (26): addEntry(), B(), deleteEntry(), fetchDidFail(), G(), getAll(), getAllEntriesByQueueName(), getDb() (+18 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (30): DashboardService, DeliveryRow, MonthCashFlow, PENDING_KINDS, toNumber(), UpcomingDelivery, Indicator(), IndicatorCards() (+22 more)
...
Cohesion: 0.1
Nodes (20): LineOption(), LineSelector(), user, ThemeToggle(), Header(), bell, MobileContextBar(), tira (+12 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (27): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barHrefOf(), barLabelOf(), bottomBarEntriesFor(), isNavEntryActive(), moreEntriesFor() (+19 more)
...
Cohesion: 0.07
Nodes (30): NO_MONEY, OrderFilters, OrderRow, OrderTotals, id, MoveOrderInput, moveOrderSchema, numeric (+22 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (19): archiveTask(), CreateTaskResult, moveTaskSchema, moveTaskToStatus(), revalidateTasks(), TaskActionResult, taskIdSchema, updateTaskFields() (+11 more)
...
Cohesion: 0.15
Nodes (27): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+19 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (16): AttachmentRow, AttachmentService, NewAttachment, client, inserted, newPhoto, path, row (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (21): SessionContext, ExpenseDetail(), ExpenseDetailData, ExpenseItemRow, ExpenseItemService, ExpenseItemWithNames, loadExpenseDetail(), ExpensesPage() (+13 more)

### Community 40 - "Community 40"
Cohesion: 0.09
Nodes (22): BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardState, displayedPlacement(), enCola, otra (+14 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (19): AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, root, OwnerDashboard(), OwnerDashboardProps, activity (+11 more)

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (20): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+12 more)
...
Cohesion: 0.11
Nodes (10): ContactFilters, ContactRow, ContactService, ContactFormValues, matchesSearch(), normalizeForSearch(), TagRow, TagService (+2 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (22): addLine(), cartTotal(), cartUnits(), cents(), clear(), removeLine(), SellableProduct, CartState (+14 more)

### Community 46 - "Community 46"
Cohesion: 0.15
Nodes (16): InviteForm(), FormValues, schema, ActivityItem, RecentActivity(), { container }, items, Figure() (+8 more)
...
Cohesion: 0.16
Nodes (26): a, C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+18 more)
...
Cohesion: 0.09
Nodes (18): lineIssuesOf(), OrderForm(), OrderFormState, antes, CHANNELS, CLIENTA, { container, user }, defaults() (+10 more)
...
Cohesion: 0.22
Nodes (15): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), revalidateOrders() (+7 more)

### Community 67 - "Community 67"
Cohesion: 0.18
Nodes (12): defaultLandingPath(), isMobileUserAgent(), isProtectedPath(), PROTECTED_PREFIXES, ExpensesLayout(), config, proxy(), metadata (+4 more)
...
Cohesion: 0.12
Nodes (16): 14. Próximos Pasos, 1. Resumen Ejecutivo, 3.1 Dueño / administrador, 3.2 Ayudante / operador (1 o 2 personas), 3.3 Organizaciones futuras, 3. Público Objetivo, 4. Tipo de Producto Digital, 5. Propuesta de Valor y Tono de Marca (+8 more)
...
Cohesion: 0.12
Nodes (15): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Las consultas de ingresos incluyen las ventas directas, Requirements, Scenario: Creación con nombre y teléfono, Scenario: El cobrado también suma, Scenario: El contacto es un cliente (+7 more)
...
Cohesion: 0.2
Nodes (9): BoardOrder, CalendarView(), ListView(), View, Checkbox(), ToggleGroupContext, ToggleGroupItem(), Toggle() (+1 more)
...
Cohesion: 0.13
Nodes (14): payments Specification, Requirement: El sobrepago se advierte pero se permite, Requirement: La dirección se deduce del destino y la base de datos la impone, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: Advertencia antes de confirmar, Scenario: Cobro de pedido, Scenario: Dirección contraria sobre un egreso (+6 more)
...
Cohesion: 0.26
Nodes (8): OrderContext, prefillFromOrder(), TaskPrefill, ORDER, prefill, shiftDays(), suggestedDueDate(), propuesta
...
Cohesion: 0.35
Nodes (9): comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon } (+1 more)
...
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Semilla de catálogo y directorio de Geeko Store, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo, Scenario: La búsqueda de la semilla tolera acentos (+1 more)

### Community 140 - "Community 140"
Cohesion: 0.18
Nodes (10): catalog-directory Specification, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Pantalla de contactos (V13), Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: Filtro por rol, Scenario: Intento de editar un registro archivado (+2 more)
...
Cohesion: 0.38
Nodes (6): useCartStore, useCartTotal(), useCartUnits(), FairScreen(), useFairSessionStore, useOnlineStatus()
...
Cohesion: 0.22
Nodes (8): client, inserted, otra, patch, read, row, withArchived, write
...
Cohesion: 0.22
Nodes (8): expenses Specification, Requirement: Pista del último precio en el formulario de compra, Requirement: Semilla de egresos de Geeko Store, Requirements, Scenario: Insumo comprado antes, Scenario: Insumo nuevo, Scenario: La pista no cambia el valor, Scenario: Reinicio local
...
Cohesion: 0.22
Nodes (8): dashboard Specification, Requirement: El panel es utilizable en un teléfono, Requirement: Marcadores de posición declarados, Requirements, Scenario: El aterrizaje no cambia, Scenario: El marcador no engaña, Scenario: Los dos marcadores están rotulados, Scenario: Una columna en 390 px
...
Cohesion: 0.38
Nodes (4): CartBar(), onCheckout, onRemove, CartLine
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: El panel carga dentro de su presupuesto, Scenario: Doce meses sembrados, Scenario: Nada se precalcula en una columna
...
## Knowledge Gaps
- **2918 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+2913 more)
...
- **Why does `cn()` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 18`, `Community 21`, `Community 24`, `Community 26`, `Community 29`, `Community 30`, `Community 40`, `Community 41`, `Community 46`, `Community 51`, `Community 65`, `Community 67`, `Community 200`, `Community 205`, `Community 93`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 10` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 42`, `Community 11`, `Community 12`, `Community 46`, `Community 16`, `Community 93`, `Community 21`, `Community 279`, `Community 24`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `ItemVariantService` connect `Community 23` to `Community 37`?**
