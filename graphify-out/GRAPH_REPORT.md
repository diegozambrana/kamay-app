# Graph Report - kamay-app  (2026-09-06)

## Corpus Check
- 506 files · ~393,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4763 nodes · 8208 edges · 359 communities (342 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `86de8bcf`
...
3. `Button()` - 55 edges
4. `getSessionContext()` - 46 edges
5. `ADDED Requirements` - 33 edges
6. `Input()` - 30 edges
7. `BusinessLine` - 28 edges
8. `Requirements` - 28 edges
9. `useUserStore` - 26 edges
10. `7. Mapa de Vistas / Pantallas` - 24 edges
...
Cohesion: 0.04
Nodes (78): LineOption(), LineSelector(), ItemThumbnail(), METHOD_LABELS, useIsMobile(), AppSidebar(), nav, pathname (+70 more)
...
Cohesion: 0.1
Nodes (49): ContactCombobox(), ContactComboboxRole, CategoryChips(), AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+41 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (49): ACTION_LABELS, ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user (+41 more)
...
Cohesion: 0.1
Nodes (33): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+25 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (36): LineColorClasses, columns, onAction, Row, rows, user, LineBadge(), LineBadge() (+28 more)
...
Cohesion: 0.09
Nodes (25): Header(), MobileContextBar(), tira, OrganizationState, MEMBERSHIPS, ORG, useOrganizationStore, countItems() (+17 more)
...
Cohesion: 0.1
Nodes (33): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+25 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (38): ADDED Requirements, Purpose, quick-capture Specification, Requirement: El registro rápido es la puerta del modo feria, Requirement: La pantalla de registro rápido ofrece seis destinos, Requirement: La retícula de registro rápido se filtra por rol, Requirement: Registrado hoy confirma la captura, Requirement: Registrado hoy cuenta también lo que no se ha enviado (+30 more)
...
Cohesion: 0.08
Nodes (26): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemVariantService (+18 more)
...
Cohesion: 0.18
Nodes (20): ACTION_LABELS, DetailBody(), ReceiptView, formatDate(), formatDateTime(), formatFileSize(), METHOD_LABELS, Payment (+12 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (24): MEMBERSHIP, ORG, USER, destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, labels (+16 more)
...
Cohesion: 0.08
Nodes (25): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user, ExitFairMode() (+17 more)
...
Cohesion: 0.15
Nodes (29): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+21 more)
...
Cohesion: 0.1
Nodes (18): ExpenseRow, OrderRow, RecentCaptureService, CaptureKind, lineIdOf(), mergeRecentCaptures(), PENDING_KINDS, pendingCapturesToday() (+10 more)
...
Cohesion: 0.12
Nodes (14): InviteForm(), BusinessLineProvider(), OrganizationProvider(), UserProvider(), metadata, MembershipRow, MembershipService, BusinessLineState (+6 more)
...
Cohesion: 0.2
Nodes (16): FormValues, schema, hasARole(), itemVariantFormSchema, VariantFormDialog(), ContactFormDialog(), ROLE_FILTER_LABELS, Card() (+8 more)
...
Cohesion: 0.09
Nodes (18): FILTERS, push, renderScreen(), ROWS, user, ReceiptUploader, body, compressed (+10 more)
...
Cohesion: 0.12
Nodes (21): reorderQueue(), BoardColumn(), DraggableCard(), OrderCardData, { container }, { unmount }, Midpoint, Queueable (+13 more)

### Community 41 - "Community 41"
Cohesion: 0.16
Nodes (18): SessionContext, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad() (+10 more)
...
Cohesion: 0.11
Nodes (10): NO_MONEY, OrderFilters, OrderRow, OrderService, OrderTotals, OrderWithTotal, toNumber(), OrderLineValues (+2 more)
...
Cohesion: 0.17
Nodes (23): C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey(), _getNetworkPromise() (+15 more)
...
Cohesion: 0.17
Nodes (16): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+8 more)
...
Cohesion: 0.11
Nodes (8): AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, AttachmentEntityType
...
Cohesion: 0.13
Nodes (16): ExpenseCard(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), UploadIndicator() (+8 more)
...
Cohesion: 0.17
Nodes (12): CalendarView(), ListView(), View, money(), outstandingFor(), OutstandingSummary(), rows, OutstandingByLine (+4 more)

### Community 65 - "Community 65"
Cohesion: 0.11
Nodes (18): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Entradas al alta y a la edición, Requirement: Fecha comprometida con atajos, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+10 more)
...
Cohesion: 0.13
Nodes (12): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), client, formValues, orderRow, { p_items } (+4 more)
...
Cohesion: 0.19
Nodes (13): 11. Vistas derivadas, 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (-- Saldo actual por ítem), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log () (+5 more)
...
Cohesion: 0.15
Nodes (13): Requirement: Detalle del pedido, Scenario: Acciones de edición y cancelación, Scenario: Bloque de cobros y saldo, Scenario: Cambio de estado desde el detalle, Scenario: Historial, Scenario: Imagen de referencia, Scenario: Pedido archivado, Scenario: Pedido completo (+5 more)
...
Cohesion: 0.17
Nodes (8): fila, monto, opciones, panel, ranuras, RUTAS, selector, tablero
...
Cohesion: 0.24
Nodes (11): a, _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), iterateCallbacks(), n (+3 more)
...
Cohesion: 0.25
Nodes (8): 10. Inventario, 12. Tareas, 9. Pedidos y ventas, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), code:sql (create table inventory_movements (), code:sql (create table tasks (), Una decisión que conviene revisar
...
Cohesion: 0.43
Nodes (5): ActionResult, ConfigEntity, ConfigItem, ConfigList(), NamedItem
...
## Knowledge Gaps
- **2418 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2413 more)
...
- **Why does `cn()` connect `Community 0` to `Community 64`, `Community 1`, `Community 35`, `Community 4`, `Community 3`, `Community 36`, `Community 40`, `Community 9`, `Community 12`, `Community 16`, `Community 51`, `Community 22`, `Community 23`, `Community 60`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 22` to `Community 0`, `Community 1`, `Community 64`, `Community 35`, `Community 3`, `Community 4`, `Community 9`, `Community 12`, `Community 13`, `Community 251`, `Community 273`, `Community 52`, `Community 20`, `Community 25`, `Community 27`, `Community 60`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `getOperation()` connect `Community 2` to `Community 31`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
