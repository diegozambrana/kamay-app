# Graph Report - kamay-app  (2026-09-16)

## Corpus Check
- 1200 files · ~1,199,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11108 nodes · 19093 edges · 817 communities (792 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2cd87f1d`
...
## Communities (817 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (114): ProfileForm(), ActivityListProps, ActivityRow(), ORIGIN_LABELS, EventDetail, HistoryEntry(), RecordHistory, RecordHistoryItem (+106 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (97): Detail(), BoardColumn(), DraggableCard(), TaskSheet(), ItemThumbnail(), Count(), LineBadge(), CheckoutSheet() (+89 more)
...
Cohesion: 0.06
Nodes (74): FormValues, schema, DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, Assignee, TASK_FILTERS, View (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (86): ACTION_LABELS, ActivityFiltersProps, FilterOption, CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineOption() (+78 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (70): selectBusinessLine(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (61): createTask(), BoardTask, BoardView(), CalendarView(), KanbanBoard(), KanbanColumn, card, Item (+53 more)
...
Cohesion: 0.06
Nodes (51): ActionResult, metadata, InviteDialog(), PendingRow(), PendingTask, NotificationType, OPTIONS, BusinessLinesSection() (+43 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (48): AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema, selectOrganization(), updatePassword() (+40 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (49): UserMenu(), AppShell(), AppSidebar(), links, nav, pathname, renderSidebar(), Header() (+41 more)
...
Cohesion: 0.05
Nodes (35): estado, Redirect, loadRecordHistory(), NotFound(), makeThumbnail(), blob, broken, pdf (+27 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (45): relatedTasksFor(), ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps, LinkSearch(), LinkSearchProps, TYPE_LABELS, RelatedTasksPanel() (+37 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (41): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, memberLinesSchema (+33 more)
...
Cohesion: 0.06
Nodes (43): TasksScreen(), CATALOG_FILTERS, CatalogScreen(), ITEM_KIND_FIELDS, ItemDetail(), BALANCE, EMBALAJE, form (+35 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (37): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+29 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (36): PlatformActionResult, CreateOrganizationDialog(), OrganizationDetail(), TeamMember, MembershipEmbed, OrganizationInput, OrganizationRow, OrganizationSummary (+28 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (23): chunk(), takeWindow(), OrderItemRow, OrderItemService, toNumber(), NO_MONEY, OrderFilters, OrderRow (+15 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (36): addAccountByEmail(), AddUserResult, addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue(), inviteToOrganization() (+28 more)
...
Cohesion: 0.07
Nodes (36): ExpenseCard(), KIND_LABELS, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), LineBadge(), UploadIndicator(), EXPENSE_FILTERS (+28 more)
...
Cohesion: 0.05
Nodes (21): original, created, dialog, link, first, row, filas, detalle (+13 more)
...
Cohesion: 0.08
Nodes (30): RetentionJobDeps, RetentionJobResult, runRetentionJob(), EMPTY, report, run, describeRun(), RetentionRun (+22 more)

### Community 29 - "Community 29"
Cohesion: 0.11
Nodes (29): moveOrderToStatus(), ItemPhotos(), useReturnFocus(), ArchiveWarning(), ArchiveWarningProps, list, onConfirm, CancelOrderButton() (+21 more)
...
Cohesion: 0.1
Nodes (29): AccountLayout(), NoOrganizationNotice(), ProfileView, ROLE_LABELS, organization, view, signOut(), AppLayout() (+21 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (37): buildDetail(), ChangePair, DETAIL_MARKERS, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds() (+29 more)
...
Cohesion: 0.06
Nodes (28): ActionResult, linkExpenseToAsset(), message(), revalidateAsset(), saveAssetDetails(), AssetDetailView, acquisition, breakdown (+20 more)
...
Cohesion: 0.09
Nodes (30): addLine(), CartBar(), onCheckout, onRemove, CartLine, cartTotal(), cartUnits(), cents() (+22 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (25): LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames, PurchaseLinesTable(), HINTS, quantity, row (+17 more)

### Community 47 - "Community 47"
Cohesion: 0.09
Nodes (31): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), useSignOut(), CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, block (+23 more)

### Community 48 - "Community 48"
Cohesion: 0.09
Nodes (27): DEFAULT_PREFERENCES, PreferencesRow, resolvePreferences(), resolved, validHour(), alasSeis, alasSiete, conHora() (+19 more)
...
Cohesion: 0.07
Nodes (22): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), NotificationBell(), Destination (+14 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (20): detalle, monto, elapsed, MID_RANGE, started, enRevision, porHacer, fila (+12 more)
...
Cohesion: 0.09
Nodes (19): CatalogScope, ContactScope, joinsCatalogWindow(), joinsContactWindow(), all, archived, conCategoria, CONTACT (+11 more)
...
Cohesion: 0.07
Nodes (29): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Archivar retira de listados y buscadores sin borrar la historia, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Desarchivar devuelve el registro intacto, Requirement: El ayudante crea y edita, pero no archiva (+21 more)
...
Cohesion: 0.12
Nodes (28): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, reorderQueue(), revalidateOrders(), setArchived(), setOrderAttachmentArchived() (+20 more)
...
Cohesion: 0.07
Nodes (25): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, DUE_DATE_SHORTCUTS (+17 more)
...
Cohesion: 0.1
Nodes (26): ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock(), consumptionSchema, ConsumptionValues (+18 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (20): ActivityPage, ActivityService, decodeCursor(), encodeCursor(), RecentActivityEntry, RecentOptions, client, cursor (+12 more)
...
Cohesion: 0.11
Nodes (20): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], UnitRow (+12 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (19): client, opciones, client, update, client, patch, row, Call (+11 more)
...
Cohesion: 0.13
Nodes (19): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, CsvContext, CsvTable, cells (+11 more)
...
Cohesion: 0.15
Nodes (20): rangeInstants(), currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone(), startOfNextDayInTimezone() (+12 more)

### Community 80 - "Community 80"
Cohesion: 0.13
Nodes (20): ActivityFilterBar(), ActivityDay, ActivityList(), ActivityRowItem, actorOf(), capitalize(), contract(), DescribableEvent (+12 more)

### Community 81 - "Community 81"
Cohesion: 0.12
Nodes (19): barPercent(), comparisonRows(), comparisonScale(), LineCashFlow, NO_CASH_FLOW, ALFARERIA, flows, rows (+11 more)
...
Cohesion: 0.14
Nodes (18): dueSummaryKey(), taskAssignedKey(), taskOverdueKey(), taskReviewKey(), taskStalledKey(), claves, dia1, dia2 (+10 more)
...
Cohesion: 0.16
Nodes (13): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, renderPanel(), uno (+5 more)
...
Cohesion: 0.1
Nodes (16): OrderFormState, antes, CHANNELS, CLIENTA, { container, user }, defaults(), file, grande (+8 more)
...
Cohesion: 0.11
Nodes (19): renderMenu(), card(), marca, { onOpen, tarjeta }, renderCard(), renderWith(), renderScreen(), task() (+11 more)
...
Cohesion: 0.15
Nodes (13): adminClient(), countNotifications(), serviceRoleKey(), userIdByEmail(), newAccount(), newOrganization(), plan, roles (+5 more)
...
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Líneas de pedido con precio propio, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Numeración visible por organización sin duplicados, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Cantidad no positiva, Scenario: El número no se reutiliza (+11 more)
...
Cohesion: 0.19
Nodes (12): AssistantDashboardProps, LowStockItem, PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard(), { container } (+4 more)
...
Cohesion: 0.15
Nodes (14): contactFormSchema, ContactFormValues, itemFieldsSchema, itemFormSchema, ItemFormValues, itemVariantFormSchema, name, optionalAmount (+6 more)
...
Cohesion: 0.19
Nodes (9): ADDED Requirements, MODIFIED Requirements, Purpose, REMOVED Requirements, Requirement: El panel es la puerta de entrada de escritorio y se compone según el rol, Scenario: El ayudante recibe su propia composición, Scenario: El rol se decide antes de pintar, Scenario: La persona dueña recibe la composición completa (+1 more)
...
Cohesion: 0.14
Nodes (13): archiveSchema, entities, Entity, generalSchema, id, itemCategorySchema, lineSchema, name (+5 more)
...
Cohesion: 0.16
Nodes (9): CaptureDeps, CaptureResult, drain, draining, enqueue, entrada, DrainOutcomes, EnqueueInput (+1 more)

### Community 202 - "Community 202"
Cohesion: 0.14
Nodes (13): 10. Integraciones y Funcionalidades de Terceros, 14. Próximos Pasos, 1. Resumen Ejecutivo, 4. Tipo de Producto Digital, 9. Necesidad de Datos y Persistencia, Consecuencias de diseño, Deliberadamente evitado, Deseables después (+5 more)
...
Cohesion: 0.23
Nodes (12): createExpenseCategory(), createSalesChannel(), createUnit(), revalidateConfiguration(), toMessage(), updateExpenseCategory(), updateGeneralSettings(), updateItemCategory() (+4 more)

### Community 209 - "Community 209"
Cohesion: 0.15
Nodes (11): archiveConfigurationItem(), serviceFor(), unarchiveConfigurationItem(), archived, GENERAL, { onEdit }, renderLines(), Row (+3 more)
...
Cohesion: 0.17
Nodes (10): active, audit(), confirm, dialog, form, found, opener, style (+2 more)
...
Cohesion: 0.15
Nodes (9): cantidad, CATALOGO, { onAdd, user }, { onRemove, user }, precio, renderEditor(), TAZA, TAZA_CON_VARIANTES (+1 more)
...
Cohesion: 0.3
Nodes (8): backoffDelay(), hasExhaustedAttempts(), esperas, DrainDeps, drainOutbox(), runDrain(), failedRecordIdsOf(), listEntries()
...
Cohesion: 0.18
Nodes (7): ADDED Requirements, expenses Specification, Purpose, Requirement: Líneas de compra con precio propio, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Precio negativo
...
Cohesion: 0.24
Nodes (9): holdMessage(), holdReason(), FairSnapshot, FairSnapshotProduct, HoldReason, OutboxEntry, OutboxState, SessionIdentity (+1 more)
...
Cohesion: 0.29
Nodes (7): FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), formatFileSize(), EmptyMedia(), emptyMediaVariants
...
Cohesion: 0.2
Nodes (10): Requirement: A platform admin's profile reflects platform access, Requirement: Actions of a platform admin are marked in the activity log, Requirement: Platform views fit a phone, Requirements, Scenario: A foreign change is marked, Scenario: A member's own change is not marked, Scenario: Platform views at 390 px, Scenario: Profile inside a foreign organization (+2 more)
...
Cohesion: 0.2
Nodes (9): inventory Specification, Requirement: Cada línea de compra de un insumo genera exactamente una entrada, Requirement: Todo movimiento de inventario queda en la bitácora, Requirements, Scenario: Compra de tres insumos, Scenario: El consumo queda registrado, Scenario: El saldo sube con la compra, Scenario: Línea de compra de un producto (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForResponse: Test timeout of 30000ms exceede), code:yaml (- generic [ref=f4e1]:), code:ts (1   | import { geeko } from "./helpers/seed-copies";), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active] [ref=f2e1]:), code:ts (180 |), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f1e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 333 - "Community 333"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- main [ref=f1e3]:), code:ts (11  |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Error: expect(locator).toHaveText(expected) failed), code:yaml (- text: "340.00"), code:ts (1   | import { expect, test, type Page } from "./helpers/tes), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f1e2]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (8): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f2e2]:), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: Timeout 30000ms exceeded while waiting on the predica), code:yaml (- generic [active] [ref=f2e1]:), code:ts (55  |     await expect(), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: net::ERR_ABORTED; maybe frame was detached), code:ts (1   | import { expect, test, type Page } from "@playwright/t), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 30000ms exceeded.), code:yaml (- generic:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f2e1]:), code:ts (39  |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 60000ms exceeded.), code:block2 (Error: page.waitForResponse: Test timeout of 60000ms exceede), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.24
Nodes (9): code:block1 (Error: Timeout 30000ms exceeded while waiting on the predica), code:yaml (- generic [active] [ref=f2e1]:), code:ts (41  |), code:ts (27  | test.describe("catálogo y directorio (V10, V11, V13)",), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Error: expect(locator).toBeEnabled() failed), code:yaml (- button "Línea de negocio" [disabled]: Sublimación), code:ts (1   | import { expect, test, type Locator, type Page } from ), code:ts (51  |     let interactions = 0;), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:ts (1   | import { expect, test, type Locator, type Page } from ), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.22
Nodes (7): chunks, csv, download, link, section, started, tabs
...
Cohesion: 0.25
Nodes (8): ExpenseDetail(), ExpenseDetailData, data(), expense(), field, linkExpenseToAsset, push, ExpenseWithTotal
...
Cohesion: 0.22
Nodes (8): Requirement: Password recovery is available, Requirement: Unauthenticated access is redirected to login, Requirements, Scenario: Anonymous visitor is redirected, Scenario: No public sign-up exists, Scenario: Original destination is restored after login, Scenario: User recovers access, user-auth Specification

### Community 431 - "Community 431"
Cohesion: 0.25
Nodes (6): ADDED Requirements, platform-administration Specification, Purpose, Requirement: A platform admin without an active organization gets the platform shell, Scenario: Organization-scoped routes need an organization, Scenario: The platform shell omits organization controls
...
Cohesion: 0.25
Nodes (5): ADDED Requirements, Purpose, Requirement: Action kind is derived from the nature of the change, Scenario: Archiving is logged as archived, not updated, Scenario: Unarchiving is logged as unarchived
...
Cohesion: 0.25
Nodes (7): activity-log Specification, Requirement: Activity log table stores every audited event, Requirement: Updates record only the fields that changed, Requirements, Scenario: Invalid action is rejected, Scenario: Single-field update stores only that field, Scenario: Touching only updated_at produces no event
...
Cohesion: 0.25
Nodes (7): notifications Specification, Requirement: La bitácora nunca genera notificaciones, Requirement: Sin fecha límite no hay aviso de vencimiento, Requirements, Scenario: Actividad intensa, bandeja tranquila, Scenario: Se le pone fecha, Scenario: Tarea sin fecha, sin avisos
...
Cohesion: 0.29
Nodes (7): Requirement: Marcador de posición de insumos bajo mínimo, Requirement: Marcadores de posición declarados, Scenario: El marcador no engaña, Scenario: El marcador que queda está rotulado, Scenario: Insumos bajo mínimo ya no es un marcador, Scenario: Los dos marcadores están rotulados, Scenario: Pendientes ya no es marcador
...
Cohesion: 0.29
Nodes (5): updateUnit(), KG, name, row, U

### Community 604 - "Community 604"
Cohesion: 0.29
Nodes (4): createBusinessLine(), updateBusinessLine(), LINES, user
...
Cohesion: 0.33
Nodes (3): ADDED Requirements, Requirement: Session is refreshed on every request, Scenario: Active session stays alive
...
Cohesion: 0.33
Nodes (4): createItemCategory(), archived, push, table
...
Cohesion: 0.5
Nodes (4): Requirement: Cliente creado al vuelo desde el pedido, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito
...
Cohesion: 0.67
Nodes (3): Requirement: La misma compra sincronizada dos veces deja una sola entrada, Scenario: Compra reenviada tras una respuesta perdida, Scenario: Dos reintentos, un solo movimiento
...
## Knowledge Gaps
- **5932 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+5927 more)
...
- **Why does `useSearchReset()` connect `Community 17` to `Community 3`, `Community 12`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 12` to `Community 17`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 8` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 14`, `Community 17`, `Community 19`, `Community 24`, `Community 29`, `Community 35`, `Community 37`, `Community 299`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 214`, `Community 94`, `Community 249`?**
