# Graph Report - kamay-app  (2026-09-03)

## Corpus Check
- 464 files · ~364,218 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4335 nodes · 7399 edges · 356 communities (336 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e4b9e83`
...
3. `Button()` - 50 edges
4. `getSessionContext()` - 42 edges
5. `ADDED Requirements` - 32 edges
6. `Input()` - 29 edges
7. `Requirements` - 27 edges
8. `BusinessLine` - 25 edges
9. `7. Mapa de Vistas / Pantallas` - 24 edges
10. `Alert()` - 22 edges
...
- `ContactsPage()` --calls--> `getSessionContext()`  [EXTRACTED]
  app/(app)/contacts/page.tsx → lib/auth/session-context.ts
- `ItemDetailPage()` --calls--> `getSessionContext()`  [EXTRACTED]
  app/(app)/catalog/[id]/page.tsx → lib/auth/session-context.ts
- `boot()` --calls--> `fetch()`  [INFERRED]
  specs/design/# Kamay, gestión operativa/support.js → public/sw.js

## Communities (356 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (68): ItemThumbnail(), cn(), AlertAction(), AlertDialogMedia(), AlertDialogOverlay(), Avatar(), AvatarBadge(), AvatarFallback() (+60 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (51): backoffDelay(), hasExhaustedAttempts(), esperas, capture(), CaptureDeps, CaptureResult, drain, draining (+43 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (49): ContactCombobox(), ContactComboboxRole, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm(), createContactInline, createPurchase (+41 more)
...
Cohesion: 0.1
Nodes (41): ACTION_LABELS, ItemFormDialog(), ItemForm(), VariantsList(), metadata, DataTable(), DataTableAction, DataTableColumn (+33 more)
...
Cohesion: 0.1
Nodes (37): itemVariantFormSchema, VariantFormDialog(), CategoryChips(), AssignableOrder, DueDateField(), { onChange, user }, METHOD_LABELS, money() (+29 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (44): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+36 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (34): LineColorClasses, columns, onAction, Row, rows, user, ExpenseCard(), ExpenseDetail() (+26 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (48): ADDED Requirements, Purpose, Requirement: Ante ediciones desordenadas gana la última en llegar, con constancia, Requirement: El envío es secuencial y nunca envía un hijo antes que su padre, Requirement: La aplicación es instalable y su cascarón se abre sin conexión, Requirement: La cola pertenece a una organización y a una sesión, Requirement: La cola sobrevive al cierre de la aplicación, Requirement: La hora del hecho la fija el dispositivo y la de llegada el servidor (+40 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (40): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Authenticated shell frames every app screen, Requirement: No app screen scrolls horizontally on a phone, Requirement: Password recovery is available, Requirement: Session is refreshed on every request, Requirement: Sign-in lands on the device-appropriate home (+32 more)
...
Cohesion: 0.12
Nodes (26): AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION, CatalogPage() (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (26): AppSidebar(), nav, pathname, CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), pathname, isNavEntryActive() (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (28): _awaitComplete(), B(), createHandlerBoundToUrl(), deleteEntry(), destroy(), doneWaiting(), fetchDidFail(), G() (+20 more)
...
Cohesion: 0.08
Nodes (25): ItemFilters, ItemRow, toNumber(), ItemVariantService, toNumber(), variantFromRow(), VariantRow, ITEM_KIND_LABELS (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (21): useOnlineStatus(), Header(), MobileContextBar(), useOrganizationStore, countItems(), EMPTY, resolveItems(), SyncCounts (+13 more)

### Community 18 - "Community 18"
Cohesion: 0.17
Nodes (23): ItemPhoto, ItemPhotos(), ACTION_LABELS, DetailBody(), ReceiptView, formatDateTime(), Figure(), PaymentBlock() (+15 more)
...
Cohesion: 0.08
Nodes (28): activity-log Specification, ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Action kind is derived from the nature of the change, Requirement: Activity log table stores every audited event, Requirement: Every INSERT on an audited table produces a created event, Requirement: Existing tables are audited and future tables must opt in at creation (+20 more)
...
Cohesion: 0.14
Nodes (29): a, cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey(), _getNetworkPromise() (+21 more)

### Community 26 - "Community 26"
Cohesion: 0.15
Nodes (19): FormValues, schema, contactFormSchema, hasARole(), ContactFormDialog(), ROLE_FILTER_LABELS, Card(), CardAction() (+11 more)
...
Cohesion: 0.09
Nodes (19): AttachmentRow, NewAttachment, ContactsPage(), metadata, ExpenseItemRow, ExpenseItemService, ExpenseItemWithNames, Attachment (+11 more)
...
Cohesion: 0.15
Nodes (17): SessionContext, ExpenseCategoryRow, ExpenseCategoryService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange (+9 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (24): ADDED Requirements, Purpose, Requirement: La pantalla de registro rápido ofrece seis destinos, Requirement: La retícula de registro rápido se filtra por rol, Requirement: Registrado hoy confirma la captura, Requirement: Registrar está a dos toques desde cualquier pantalla móvil, Scenario: Ayer no cuenta, Scenario: Cada elemento abre su registro (+16 more)
...
Cohesion: 0.16
Nodes (15): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), resolvePostAuthPath() (+7 more)

### Community 36 - "Community 36"
Cohesion: 0.16
Nodes (23): _(), _addSyncListener(), addToPrecacheList(), ae(), Be(), constructor(), Fe(), findMatchingRoute() (+15 more)
...
Cohesion: 0.1
Nodes (17): OrderFormState, antes, CHANNELS, CLIENTA, { container, user }, defaults(), file, grande (+9 more)
...
Cohesion: 0.19
Nodes (15): STATUS_KIND_LABELS, metadata, StatusesSettingsPage(), setIsComplete(), statusFlowSchema, statusFormSchema, StatusFormValues, result (+7 more)

### Community 46 - "Community 46"
Cohesion: 0.17
Nodes (13): selectBusinessLine(), LineOption(), LineSelector(), money(), outstandingFor(), OutstandingSummary(), rows, BusinessLineState (+5 more)
...
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Entradas al alta y a la edición, Requirement: Fecha comprometida con atajos, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Mover un pedido de estado, Requirements, Scenario: Arrastre exitoso, Scenario: Atajo «Mañana» (+11 more)
...
Cohesion: 0.24
Nodes (13): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), revalidateOrders(), setArchived(), setOrderAttachmentArchived() (+5 more)
...
Cohesion: 0.12
Nodes (16): 10. `fair-offline.spec.ts` pertenece a este cambio, 11. La costura de inventario queda señalada y sin abrir, 1. La venta directa reutiliza `orders`, sin tabla ni columna nuevas, 2. `create_direct_sale(p_sale, p_items, p_payment)`: la venta, sus líneas y su cobro en una transacción, 3. El estado sale de `resolve_statuses(..., 'order')` filtrando `kind = 'final'` por menor `position`, 4. La cuadrícula de más vendidos es una vista derivada, no una consulta suelta, 5. Contrato con KAM-11 — lo que `lib/offline/` debe entregar, 6. Un solo camino de escritura: siempre se encola, con red y sin ella (+8 more)
...
Cohesion: 0.2
Nodes (13): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+5 more)
...
Cohesion: 0.13
Nodes (15): Requirement: Aislamiento, roles y archivado de pedidos, Requirement: Edición de pedido, Scenario: Cambiar fecha y agregar una línea, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante intenta archivar, Scenario: El pedido archivado conserva su historia (+7 more)
...
Cohesion: 0.13
Nodes (14): Context, D1 · Las seis ranuras se declaran como datos, con su estado de disponibilidad, D2 · Las entradas de navegación ganan un campo `mobile`, no una lista aparte, D3 · "Registrado hoy" se compone en un servicio, sin vista de base de datos, D4 · La vista por omisión de pedidos se decide por user-agent, en el servidor, D5 · "Más" es un `Sheet`, no una página, D6 · *+ Registrar* es un botón flotante sobre la barra, no un elemento dentro de ella, D7 · Los destinos no disponibles son botones inertes con leyenda, no enlaces rotos (+6 more)
...
Cohesion: 0.14
Nodes (10): CatalogRow, CatalogScreen(), LINE, push, UNIT, { unmount }, user, { result } (+2 more)
...
Cohesion: 0.21
Nodes (6): InviteForm(), LoginForm(), metadata, metadata, createClient(), metadata

### Community 87 - "Community 87"
Cohesion: 0.27
Nodes (7): isProtectedPath(), PROTECTED_PREFIXES, sanitizeInternalPath(), GET(), config, proxy(), updateSession()
...
Cohesion: 0.2
Nodes (9): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+1 more)
...
Cohesion: 0.18
Nodes (9): ExpenseFilters, ExpenseRow, ExpenseTotals, ExpenseWithTotal, NO_MONEY, CostFormValues, PurchaseFormValues, PurchaseLineValues (+1 more)
...
Cohesion: 0.18
Nodes (11): Requirement: Detalle del pedido, Scenario: Acciones de edición y cancelación, Scenario: Bloque de cobros y saldo, Scenario: Cambio de estado desde el detalle, Scenario: Historial, Scenario: Imagen de referencia, Scenario: Pedido archivado, Scenario: Pedido completo (+3 more)
...
Cohesion: 0.2
Nodes (8): NO_MONEY, OrderFilters, OrderRow, OrderTotals, OrderWithTotal, OrderLineValues, Order, OrderKind
...
Cohesion: 0.22
Nodes (10): 16. Seguridad a nivel de fila (RLS), Bitácora: inalterable de verdad, Cómo se ocultan los costos al ayudante, code:sql (-- Tarea programada mensual (pg_cron): exportar y luego resu), code:sql (alter table orders enable row level security;), code:sql (alter table activity_log enable row level security;), code:sql (-- Líneas), Matriz de acceso (+2 more)
...
Cohesion: 0.22
Nodes (7): ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user
...
Cohesion: 0.28
Nodes (6): OrganizationProvider(), OrganizationState, MEMBERSHIPS, ORG, MembershipWithOrganization, Organization
...
Cohesion: 0.22
Nodes (6): CancelOrderButton(), CANCELADO, REGISTRADO, renombrado, user, Status
...
Cohesion: 0.22
Nodes (5): FakeClient, client, failing, [payload], row
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (9   |   await page.goto("/auth/login");), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.38
Nodes (5): defaultLandingPath(), metadata, SettingsLayout(), SETTINGS_SECTIONS, SettingsNav()
...
Cohesion: 0.29
Nodes (6): expenses Specification, Requirement: Pista del último precio en el formulario de compra, Requirements, Scenario: Insumo comprado antes, Scenario: Insumo nuevo, Scenario: La pista no cambia el valor
...
Cohesion: 0.53
Nodes (4): CLASSES, isLineColor(), LINE_COLOR_LABELS, LINE_COLORS
...
Cohesion: 0.5
Nodes (4): Requirement: Indicador de ventas pendientes de sincronizar, Scenario: Llega a cero al sincronizar, Scenario: Sin pendientes, Scenario: Sube al vender sin conexión
...
## Knowledge Gaps
- **2183 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2178 more)
...
- **Why does `cn()` connect `Community 0` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 104`, `Community 235`, `Community 44`, `Community 45`, `Community 46`, `Community 13`, `Community 17`, `Community 18`, `Community 26`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 18` to `Community 0`, `Community 66`, `Community 35`, `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 263`, `Community 104`, `Community 45`, `Community 46`, `Community 16`, `Community 17`, `Community 26`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `StatusService` connect `Community 90` to `Community 12`, `Community 45`, `Community 79`, `Community 51`, `Community 60`, `Community 191`?**
