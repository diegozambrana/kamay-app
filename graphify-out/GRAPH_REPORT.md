# Graph Report - kamay-app  (2026-09-05)

## Corpus Check
- 491 files · ~381,853 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4631 nodes · 7968 edges · 364 communities (345 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34722760`
...
3. `Button()` - 55 edges
4. `getSessionContext()` - 44 edges
5. `ADDED Requirements` - 33 edges
6. `Input()` - 30 edges
7. `BusinessLine` - 28 edges
...
## Communities (364 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (60): ContactCombobox(), ContactComboboxRole, metadata, CategoryChips(), AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf() (+52 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (59): cn(), Figure(), AlertAction(), AlertDialogMedia(), AlertDialogOverlay(), CardFooter(), DialogOverlay(), DropdownMenu() (+51 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (47): DataTable(), DataTableAction, DataTableColumn, columns, onAction, Row, rows, user (+39 more)
...
Cohesion: 0.05
Nodes (33): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+25 more)
...
Cohesion: 0.08
Nodes (32): useOnlineStatus(), AppSidebar(), Header(), MobileContextBar(), CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), pathname (+24 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (31): ActionResult, FormValues, schema, CatalogScreen(), VariantFormDialog(), ContactsScreen(), ROLE_FILTER_LABELS, roleSummary() (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (37): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, StatusInput, StatusRow, LineBadge(), DEFAULT_STATUS_SETS (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (31): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+23 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (35): addEntry(), _addRequest(), B(), deleteEntry(), fetchDidFail(), fromRequest(), G(), getAll() (+27 more)
...
Cohesion: 0.05
Nodes (41): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Authenticated shell frames every app screen, Requirement: No app screen scrolls horizontally on a phone, Requirement: Password recovery is available, Requirement: Session is refreshed on every request, Requirement: Sign-in lands on the device-appropriate home (+33 more)
...
Cohesion: 0.08
Nodes (26): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta], countItems() (+18 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (26): DataTableProps, DEFAULT_ROW_ACTIONS, ACTION_LABELS, ReceiptView, FileDropzoneProps, FilePreview(), isImage(), formatFileSize() (+18 more)
...
Cohesion: 0.07
Nodes (21): AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, OrderDetailPage() (+13 more)
...
Cohesion: 0.06
Nodes (35): ADDED Requirements, Purpose, Requirement: El registro rápido es la puerta del modo feria, Requirement: La pantalla de registro rápido ofrece seis destinos, Requirement: La retícula de registro rápido se filtra por rol, Requirement: Registrado hoy confirma la captura, Requirement: Registrado hoy cuenta también lo que no se ha enviado, Requirement: Registrar está a dos toques desde cualquier pantalla móvil (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (23): SessionContext, ExpenseCategoryService, ExpenseDetail(), ExpenseDetailData, ExpenseItemRow, ExpenseItemService, ExpenseItemWithNames, loadExpenseDetail() (+15 more)
...
Cohesion: 0.14
Nodes (30): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+22 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (25): CatalogRow, LINE, push, UNIT, { unmount }, user, ACTION_LABELS, ItemDetail() (+17 more)
...
Cohesion: 0.1
Nodes (19): ExpenseCard(), ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpensesScreen(), CheckoutSheet(), METHOD_LABELS, monto (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (21): backoffDelay(), hasExhaustedAttempts(), esperas, DrainDeps, drainOutbox(), resetDrainLock(), runDrain(), { enviados, resolveOperation } (+13 more)
...
Cohesion: 0.15
Nodes (17): createOutboxDatabase(), OutboxDatabase, holdMessage(), holdReason(), discardEntry(), enqueue(), retryEntry(), primera (+9 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (13): MembersSettingsPage(), metadata, InvitationRow, InvitationService, MembershipRow, client, failing, input (+5 more)
...
Cohesion: 0.22
Nodes (22): C(), cacheMatch(), cachePut(), clone(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+14 more)
...
Cohesion: 0.13
Nodes (14): registerDirectSale(), RegisterDirectSaleResult, DirectSaleInput, DirectSaleLineInput, directSaleLineSchema, DirectSalePaymentInput, directSalePaymentSchema, directSaleSchema (+6 more)

### Community 52 - "Community 52"
Cohesion: 0.15
Nodes (9): ContactFilters, ContactRow, ContactService, ContactFormValues, ContactsPage(), metadata, matchesSearch(), normalizeForSearch() (+1 more)
...
Cohesion: 0.11
Nodes (17): CostFormInput, costFormSchema, id, numeric, occurredAt, optionalId, optionalText, PurchaseFormInput (+9 more)

### Community 55 - "Community 55"
Cohesion: 0.13
Nodes (10): InviteForm(), LinesSettingsPage(), metadata, metadata, MembershipRow, MembershipService, BusinessLinesSection(), createClient() (+2 more)
...
Cohesion: 0.12
Nodes (12): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], UnitRow (+4 more)
...
Cohesion: 0.12
Nodes (16): orders Specification, Requirement: Cancelación de pedido, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Fecha comprometida con atajos, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: Cancelar con confirmación (+8 more)
...
Cohesion: 0.15
Nodes (11): capture(), CaptureDeps, CaptureResult, drain, draining, enqueue, entrada, DrainOutcomes (+3 more)
...
Cohesion: 0.14
Nodes (16): 15. Notificaciones, 16. Seguridad a nivel de fila (RLS), 18. Orden de migraciones, Bitácora: inalterable de verdad, Cómo se ocultan los costos al ayudante, code:sql (create trigger audit after insert or update on orders), code:sql (create table notifications (), code:sql (alter table orders enable row level security;) (+8 more)

### Community 77 - "Community 77"
Cohesion: 0.12
Nodes (16): Requirement: Aislamiento, roles y archivado de pedidos, Requirement: Edición de pedido, Scenario: Cambiar fecha y agregar una línea, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante intenta archivar (+8 more)
...
Cohesion: 0.29
Nodes (11): balance(), cents(), overpayment(), paymentStatus(), safe(), PaymentBlock(), money(), PaymentDialog() (+3 more)

### Community 93 - "Community 93"
Cohesion: 0.25
Nodes (11): a(), B(), D(), g(), i(), k(), Q(), y() (+3 more)
...
Cohesion: 0.18
Nodes (11): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+3 more)
...
Cohesion: 0.17
Nodes (12): Requirement: Detalle del pedido, Scenario: Acciones de edición y cancelación, Scenario: Bloque de cobros y saldo, Scenario: Cambio de estado desde el detalle, Scenario: Historial, Scenario: Imagen de referencia, Scenario: Pedido archivado, Scenario: Pedido completo (+4 more)
...
Cohesion: 0.22
Nodes (6): nav, pathname, Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
Cohesion: 0.25
Nodes (8): 11. Vistas derivadas, 12. Tareas, 13. Adjuntos, code:sql (-- Saldo actual por ítem), code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), Storage
...
Cohesion: 0.25
Nodes (7): catalog-directory Specification, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: Intento de editar un registro archivado, Scenario: Otra organización no ve nada

### Community 202 - "Community 202"
Cohesion: 0.29
Nodes (6): ADDED Requirements, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo
...
Cohesion: 0.4
Nodes (4): metadata, SettingsLayout(), SETTINGS_SECTIONS, SettingsNav()
...
Cohesion: 0.4
Nodes (5): 8. Egresos, Cobros y pagos, code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Contactos: proveedores, clientes, o ambos)
...
## Knowledge Gaps
- **2345 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2340 more)
...
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 2`, `Community 133`, `Community 6`, `Community 7`, `Community 8`, `Community 41`, `Community 270`, `Community 15`, `Community 14`, `Community 174`, `Community 50`, `Community 120`, `Community 27`, `Community 92`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `PaymentService` connect `Community 4` to `Community 9`, `Community 177`, `Community 22`, `Community 17`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `ItemService` connect `Community 19` to `Community 9`, `Community 52`, `Community 29`, `Community 17`?**
