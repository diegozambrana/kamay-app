...
## Corpus Check
- 150 files · ~104,250 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1218 nodes · 1698 edges · 99 communities (88 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `90f53126`
...
1. `getOwnerContext()` - 33 edges
2. `7. Mapa de Vistas / Pantallas` - 24 edges
3. `cn()` - 21 edges
4. `Kamay — Esquema de Base de Datos (Supabase / PostgreSQL)` - 21 edges
5. `Kamay — Arquitectura del Proyecto` - 15 edges
6. `Kamay — Mapa de Interfaz y Navegación` - 15 edges
7. `Kamay — Documento de Especificación de Producto` - 15 edges
8. `Button()` - 14 edges
9. `resolvePostAuthPath()` - 13 edges
10. `Decisions` - 13 edges
...
Cohesion: 0.08
Nodes (31): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), InviteForm() (+23 more)
...
Cohesion: 0.2
Nodes (20): ActionResult, FormValues, schema, cn(), metadata, ConfigEntity, ConfigItem, ConfigList() (+12 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (31): ADDED Requirements, Purpose, Requirement: A new business line is usable immediately, Requirement: Archiving hides a line from new work without erasing its history, Requirement: Configuration tables exist with the canonical shape, Requirement: Exactly one shared business line exists and cannot be archived, Requirement: Geeko Store is seeded with its real lines and channels, Requirement: General settings of the organization are editable (+23 more)
...
Cohesion: 0.08
Nodes (16): Call, FakeClient, FakeQuery, FakeResult, query, result, client, failing (+8 more)

### Community 12 - "Community 12"
Cohesion: 0.17
Nodes (25): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createSalesChannel(), createUnit(), entities, Entity, generalSchema (+17 more)
...
Cohesion: 0.23
Nodes (13): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineOption(), LineSelector(), BusinessLineState, LINE (+5 more)
...
Cohesion: 0.17
Nodes (12): Header(), NAV_ENTRIES, navEntriesFor(), NavEntry, hrefs, UserProvider(), MEMBERSHIP, USER (+4 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (17): ADDED Requirements, Purpose, Requirement: The active line is resolved on the server before the first render, Requirement: The active line preselects the line in creation forms, Requirement: The selection survives navigation between sections, Requirement: The selection survives the end of the session, Requirement: The shell offers a global business line selector, Scenario: A selection pointing at an archived or foreign line is discarded (+9 more)

### Community 22 - "Community 22"
Cohesion: 0.18
Nodes (10): AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION, MainContainer() (+2 more)
...
Cohesion: 0.14
Nodes (10): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], SalesChannelRow (+2 more)
...
Cohesion: 0.22
Nodes (10): OrganizationProvider(), MEMBERSHIP, ORG, USER, OrganizationState, MEMBERSHIPS, ORG, useOrganizationStore (+2 more)

### Community 29 - "Community 29"
Cohesion: 0.15
Nodes (13): 11. Vistas derivadas, 13. Adjuntos, 17. Sincronización sin conexión, 19. Lo que este esquema aún no incluye, 1. Alcance y advertencia, 20. Lista de verificación antes de producción, 2. Cómo se traducen los principios, 3. Convenciones (+5 more)

### Community 30 - "Community 30"
Cohesion: 0.23
Nodes (7): selectBusinessLine(), getSessionContext(), SessionContext, lineCookieName(), MembershipRow, MembershipService, Role

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (7): createExpenseCategory(), CategoriesSettingsPage(), metadata, ExpenseCategoryRow, ExpenseCategoryService, NamedSection(), ExpenseCategory

### Community 32 - "Community 32"
Cohesion: 0.2
Nodes (6): BusinessLineRow, BusinessLineService, LinesSettingsPage(), metadata, BusinessLinesSection(), LineColor
...
## Knowledge Gaps
- **600 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `geistSans` (+595 more)
...
- **Why does `Kamay — Documento de Especificación de Producto` connect `Community 40` to `Community 38`, `Community 8`, `Community 72`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 15`, `Community 50`, `Community 62`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `getOwnerContext()` connect `Community 12` to `Community 32`, `Community 1`, `Community 34`, `Community 33`, `Community 5`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `6. Funcionalidades Clave` connect `Community 8` to `Community 40`?**
