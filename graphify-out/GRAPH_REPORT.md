...
## Corpus Check
- 420 files · ~327,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3646 nodes · 6385 edges · 297 communities (283 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27e47aa7`
...
Cohesion: 0.07
Nodes (51): FormValues, schema, ACTION_LABELS, itemVariantFormSchema, VariantFormDialog(), VariantsList(), ExpenseCard(), ACTION_LABELS (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (55): ItemThumbnail(), useIsMobile(), cn(), AlertAction(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+47 more)
...
Cohesion: 0.05
Nodes (37): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+29 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (29): SessionContext, AttachmentRow, AttachmentService, NewAttachment, BusinessLineRow, BusinessLineService, [archivePayload], channelRow (+21 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (36): user, ThemeToggle(), AppSidebar(), nav, pathname, Header(), MobileContextBar(), CAPTURE_ROUTES (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (49): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+41 more)
...
Cohesion: 0.1
Nodes (29): ContactComboboxRole, PurchaseLineErrors, BoardOrder, CalendarView(), CatalogPicker(), DueDateField(), { onChange, user }, PickableItem (+21 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (31): AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm(), ReceiptField(), useReceiptUploadStore, DiscardGuard() (+23 more)
...
Cohesion: 0.11
Nodes (37): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+29 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (27): ItemPhotos(), DataTableAction, DataTableProps, DEFAULT_ROW_ACTIONS, METHOD_LABELS, AlertDialog(), AlertDialogAction(), AlertDialogCancel() (+19 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (29): selectBusinessLine(), LineOption(), LineSelector(), ExpenseItemRow, ExpenseItemService, ExpenseItemWithNames, NO_MONEY, OrderFilters (+21 more)
...
Cohesion: 0.14
Nodes (24): AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION, CatalogPage() (+16 more)
...
Cohesion: 0.09
Nodes (22): metadata, FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), onChange, pdf, photo (+14 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (24): ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user, ItemFormDialog() (+16 more)
...
Cohesion: 0.16
Nodes (18): STATUS_KIND_LABELS, metadata, StatusesSettingsPage(), setIsComplete(), statusFlowSchema, statusFormSchema, StatusFormValues, result (+10 more)
...
Cohesion: 0.14
Nodes (16): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineBadge(), LinesSettingsPage(), metadata, DELIVERY_LABELS (+8 more)
...
Cohesion: 0.16
Nodes (13): CategoryChips(), ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpenseCategory, Checkbox() (+5 more)

### Community 42 - "Community 42"
Cohesion: 0.19
Nodes (13): ExpenseCategoryRow, ExpenseCategoryService, ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad() (+5 more)
...
Cohesion: 0.12
Nodes (9): MembersSettingsPage(), metadata, InvitationRow, InvitationService, MembershipRow, toInvitation(), MembersSection(), Invitation (+1 more)

### Community 46 - "Community 46"
Cohesion: 0.15
Nodes (13): ExpenseRowView, ExpensesScreen(), FILTERS, push, renderScreen(), ROWS, user, PurchaseLinesTable() (+5 more)
...
Cohesion: 0.2
Nodes (11): selectOrganization(), defaultLandingPath(), PROTECTED_PREFIXES, sanitizeInternalPath(), sanitizeNextPath(), GET(), ExpensesLayout(), metadata (+3 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (13): OrderFormState, CHANNELS, CLIENTA, { container, user }, defaults(), grande, LINES, primero (+5 more)
...
Cohesion: 0.13
Nodes (14): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: Modo de entrega fuera del dominio (+6 more)
...
Cohesion: 0.22
Nodes (10): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, updatePassword(), resolvePostAuthPath(), setActiveOrganizationCookie() (+2 more)

### Community 69 - "Community 69"
Cohesion: 0.21
Nodes (12): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+4 more)
...
Cohesion: 0.27
Nodes (10): add, back, remove, { rerender }, user, balance(), cents(), overpayment() (+2 more)

### Community 73 - "Community 73"
Cohesion: 0.19
Nodes (7): InviteForm(), LoginForm(), LoginPage(), metadata, metadata, createClient(), metadata
...
Cohesion: 0.19
Nodes (7): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito
...
Cohesion: 0.17
Nodes (8): ContactCombobox(), AMBOS, ANDINA, CLIENTA, CREATED, onSelect, step, user
...
Cohesion: 0.24
Nodes (9): LineAmounts, lineTotal(), orderTotal(), pickerCandidates(), prefilledPrice(), catalogo, names, toNumber() (+1 more)
...
Cohesion: 0.2
Nodes (7): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user
...
Cohesion: 0.2
Nodes (10): Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo (+2 more)
...
Cohesion: 0.25
Nodes (6): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Pantalla de contactos (V13), Scenario: Filtro por rol, Scenario: Selección sin abandonar la pantalla
...
Cohesion: 0.25
Nodes (8): Requirement: El alta es una sola operación y el estado inicial lo asigna la base, Scenario: Alta registrada en la bitácora, Scenario: El alta de pedidos exige cliente, Scenario: El alta de pedidos no crea ventas directas, Scenario: La base rechaza el alta sin líneas, Scenario: Nace en el estado inicial de su línea, Scenario: Renombrar el estado inicial no cambia el comportamiento, Scenario: Un fallo deja todo como estaba

### Community 164 - "Community 164"
Cohesion: 0.25
Nodes (8): Requirement: Vistas alternativas y filtros del tablero, Scenario: La venta directa no aparece en el tablero, Scenario: La venta directa tampoco aparece en lista ni calendario, Scenario: Los filtros sobreviven al cambio de vista, Scenario: Pedido archivado oculto por defecto, Scenario: Ver archivados, Scenario: Ver archivados no la trae de vuelta, Scenario: Vista de calendario
...
Cohesion: 0.33
Nodes (6): Requirement: Detalle del egreso, Scenario: Compra completa, Scenario: Compra completa, Scenario: Enlace directo, Scenario: Gasto asignado a un pedido, Scenario: Historial
...
Cohesion: 0.4
Nodes (5): Requirement: Adjuntos del pedido, Scenario: Alta con imagen de referencia, Scenario: Archivo demasiado pesado, Scenario: La subida falla pero el pedido queda, Scenario: Quitar un adjunto desde la edición
...
Cohesion: 0.5
Nodes (4): Requirement: Guardar y Guardar y crear otro, Scenario: El pedido guardado existe, Scenario: Guardar lleva al detalle, Scenario: Guardar y crear otro conserva línea y canal
...
## Knowledge Gaps
- **1839 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+1834 more)
...
- **Why does `cn()` connect `Community 1` to `Community 32`, `Community 0`, `Community 5`, `Community 6`, `Community 39`, `Community 8`, `Community 9`, `Community 41`, `Community 12`, `Community 13`, `Community 48`, `Community 19`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `getOwnerContext()` connect `Community 11` to `Community 32`, `Community 3`, `Community 4`, `Community 69`, `Community 6`, `Community 7`, `Community 42`, `Community 45`, `Community 79`, `Community 48`, `Community 17`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `PaymentService` connect `Community 3` to `Community 17`, `Community 42`, `Community 4`, `Community 125`?**
