...
## Corpus Check
- 1146 files · ~1,146,918 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10566 nodes · 18073 edges · 787 communities (758 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 150 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fdfad72e`
...
## Communities (787 total, 29 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (91): FormValues, schema, ActionResult, ACTION_LABELS, ActivityFiltersProps, FilterOption, DeclarableAsset, DeclareAssetDialog() (+83 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (88): createTask(), ActivityListProps, ActivityRowItem, metadata, BoardTask, BoardView(), CalendarView(), KanbanBoard() (+80 more)
...
Cohesion: 0.04
Nodes (70): ActivityRow(), renderValue(), HistoryEntry(), AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine() (+62 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (78): ProfileForm(), FormValues, LoginForm(), schema, AssistantDashboardProps, DeliveryRow, MonthCashFlow, PENDING_KINDS (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (80): UserMenu(), BoardColumn(), DraggableCard(), LineOption(), LineSelector(), ItemThumbnail(), user, ThemeToggle() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (81): Detail(), ORIGIN_LABELS, CATALOG_FILTERS, ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps (+73 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (71): relatedTasksFor(), unlinkTask(), EventDetail, RecordHistory, RecordHistoryItem, ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps (+63 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (56): selectBusinessLine(), metadata, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+48 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (60): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (58): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), useSignOut(), ConsumptionDialog(), estado, item, onOpenChange, links (+50 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (50): backoffDelay(), hasExhaustedAttempts(), esperas, CaptureDeps, CaptureResult, drain, draining, enqueue (+42 more)
...
Cohesion: 0.06
Nodes (39): estado, Redirect, changePassword(), changePasswordSchema, displayNameSchema, ProfileActionResult, updateDisplayName(), loadRecordHistory() (+31 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (42): AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema, selectOrganization(), signOut() (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (36): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, resolveSearch(), AllocationRuleService, CsvContext (+28 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (35): AccountLayout(), NoOrganizationNotice(), ProfileView, ROLE_LABELS, organization, view, AppLayout(), AccessInput (+27 more)
...
Cohesion: 0.07
Nodes (35): addAccountByEmail(), AddUserResult, addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue(), inviteToOrganization() (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (31): ajenos, todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn(), plan (+23 more)
...
Cohesion: 0.06
Nodes (30): CatalogPage(), metadata, itemKindSchema, CatalogScope, ContactScope, joinsCatalogWindow(), all, archived (+22 more)
...
Cohesion: 0.09
Nodes (34): addLine(), CartBar(), onCheckout, onRemove, CartLine, cartTotal(), cartUnits(), cents() (+26 more)
...
Cohesion: 0.08
Nodes (37): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue() (+29 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (27): ItemPhotos(), DataTable(), DataTableColumn, DataTableProps, columns, onAction, Row, rows (+19 more)
...
Cohesion: 0.1
Nodes (26): PlatformActionResult, CreateOrganizationDialog(), OrganizationDetail(), TeamMember, MembershipEmbed, OrganizationInput, OrganizationRow, OrganizationSummary (+18 more)
...
Cohesion: 0.06
Nodes (24): client, opciones, client, update, Call, FakeClient, FakeResult, query (+16 more)
...
Cohesion: 0.09
Nodes (21): { result }, MobileContextBar(), tira, countItems(), EMPTY, resolveItems(), SyncCounts, SyncState (+13 more)
...
Cohesion: 0.08
Nodes (19): first, row, filas, detalle, monto, fila, vinculo, clone() (+11 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (15): original, link, alreadyThere, cambios, option, recorrido, elapsed, MID_RANGE (+7 more)
...
Cohesion: 0.11
Nodes (19): GET(), ArchiveEntry, exportFilename(), files, zipStream(), csvLine(), ExportService, Row (+11 more)
...
Cohesion: 0.1
Nodes (10): ItemFilters, ItemRow, ItemService, toNumber(), VariantRow, ItemFormValues, matchesSearch(), normalizeForSearch() (+2 more)
...
Cohesion: 0.1
Nodes (18): LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames, PurchaseLinesTable(), HINTS, quantity, row (+10 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (11): makeThumbnail(), blob, broken, pdf, thumbnailPath(), AttachmentRow, AttachmentService, CopiedAttachment (+3 more)
...
Cohesion: 0.13
Nodes (17): comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon } (+9 more)
...
Cohesion: 0.14
Nodes (18): AllocationResult, ExpenseBreakdownReport(), Group, LowStockReport(), link, renderReport(), row, ROWS (+10 more)

### Community 67 - "Community 67"
Cohesion: 0.14
Nodes (18): RetentionJobDeps, emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron() (+10 more)
...
Cohesion: 0.08
Nodes (22): renderMenu(), renderScreen(), task(), item(), renderDetail(), renderTable(), declareDeliverable, renderSection() (+14 more)
...
Cohesion: 0.13
Nodes (18): buildDetail(), ChangePair, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds(), RenderContext (+10 more)
...
Cohesion: 0.13
Nodes (17): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+9 more)
...
Cohesion: 0.14
Nodes (18): ActivityFilterBar(), ActivityDay, ActivityList(), actorOf(), capitalize(), contract(), DescribableEvent, describeEvent() (+10 more)
...
Cohesion: 0.1
Nodes (18): captureSale, channels, enlaces, products, readSnapshot, renderScreen(), saveSnapshot, [taza, maceta] (+10 more)
...
Cohesion: 0.16
Nodes (19): ACTIONS, ActivityAction, activityHref(), ANY, EMPTY_FILTERS, hasActiveFilters(), isRealCivilDate(), normalizeRange() (+11 more)
...
Cohesion: 0.11
Nodes (16): AssetDetailView, acquisition, breakdown, detail, entries, links, maintenance, relatedTasksFor (+8 more)
...
Cohesion: 0.14
Nodes (13): ChartDatum, ReportChart(), ReportChartImpl, ChartConfig, ChartContainer(), ChartContext, ChartContextProps, ChartLegendContent() (+5 more)
...
Cohesion: 0.11
Nodes (18): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+10 more)
...
Cohesion: 0.16
Nodes (13): AllocatedLine, allocateSharedExpenses(), ComparisonRow, composeLegend(), distribute(), fromCents(), RULE_LABEL, result (+5 more)
...
Cohesion: 0.15
Nodes (13): amount, collectionSchema, CollectionValues, id, method, movement, occurredAt, optionalText (+5 more)
...
Cohesion: 0.13
Nodes (11): EditorLine, OrderLinesEditor(), cantidad, CATALOGO, { onAdd, user }, { onRemove, user }, precio, renderEditor() (+3 more)
...
Cohesion: 0.13
Nodes (14): payments Specification, Requirement: Aislamiento por organización de los movimientos, Requirement: Registrar un pago desde el detalle del egreso, Requirement: Un movimiento registrado no se edita, Requirements, Scenario: Archivar sí está permitido, Scenario: Corrección por la vía prevista, Scenario: Crear en organización ajena (+6 more)
...
Cohesion: 0.14
Nodes (11): ADDED Requirements, Purpose, Requirement: Entradas al alta y a la edición, Requirement: Las consultas de ingresos incluyen las ventas directas, Scenario: Desde el detalle, Scenario: Desde el tablero, Scenario: El cobrado también suma, Scenario: Ingresos de la línea (+3 more)
...
Cohesion: 0.15
Nodes (10): ADDED Requirements, Purpose, Requirement: Líneas de compra con precio propio, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta (+2 more)
...
Cohesion: 0.23
Nodes (9): StatusInput, StatusRow, DEFAULT_STATUS_SETS, defaultSetAsJson(), DefaultStatus, kinds, positions, STATUS_FLOWS (+1 more)
...
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: Alta de un activo desde el catálogo, Requirement: Un activo sin línea propia no muestra porcentaje, Scenario: Activo compartido, Scenario: Alta desde el detalle del ítem, Scenario: El ayudante no ve la sección, Scenario: No se ofrece donde no corresponde (+1 more)

### Community 272 - "Community 272"
Cohesion: 0.18
Nodes (10): assets Specification, Requirement: Alta de un activo desde el registro de una compra, Requirement: Semilla de activos de Geeko Store, Requirements, Scenario: Compra de una máquina, Scenario: Las barras no salen todas iguales, Scenario: Las cifras prellenadas se pueden ajustar, Scenario: Rechazar no bloquea la compra (+2 more)
...
Cohesion: 0.24
Nodes (9): EXCLUDED_COLUMNS, EXCLUDED_TABLES, catalog, catalogTables(), expected, files, organizationTables, ownerOnlyTables() (+1 more)
...
Cohesion: 0.25
Nodes (7): activity-log Specification, Requirement: Activity log table stores every audited event, Requirement: Successive edits by the same author are merged, Requirements, Scenario: Edits by different users are not merged, Scenario: Invalid action is rejected, Scenario: Two edits within five minutes produce one event
...
Cohesion: 0.29
Nodes (6): barra, block, mas, panel, pathname, renderNav()
...
Cohesion: 0.29
Nodes (6): reports Specification, Requirement: La pantalla responde dentro de su presupuesto, Requirement: Los informes se adaptan al móvil, Requirements, Scenario: Doce meses de datos, Scenario: Un informe por pantalla
...
Cohesion: 0.4
Nodes (4): metadata, StatusesSettingsPage(), statusFlowSchema, StatusesSection()
...
Cohesion: 0.5
Nodes (3): DueDateField(), { onChange, user }, renderField()
...
## Knowledge Gaps
- **5597 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+5592 more)
...
- **Why does `useSearchReset()` connect `Community 1` to `Community 13`, `Community 6`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 13` to `Community 1`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `H()` connect `Community 2` to `Community 13`?**
...
- **What connects `config`, `config`, `eslintConfig` to the rest of the system?**
  _5597 weakly-connected nodes found - possible documentation gaps or missing edges._
