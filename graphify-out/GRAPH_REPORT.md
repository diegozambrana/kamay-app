...
## Corpus Check
- 624 files · ~484,472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5894 nodes · 10037 edges · 463 communities (439 shown, 24 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7ca608a`
...
1. `cn()` - 200 edges
2. `getSessionContext()` - 64 edges
3. `Button()` - 62 edges
4. `getOwnerContext()` - 62 edges
5. `BusinessLine` - 38 edges
6. `Input()` - 36 edges
7. `ADDED Requirements` - 33 edges
8. `Badge()` - 30 edges
9. `BusinessLineService` - 28 edges
...
## Communities (463 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (59): ContactCombobox(), ContactComboboxRole, TaskFieldsProps, AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+51 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (69): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+61 more)
...
Cohesion: 0.06
Nodes (43): BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd(), created, link, onError (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (41): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+33 more)
...
Cohesion: 0.08
Nodes (44): ACTION_LABELS, ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (40): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, ACCEPTED_TYPES (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (38): FormValues, schema, CatalogScreen(), contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name (+30 more)
...
Cohesion: 0.05
Nodes (43): ADDED Requirements, MODIFIED Requirements, Purpose, quick-capture Specification, RENAMED Requirements, Requirement: El registro rápido es la puerta del modo feria, Requirement: La pantalla de registro rápido ofrece seis destinos, Requirement: La retícula de registro rápido se filtra por rol (+35 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (28): ACTION_LABELS, DetailBody(), ReceiptView, ExpenseItemRow, ExpenseItemWithNames, ExitFairMode(), salida, FileDropzone() (+20 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (43): cn(), Figure(), AlertAction(), CardFooter(), DialogOverlay(), EmptyContent(), FieldContent(), FieldSeparator() (+35 more)
...
Cohesion: 0.09
Nodes (25): MobileContextBar(), tira, OrganizationState, MEMBERSHIPS, ORG, useOrganizationStore, countItems(), EMPTY (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (29): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user, LastCostHint (+21 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (37): activity-log Specification, ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Action kind is derived from the nature of the change, Requirement: Activity log table stores every audited event, Requirement: An event can be rendered as a natural-language sentence, Requirement: Every INSERT on an audited table produces a created event (+29 more)
...
Cohesion: 0.09
Nodes (28): addEntry(), _addRequest(), B(), deleteEntry(), fetchDidFail(), fromRequest(), getAll(), getAllEntriesByQueueName() (+20 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (26): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], SalesChannelRow (+18 more)
...
Cohesion: 0.08
Nodes (27): archiveTask(), attachmentIdSchema, createTask(), CreateTaskResult, detachFromTask(), moveTaskSchema, moveTaskToStatus(), revalidateTasks() (+19 more)

### Community 25 - "Community 25"
Cohesion: 0.12
Nodes (34): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+26 more)
...
Cohesion: 0.08
Nodes (18): OrderContext, prefillFromOrder(), TaskPrefill, ORDER, prefill, quickTaskSchema, TaskInput, taskSchema (+10 more)
...
Cohesion: 0.11
Nodes (22): isCaptureRoute(), destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, labels, pendientes, tarea (+14 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (23): registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot, saveSnapshot (+15 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (14): ContactFilters, ContactRow, ContactService, ContactFormValues, ContactsPage(), metadata, matchesSearch(), normalizeForSearch() (+6 more)
...
Cohesion: 0.13
Nodes (18): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+10 more)

### Community 37 - "Community 37"
Cohesion: 0.1
Nodes (13): StatusInput, StatusRow, StatusService, DEFAULT_STATUS_SETS, defaultSetAsJson(), DefaultStatus, kinds, positions (+5 more)

### Community 38 - "Community 38"
Cohesion: 0.12
Nodes (23): CAPTURE_ROUTES, MobileNav(), barra, mas, panel, pathname, barHrefOf(), barLabelOf() (+15 more)

### Community 39 - "Community 39"
Cohesion: 0.14
Nodes (21): ExpenseCard(), KIND_LABELS, ExpenseRows(), LineBadge(), UploadIndicator(), ExpenseRowView, ReceiptUpload, formatDate() (+13 more)
...
Cohesion: 0.09
Nodes (15): MembersSettingsPage(), metadata, InvitationRow, InvitationService, MembershipRow, client, failing, input (+7 more)

### Community 42 - "Community 42"
Cohesion: 0.11
Nodes (16): MarkdownEditor(), MarkdownEditorProps, area, { onSave }, user, TOOLS, CategoryChips(), METHOD_LABELS (+8 more)

### Community 43 - "Community 43"
Cohesion: 0.17
Nodes (26): C(), cacheMatch(), cachePut(), clone(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+18 more)

### Community 44 - "Community 44"
Cohesion: 0.13
Nodes (22): reorderQueue(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardColumn(), DraggableCard(), Midpoint (+14 more)
...
Cohesion: 0.1
Nodes (16): ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle, resultado (+8 more)
...
Cohesion: 0.16
Nodes (14): defaultLandingPath(), isMobileUserAgent(), isProtectedPath(), PROTECTED_PREFIXES, sanitizeInternalPath(), GET(), ExpensesLayout(), config (+6 more)
...
Cohesion: 0.11
Nodes (18): ExpenseFilters, ExpenseRow, ExpenseTotals, NO_MONEY, CostFormInput, CostFormValues, id, numeric (+10 more)
...
Cohesion: 0.17
Nodes (14): SessionContext, ExpenseItemService, loadExpenseDetail(), ExpensesPage(), currentMonthRange(), DateRange, isCivilDate(), pad() (+6 more)
...
Cohesion: 0.15
Nodes (11): GeneralSettingsPage(), metadata, OrganizationRow, OrganizationService, client, failing, [payload], row (+3 more)

### Community 76 - "Community 76"
Cohesion: 0.17
Nodes (14): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, memberLinesSchema (+6 more)

### Community 77 - "Community 77"
Cohesion: 0.19
Nodes (11): LineCashFlow, OwnerDashboard(), OwnerDashboardProps, activity, comparison, deliveries, ActivityItem, RecentActivity() (+3 more)
...
Cohesion: 0.19
Nodes (8): ItemFilters, ItemRow, ItemVariantService, toNumber(), variantFromRow(), VariantRow, ItemFormValues, ItemVariantFormValues

### Community 92 - "Community 92"
Cohesion: 0.12
Nodes (16): Requirement: Detalle del pedido, Scenario: Acciones de edición y cancelación, Scenario: Bloque de cobros y saldo, Scenario: Cambiar de estado no crea ninguna tarea, Scenario: Cambio de estado desde el detalle, Scenario: Crear tarea para este pedido, Scenario: Historial, Scenario: Imagen de referencia (+8 more)
...
Cohesion: 0.17
Nodes (8): archive(), list(), listActive(), listAll(), patch(), unarchive(), ExpenseCategoryRow, ExpenseCategoryService

### Community 101 - "Community 101"
Cohesion: 0.18
Nodes (7): LineOption(), LineSelector(), user, ThemeToggle(), Header(), bell, SidebarProvider()
...
Cohesion: 0.19
Nodes (10): FILTERS, push, renderScreen(), ROWS, user, cents(), PurchaseLineAmount, purchaseTotal() (+2 more)
...
Cohesion: 0.22
Nodes (9): AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, root, LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard() (+1 more)
...
Cohesion: 0.21
Nodes (8): NotificationBell(), Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle()
...
Cohesion: 0.17
Nodes (12): 10. Inventario, 12. Tareas, 17. Sincronización sin conexión, 19. Lo que este esquema aún no incluye, 1. Alcance y advertencia, 20. Lista de verificación antes de producción, 2. Cómo se traducen los principios, 3. Convenciones (+4 more)
...
Cohesion: 0.18
Nodes (11): TaskFields(), assignees, lines, onSave, recordatorio, renderFields(), statuses, task() (+3 more)

### Community 138 - "Community 138"
Cohesion: 0.21
Nodes (10): ChecklistItem, parseChecklistItems(), antes, body, despues, HORNADA, items, marcado (+2 more)

### Community 139 - "Community 139"
Cohesion: 0.2
Nodes (8): ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseWithTotal, ExpensesScreen(), ExpenseSummary, useIsMobile()
...
Cohesion: 0.2
Nodes (7): AppSidebar(), nav, pathname, Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
Cohesion: 0.38
Nodes (6): todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn()

### Community 170 - "Community 170"
Cohesion: 0.2
Nodes (9): client, entrada, inserted, otra, patch, read, row, withArchived (+1 more)
...
Cohesion: 0.28
Nodes (6): ACTION_LABELS, TaskHistory(), TaskHistoryProps, filas, pendiente, ActivityEntry
...
Cohesion: 0.25
Nodes (9): a, _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), n, o (+1 more)

### Community 228 - "Community 228"
Cohesion: 0.28
Nodes (6): OrganizationProvider(), MEMBERSHIP, ORG, USER, UserProvider(), MembershipWithOrganization
...
Cohesion: 0.22
Nodes (6): CatalogRow, LINE, push, UNIT, { unmount }, user
...
Cohesion: 0.22
Nodes (8): dashboard Specification, Requirement: El panel carga dentro de su presupuesto, Requirement: Marcadores de posición declarados, Requirements, Scenario: Doce meses sembrados, Scenario: El marcador no engaña, Scenario: Los dos marcadores están rotulados, Scenario: Nada se precalcula en una columna
...
Cohesion: 0.29
Nodes (5): DELIVERY_LABELS, items, { rerender, container }, UpcomingDeliveries(), formatCalendarDate()
...
Cohesion: 0.25
Nodes (8): 11. Vistas derivadas, 13. Adjuntos, code:sql (create table payments (), code:sql (-- Saldo actual por ítem), code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), Storage

### Community 257 - "Community 257"
Cohesion: 0.25
Nodes (8): 8. Egresos, 9. Pedidos y ventas, Cobros y pagos, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table orders (), code:sql (-- Contactos: proveedores, clientes, o ambos), Una decisión que conviene revisar
...
Cohesion: 0.25
Nodes (8): Requirement: Flujo de caja del periodo por línea, Scenario: Cada movimiento cae en el mes en que ocurrió, Scenario: Cobrado y pagado del mes, Scenario: El ayudante obtiene cero filas, Scenario: El movimiento anulado no suma, Scenario: La línea la pone el destino, Scenario: Ninguna organización ve a otra, Scenario: Un mes sin movimiento no inventa filas

### Community 261 - "Community 261"
Cohesion: 0.29
Nodes (6): ADDED Requirements, Purpose, Requirement: El vínculo de una tarea con un pedido se guarda desde el primer día, Scenario: El vínculo sigue la visibilidad de su tarea, Scenario: Vínculo a un registro inexistente, Scenario: Vínculo duplicado
...
Cohesion: 0.29
Nodes (6): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirements, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo
...
Cohesion: 0.29
Nodes (7): Requirement: Detalle del egreso, Scenario: Compra completa, Scenario: Compra completa, Scenario: Compra completa, Scenario: Enlace directo, Scenario: Gasto asignado a un pedido, Scenario: Historial

### Community 325 - "Community 325"
Cohesion: 0.29
Nodes (7): Requirement: Modelo de egreso con dos tipos en una sola tabla, Scenario: Compra con monto propio, Scenario: Compra sin proveedor, Scenario: Egreso sin línea de negocio, Scenario: Gasto sin categoría, Scenario: Gasto sin monto, Scenario: Identificador y fecha del hecho fijados por el cliente
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: El panel es utilizable en un teléfono, Scenario: El aterrizaje no cambia, Scenario: Una columna en 390 px
...
Cohesion: 0.4
Nodes (4): ADDED Requirements, Purpose, Requirement: Un registro archivado no se edita sin desarchivarlo, Scenario: Intento de editar un registro archivado
...
Cohesion: 0.33
Nodes (6): Requirement: Vistas lista y calendario y filtros del tablero, Scenario: Filtro por responsable, Scenario: Los filtros sobreviven al cambio de vista, Scenario: Tarea archivada oculta por defecto, Scenario: Un tablero enlazable, Scenario: Vista de calendario
...
Cohesion: 0.33
Nodes (6): Requirement: El arrastre funciona en ambos sentidos y sin efectos secundarios, Scenario: El historial recoge el ir y venir, Scenario: El movimiento se ve antes que la respuesta, Scenario: Movimiento rechazado, Scenario: Retroceder desde un estado final reabre la tarea, Scenario: Volver a una columna anterior
...
Cohesion: 0.4
Nodes (4): Call, FakeResult, query, result
...
Cohesion: 0.4
Nodes (5): Requirement: Tarjeta de tarea, Scenario: Color de línea con el filtro en Todas, Scenario: Fecha límite vencida, Scenario: Responsable visible, Scenario: Tarea sin fecha
...
Cohesion: 0.5
Nodes (3): UnitsSection(), metadata, UnitsSettingsPage()

### Community 405 - "Community 405"
Cohesion: 0.5
Nodes (3): LinesSettingsPage(), metadata, BusinessLinesSection()
...
Cohesion: 0.5
Nodes (4): Requirement: Pantalla de detalle de ítem (V11), Scenario: Historial en el detalle, Scenario: Sin secciones de inventario ni costos, Scenario: Variantes gestionadas desde el detalle

### Community 417 - "Community 417"
Cohesion: 0.5
Nodes (4): Requirement: Un ítem declara su tipo, su unidad y su alcance de línea, Scenario: Activo registrado como ítem, Scenario: Ítem compartido entre líneas, Scenario: Ítem de una línea concreta
...
Cohesion: 0.5
Nodes (4): Requirement: Pantalla de catálogo (V10), Scenario: Fila que abre el detalle, Scenario: Pestañas por tipo, Scenario: Sin columnas de inventario ni costo
...
Cohesion: 0.67
Nodes (3): Requirement: Pantalla de contactos (V13), Scenario: Filtro por rol, Scenario: Selección sin abandonar la pantalla
...
Cohesion: 0.67
Nodes (3): Requirement: Semilla de catálogo y directorio de Geeko Store, Scenario: La búsqueda de la semilla tolera acentos, Scenario: Semilla presente tras el reinicio

### Community 445 - "Community 445"
Cohesion: 0.67
Nodes (3): Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Scenario: Alta y cambio quedan en la bitácora, Scenario: Otra organización no ve nada

## Knowledge Gaps
- **3069 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+3064 more)
...
- **Why does `cn()` connect `Community 13` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 8`, `Community 12`, `Community 16`, `Community 22`, `Community 155`, `Community 31`, `Community 34`, `Community 38`, `Community 39`, `Community 42`, `Community 44`, `Community 48`, `Community 52`, `Community 53`, `Community 440`, `Community 76`, `Community 86`, `Community 221`, `Community 101`, `Community 249`, `Community 122`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 12` to `Community 0`, `Community 1`, `Community 3`, `Community 36`, `Community 101`, `Community 6`, `Community 7`, `Community 8`, `Community 42`, `Community 139`, `Community 76`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 25`, `Community 122`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `captureSale()` connect `Community 2` to `Community 32`, `Community 14`?**
