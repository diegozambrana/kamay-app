...
## Corpus Check
- 170 files · ~119,108 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1387 nodes · 2020 edges · 106 communities (96 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84e26ee7`
...
Cohesion: 0.06
Nodes (57): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), ActionResult (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (40): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, BusinessLineRow, StatusInput, StatusRow, StatusService (+32 more)
...
Cohesion: 0.09
Nodes (19): archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema, revokeInvitation() (+11 more)
...
Cohesion: 0.19
Nodes (24): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+16 more)
...
Cohesion: 0.12
Nodes (13): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], UnitRow (+5 more)

### Community 22 - "Community 22"
Cohesion: 0.21
Nodes (11): findActiveLine(), preselectedLineId(), ajena, ALFARERIA, SUBLIMACION, BusinessLineState, LINE, useBusinessLineStore (+3 more)
...
Cohesion: 0.19
Nodes (8): user, ThemeToggle(), Header(), NAV_ENTRIES, navEntriesFor(), NavEntry, hrefs, Role
...
Cohesion: 0.2
Nodes (6): ChannelsSettingsPage(), metadata, SalesChannelRow, SalesChannelService, NamedSection(), SalesChannel
...
Cohesion: 0.29
Nodes (7): UserProvider(), MEMBERSHIP, USER, UserState, useUserStore, CurrentUser, Membership

### Community 37 - "Community 37"
Cohesion: 0.22
Nodes (5): CategoriesSettingsPage(), metadata, ExpenseCategoryRow, ExpenseCategoryService, ExpenseCategory
...
Cohesion: 0.36
Nodes (5): AppLayout(), resolveActiveLine(), MainContainer(), MobileNav(), BusinessLineProvider()

### Community 53 - "Community 53"
Cohesion: 0.25
Nodes (4): BusinessLineService, LinesSettingsPage(), metadata, BusinessLinesSection()
...
Cohesion: 0.52
Nodes (4): selectBusinessLine(), getSessionContext(), SessionContext, lineCookieName()
...
## Knowledge Gaps
- **679 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `geistSans` (+674 more)
...
- **Why does `getOwnerContext()` connect `Community 15` to `Community 0`, `Community 1`, `Community 32`, `Community 3`, `Community 67`, `Community 37`, `Community 8`, `Community 21`, `Community 53`, `Community 23`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `InvitationService` connect `Community 8` to `Community 3`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Community 0` to `Community 8`, `Community 67`, `Community 52`?**
