...
## Corpus Check
- 1145 files · ~1,142,317 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10517 nodes · 18010 edges · 779 communities (755 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 150 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a26801a7`
...
- `renderBlock()` --calls--> `RENDER`  [INFERRED]
  features/payments/payment-block.test.tsx → lib/monitoring/instrumentation.test.ts
- `renderDialog()` --calls--> `RENDER`  [INFERRED]
  features/payments/payment-dialog.test.tsx → lib/monitoring/instrumentation.test.ts

## Communities (779 total, 24 thin omitted)
...
Cohesion: 0.05
Nodes (79): ActivityRow(), ORIGIN_LABELS, EventDetail, HistoryEntry(), CLASSES, LineColorClasses, DELIVERY_LABELS, DataTable() (+71 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (71): AccountLayout(), NoOrganizationNotice(), AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema (+63 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (62): ActivityListProps, ActivityRowItem, metadata, AssetRowView, AssetsScreen(), cards, first, push (+54 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (59): selectBusinessLine(), AssetsPage(), metadata, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+51 more)
...
Cohesion: 0.06
Nodes (53): Detail(), ItemThumbnail(), CheckoutSheet(), METHOD_LABELS, monto, onConfirm, { rerender }, FileDropzone() (+45 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (65): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+57 more)
...
Cohesion: 0.04
Nodes (53): ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, CatalogScope, ContactScope, all, archived, CONTACT, ITEM (+45 more)
...
Cohesion: 0.06
Nodes (38): estado, Redirect, changePassword(), changePasswordSchema, displayNameSchema, ProfileActionResult, updateDisplayName(), recordActivityHref() (+30 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (45): createTask(), BoardTask, BoardView(), CalendarView(), KanbanBoard(), KanbanColumn, QuickAdd(), created (+37 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (40): ProfileForm(), FormValues, LoginForm(), schema, ACTION_LABELS, ItemDetail(), BALANCE, form (+32 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (37): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, CsvContext, csvFilename(), CsvTable (+29 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (36): relatedTasksFor(), RecordHistory, ClosingDialog(), DeliverablesSection(), TaskDetailProps, TaskFields(), ACTION_LABELS, TaskHistory() (+28 more)
...
Cohesion: 0.06
Nodes (42): useIsMobile(), links, nav, pathname, OrganizationSwitcher(), enterOrganization, [geeko], options (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.1
Nodes (33): AppSidebar(), Header(), AVISO, bell, menu, MobileContextBar(), tira, groupByType() (+25 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (35): client, opciones, client, [payload], primero, segundo, client, update (+27 more)
...
Cohesion: 0.1
Nodes (26): ActionResult, LineOption(), ItemForm(), ExitFairMode(), salida, FairStart(), channels, lines (+18 more)
...
Cohesion: 0.07
Nodes (25): ActivityHeader(), RetentionJobResult, EMPTY, report, run, readRetentionMonths(), RETENTION_KEY, retentionCutoff() (+17 more)
...
Cohesion: 0.07
Nodes (29): archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow, client (+21 more)
...
Cohesion: 0.06
Nodes (22): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), NO_MONEY, OrderFilters, OrderRow, OrderService (+14 more)
...
Cohesion: 0.07
Nodes (26): { result }, captureSale, channels, enlaces, products, readSnapshot, renderScreen(), saveSnapshot (+18 more)
...
Cohesion: 0.1
Nodes (29): updateTaskFields(), dueSummaryKey(), taskAssignedKey(), taskOverdueKey(), taskReviewKey(), taskStalledKey(), claves, dia1 (+21 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (13): original, link, first, row, detalle, monto, enRevision, porHacer (+5 more)
...
Cohesion: 0.08
Nodes (30): AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, LOW_STOCK, PENDING, root, LineCashFlow (+22 more)
...
Cohesion: 0.07
Nodes (27): filas, elapsed, MID_RANGE, started, chunks, csv, download, link (+19 more)
...
Cohesion: 0.14
Nodes (28): addAccountByEmail(), addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue(), inviteToOrganization(), PlatformActionResult (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (28): toggleTaskChecklistItem(), ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle (+20 more)
...
Cohesion: 0.1
Nodes (29): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, block, mas, panel, pathname (+21 more)
...
Cohesion: 0.1
Nodes (20): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), DEFAULT_PREFERENCES, PreferencesRow (+12 more)
...
Cohesion: 0.09
Nodes (25): declareDeliverable(), closeTaskWithDeliverables, context, enviado, nombre, nombres, onCancel, onClosed (+17 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (21): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), useSignOut(), UserMenu(), BoardColumn(), DraggableCard(), ActionItem(), RowAction (+13 more)
...
Cohesion: 0.11
Nodes (8): ItemFilters, ItemRow, ItemService, toNumber(), matchesSearch(), normalizeForSearch(), TagRow, TagService
...
Cohesion: 0.1
Nodes (24): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonRows(), comparisonScale() (+16 more)
...
Cohesion: 0.09
Nodes (22): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, alfareriaSet() (+14 more)
...
Cohesion: 0.1
Nodes (15): FailingMailer, Mailer, MemoryMailer, newAccount(), newOrganization(), plan, roles, service (+7 more)
...
Cohesion: 0.12
Nodes (20): consumptionSchema, ConsumptionValues, countSchema, CountValues, id, numeric, occurredAt, optionalId (+12 more)
...
Cohesion: 0.16
Nodes (16): RetentionJobDeps, runRetentionJob(), emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus, resolveMailer() (+8 more)
...
Cohesion: 0.16
Nodes (17): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetDetailsForm(), RecoveryBar() (+9 more)
...
Cohesion: 0.09
Nodes (19): renderMenu(), renderForm(), renderSidebar(), renderHeader(), RENDER, { onChange, user }, renderField(), createOrganization (+11 more)
...
Cohesion: 0.15
Nodes (17): ActivityDay, ActivityList(), actorOf(), capitalize(), contract(), DescribableEvent, describeEvent(), recordHref() (+9 more)
...
Cohesion: 0.13
Nodes (8): StatusService, DEFAULT_STATUS_SETS, defaultSetAsJson(), DefaultStatus, kinds, positions, STATUS_FLOWS, StatusFlow
...
Cohesion: 0.1
Nodes (19): activity, bell, box, button, comparison, deliveries, fab, fila (+11 more)
...
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Fecha comprometida con atajos, Requirement: Las columnas del tablero salen del juego de estados de la línea, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+11 more)
...
Cohesion: 0.21
Nodes (14): isLineColor(), LINE_COLOR_LABELS, STATUS_KIND_LABELS, setIsComplete(), statusFormSchema, StatusFormValues, result, valid (+6 more)
...
Cohesion: 0.15
Nodes (10): client, contactRow, inserted, itemRow, productRow, ItemVariantService, toNumber(), variantFromRow() (+2 more)
...
Cohesion: 0.15
Nodes (15): destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, consumo, labels, navegan, pendientes (+7 more)
...
Cohesion: 0.19
Nodes (14): inviteMember(), AddUserResult, inviteUrlFor(), addAccountSchema, assignmentSchema, membershipNameSchema, membershipRoleSchema, membershipTargetSchema (+6 more)
...
Cohesion: 0.15
Nodes (8): OrganizationDetailPage(), OrganizationDetail(), client, row, service, UserAdminService, UserListFilters, UserRow
...
Cohesion: 0.21
Nodes (11): EmailMessage, emailFor(), escape(), html(), DESTINATARIO, message, trimSlash(), Destination (+3 more)
...
Cohesion: 0.15
Nodes (12): expenses Specification, Requirement: Pista del último precio en el formulario de compra, Requirement: Semilla de egresos de Geeko Store, Requirement: Una compra necesita al menos una línea, Requirements, Scenario: Guardado atómico, Scenario: Insumo comprado antes, Scenario: Insumo nuevo (+4 more)
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Desarchivar devuelve el registro intacto, Requirement: El catálogo no almacena nada derivado, Scenario: Alta y cambio quedan en la bitácora, Scenario: Desarchivar desde el filtro, Scenario: El filtro no mezcla (+2 more)

### Community 244 - "Community 244"
Cohesion: 0.17
Nodes (11): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El ayudante crea y edita, pero no archiva, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: El ayudante crea y edita, Scenario: El ayudante intenta archivar, Scenario: El ayudante intenta desarchivar (+3 more)
...
Cohesion: 0.18
Nodes (10): payments Specification, Requirement: La dirección se deduce del destino y la base de datos la impone, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: Cobro de pedido, Scenario: Dirección contraria sobre un egreso, Scenario: Dirección contraria sobre un pedido, Scenario: El pago queda en la bitácora (+2 more)
...
Cohesion: 0.18
Nodes (11): Requirement: An account without an organization can sign out, Requirement: Session is refreshed on every request, Requirement: Unauthenticated access is redirected to login, Requirements, Scenario: A platform admin without memberships never sees the notice, Scenario: Active session stays alive, Scenario: After signing out, the notice is no longer reachable, Scenario: Anonymous visitor is redirected (+3 more)
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Purpose, Requirement: A platform admin's profile reflects platform access, Requirement: A platform admin without an active organization gets the platform shell, Requirement: Platform views fit a phone, Scenario: Organization-scoped routes need an organization, Scenario: Platform views at 390 px, Scenario: Profile inside a foreign organization (+2 more)
...
Cohesion: 0.2
Nodes (9): activity-screen Specification, Requirement: El vacío inicial y el resultado sin coincidencias se distinguen, Requirement: La bitácora es una página completa reservada a la persona dueña, Requirements, Scenario: El ayudante es redirigido, Scenario: La bitácora no aparece en el menú del ayudante, Scenario: La persona dueña abre la bitácora, Scenario: Ningún evento coincide (+1 more)
...
Cohesion: 0.28
Nodes (5): ProfileView, ROLE_LABELS, organization, view, ActiveAccess
...
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: El resumen llega a la hora que cada persona eligió, en la hora local de su organización, Requirement: La bitácora nunca genera notificaciones, Scenario: Actividad intensa, bandeja tranquila, Scenario: Dos horas distintas en la misma organización, Scenario: La zona horaria manda

### Community 429 - "Community 429"
Cohesion: 0.22
Nodes (8): notifications Specification, Requirement: Ningún hecho genera dos avisos, Requirement: Sin fecha límite no hay aviso de vencimiento, Requirements, Scenario: Reejecución sin duplicados, Scenario: Se le pone fecha, Scenario: Tarea sin fecha, sin avisos, Scenario: Vencida una vez, no cada día

### Community 430 - "Community 430"
Cohesion: 0.22
Nodes (9): Requirement: Cada fila abre su registro de origen, Requirement: La pantalla responde dentro de su presupuesto, Requirement: Los informes se adaptan al móvil, Requirements, Scenario: Doce meses de datos, Scenario: Fila de un insumo, Scenario: Fila de un pedido, Scenario: Fila de una categoría de gasto (+1 more)
...
Cohesion: 0.57
Nodes (6): ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock()
...
Cohesion: 0.38
Nodes (4): LineSelector(), user, ThemeToggle(), NotificationBell()
...
Cohesion: 0.33
Nodes (4): empty, error, filtered, firstRow
...
Cohesion: 0.33
Nodes (4): buscar(), linkTask, onLinked, searchLinkTargets
...
Cohesion: 0.33
Nodes (4): { onMarkAllRead }, { onMarkRead }, renderList(), row
...
Cohesion: 0.4
Nodes (3): ADDED Requirements, Purpose, reports Specification
...
Cohesion: 0.33
Nodes (4): RecentActivity(), { container }, enlaces, items
...
## Knowledge Gaps
- **5564 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+5559 more)
...
- **Why does `useSearchReset()` connect `Community 4` to `Community 11`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 11` to `Community 4`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `boot()` connect `Community 11` to `Community 1`?**
...
- **What connects `config`, `config`, `eslintConfig` to the rest of the system?**
  _5564 weakly-connected nodes found - possible documentation gaps or missing edges._
