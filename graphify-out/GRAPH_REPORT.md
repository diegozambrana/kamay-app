...
## Summary
- 5412 nodes · 9073 edges · 429 communities (412 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `821f23ca`
...
## Communities (429 total, 17 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.09
Nodes (53): ContactCombobox(), ContactComboboxRole, ROLE_FILTER_LABELS, CategoryChips(), AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf() (+45 more)
...
Cohesion: 0.07
Nodes (50): moveOrderToStatus(), CLASSES, LineColorClasses, DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS (+42 more)
...
Cohesion: 0.05
Nodes (43): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user, LastCostHint (+35 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (47): CatalogRow, LINE, push, UNIT, { unmount }, user, ACTION_LABELS, ItemDetail() (+39 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (33): selectBusinessLine(), AppLayout(), InviteForm(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (50): LineOption(), LineSelector(), cn(), DraggableCard(), AlertAction(), AlertDialogMedia(), AlertDialogOverlay(), DialogOverlay() (+42 more)
...
Cohesion: 0.07
Nodes (27): BusinessLineRow, BusinessLineService, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, OrderDetailPage(), LinesSettingsPage() (+19 more)
...
Cohesion: 0.08
Nodes (25): user, ThemeToggle(), Header(), bell, MobileContextBar(), tira, MEMBERSHIP, ORG (+17 more)
...
Cohesion: 0.08
Nodes (25): ExpenseRow, OrderRow, RecentCaptureService, CaptureKind, dayBoundsInTimezone(), dayOfInstant(), lineIdOf(), mergeRecentCaptures() (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (27): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+19 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (26): AppSidebar(), nav, pathname, isCaptureRoute(), destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination (+18 more)
...
Cohesion: 0.09
Nodes (25): addEntry(), B(), createHandlerBoundToUrl(), deleteEntry(), getAll(), getAllEntriesByQueueName(), getDb(), getEndEntryFromIndex() (+17 more)
...
Cohesion: 0.17
Nodes (20): ACTION_LABELS, DetailBody(), LineBadge(), ReceiptView, ExitFairMode(), salida, formatDateTime(), formatFileSize() (+12 more)
...
Cohesion: 0.17
Nodes (16): FormValues, schema, VariantFormDialog(), METHOD_LABELS, metadata, PAYMENT_METHODS, PaymentMethod, Card() (+8 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (20): ActivityService, RecentActivityEntry, RecentOptions, client, Call, FakeClient, FakeResult, query (+12 more)
...
Cohesion: 0.11
Nodes (16): DirectSaleInput, countItems(), EMPTY, SyncCounts, SyncItem, SyncState, items, SESSION (+8 more)
...
Cohesion: 0.12
Nodes (19): SessionContext, ExpenseCategoryRow, ExpenseCategoryService, ExpenseItemService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange() (+11 more)
...
Cohesion: 0.14
Nodes (19): addLine(), CartBar(), onCheckout, onRemove, CartLine, cartTotal(), cartUnits(), cents() (+11 more)

### Community 38 - "Community 38"
Cohesion: 0.15
Nodes (27): C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), G(), getCacheKey() (+19 more)
...
Cohesion: 0.13
Nodes (21): CAPTURE_ROUTES, MobileNav(), barra, mas, panel, pathname, barLabelOf(), bottomBarEntriesFor() (+13 more)
...
Cohesion: 0.12
Nodes (15): ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpensesScreen(), useIsMobile(), NotificationBell() (+7 more)
...
Cohesion: 0.1
Nodes (19): ExpenseFilters, ExpenseRow, ExpenseTotals, ExpenseWithTotal, NO_MONEY, CostFormInput, CostFormValues, id (+11 more)
...
Cohesion: 0.18
Nodes (21): _(), _addSyncListener(), addToPrecacheList(), Be(), constructor(), Fe(), findMatchingRoute(), get() (+13 more)
...
Cohesion: 0.13
Nodes (9): AttachmentRow, AttachmentService, NewAttachment, client, inserted, newPhoto, path, row (+1 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (17): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Las líneas de pedido se archivan, nunca se borran, Requirement: Mínimos obligatorios del pedido, Requirements, Scenario: Alta mínima, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente (+9 more)
...
Cohesion: 0.24
Nodes (13): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, revalidateOrders(), setArchived() (+5 more)
...
Cohesion: 0.14
Nodes (10): CatalogScreen(), ContactsScreen(), roleSummary(), andina, archivado, push, user, { result } (+2 more)

### Community 93 - "Community 93"
Cohesion: 0.26
Nodes (12): balance(), cents(), overpayment(), paymentStatus(), safe(), Figure(), PaymentBlock(), money() (+4 more)

### Community 94 - "Community 94"
Cohesion: 0.21
Nodes (10): useCartStore, useCartTotal(), useCartUnits(), CheckoutSheet(), monto, onConfirm, { rerender }, FairScreen() (+2 more)
...
Cohesion: 0.14
Nodes (13): buildSaleEnvelope(), base, carrito, conCliente, maceta, sobre, taza, DirectSaleLineInput (+5 more)
...
Cohesion: 0.22
Nodes (7): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta]
...
Cohesion: 0.25
Nodes (6): UpcomingDelivery, DELIVERY_LABELS, items, { rerender, container }, UpcomingDeliveries(), formatCalendarDate()
...
Cohesion: 0.29
Nodes (7): Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo, Scenario: Intento de editar un registro archivado
...
Cohesion: 0.29
Nodes (6): expenses Specification, Requirement: Líneas de compra con precio propio, Requirements, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Precio negativo
...
Cohesion: 0.4
Nodes (3): ADDED Requirements, catalog-directory Specification, Purpose
...
- **Why does `cn()` connect `Community 7` to `Community 0`, `Community 2`, `Community 4`, `Community 11`, `Community 13`, `Community 15`, `Community 18`, `Community 23`, `Community 29`, `Community 32`, `Community 33`, `Community 43`, `Community 44`, `Community 47`, `Community 313`, `Community 63`, `Community 210`, `Community 211`, `Community 82`, `Community 93`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `captureSale()` connect `Community 1` to `Community 32`, `Community 94`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `InvitationService` connect `Community 17` to `Community 64`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
