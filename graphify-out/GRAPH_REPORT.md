# Graph Report - kamay-app  (2026-08-26)

## Corpus Check
- 274 files · ~182,883 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2141 nodes · 3775 edges · 176 communities (160 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc755d62`
...
3. `getSessionContext()` - 32 edges
4. `Button()` - 31 edges
5. `7. Mapa de Vistas / Pantallas` - 24 edges
6. `Kamay — Esquema de Base de Datos (Supabase / PostgreSQL)` - 21 edges
7. `Input()` - 20 edges
8. `StatusService` - 19 edges
9. `BusinessLine` - 18 edges
...
Cohesion: 0.05
Nodes (52): ActionResult, archiveOrder(), moveOrderToStatus(), reorderQueue(), revalidateOrders(), setArchived(), unarchiveOrder(), BoardState (+44 more)
...
Cohesion: 0.09
Nodes (38): DataTableProps, FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), formatFileSize(), cn(), AlertAction() (+30 more)
...
Cohesion: 0.1
Nodes (35): ACTION_LABELS, ItemFormDialog(), ItemForm(), ItemPhoto, ItemPhotos(), ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, DataTableAction (+27 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (26): user, ThemeToggle(), Header(), MainContainer(), MobileNav(), NAV_ENTRIES, navEntriesFor(), NavEntry (+18 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (26): ContactCombobox(), ContactComboboxRole, ROLE_FILTER_LABELS, BoardOrder, CalendarView(), ListView(), View, Contact (+18 more)
...
Cohesion: 0.13
Nodes (27): contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name, optionalAmount, optionalText, quickContactSchema (+19 more)
...
Cohesion: 0.16
Nodes (22): ActionResult, FormValues, schema, VariantFormDialog(), VariantsList(), ConfigEntity, ConfigItem, ConfigList() (+14 more)
...
Cohesion: 0.12
Nodes (20): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+12 more)
...
Cohesion: 0.1
Nodes (22): AttachmentRow, NewAttachment, ContactFilters, ContactRow, ContactFormValues, ContactsPage(), metadata, OrderFilters (+14 more)
...
Cohesion: 0.18
Nodes (18): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, STATUS_KIND_LABELS, setIsComplete(), statusFormSchema, StatusFormValues (+10 more)
...
Cohesion: 0.12
Nodes (15): OrderDetailPage(), OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), client, orderRow, [payload] (+7 more)

### Community 27 - "Community 27"
Cohesion: 0.21
Nodes (18): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+10 more)
...
Cohesion: 0.15
Nodes (8): ItemFilters, ItemRow, ItemService, toNumber(), ItemFormValues, matchesSearch(), normalizeForSearch(), ActivityEntry
...
Cohesion: 0.15
Nodes (12): formatDateTime(), DELIVERY_LABELS, OrderCard(), OrderCardData, shortDate(), { unmount }, OrderDetail(), isOverdue() (+4 more)
...
Cohesion: 0.27
Nodes (16): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+8 more)

### Community 37 - "Community 37"
Cohesion: 0.17
Nodes (8): client, contactRow, inserted, itemRow, ItemVariantService, toNumber(), VariantRow, ItemVariantFormValues
...
Cohesion: 0.23
Nodes (8): defaultLandingPath(), PROTECTED_PREFIXES, sanitizeInternalPath(), GET(), metadata, SettingsLayout(), SETTINGS_SECTIONS, SettingsNav()
...
Cohesion: 0.2
Nodes (4): AttachmentService, ItemDetail(), ItemDetailPage(), metadata
...
Cohesion: 0.2
Nodes (6): BusinessLineRow, BusinessLineService, metadata, StatusesSettingsPage(), statusFlowSchema, StatusesSection()
...
Cohesion: 0.22
Nodes (5): UnitRow, UnitService, UnitsSection(), metadata, UnitsSettingsPage()
...
Cohesion: 0.25
Nodes (8): Requirement: El catálogo no almacena nada derivado, Requirement: Pantalla de contactos (V13), Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Filtro por rol, Scenario: Inspección de las columnas del catálogo, Scenario: Intento de editar un registro archivado, Scenario: Selección sin abandonar la pantalla

### Community 88 - "Community 88"
Cohesion: 0.29
Nodes (5): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Scenario: El ayudante llega al catálogo
...
Cohesion: 0.29
Nodes (6): orders Specification, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Modo de entrega fuera del dominio, Scenario: Pedido sin cliente, Scenario: Venta directa sin cliente

### Community 111 - "Community 111"
Cohesion: 0.29
Nodes (6): ADDED Requirements, Purpose, Requirement: Líneas de pedido con precio propio, Scenario: Cantidad no positiva, Scenario: El precio del catálogo cambia después, Scenario: Precio negativo
...
Cohesion: 0.33
Nodes (6): Requirement: Aislamiento, roles y archivado de pedidos, Scenario: El ayudante edita, Scenario: El ayudante intenta archivar, Scenario: El pedido archivado conserva su historia, Scenario: Intento de borrado, Scenario: Miembro de otra organización
...
Cohesion: 0.4
Nodes (5): Requirement: El total del pedido se deriva, nunca se almacena, Scenario: Ninguna columna almacena el derivado, Scenario: Pedido sin líneas, Scenario: Se agrega una línea, Scenario: Total de un pedido con líneas
...
Cohesion: 0.4
Nodes (5): Requirement: Detalle del pedido, Scenario: Cambio de estado desde el detalle, Scenario: Historial, Scenario: Imagen de referencia, Scenario: Pedido completo
...
Cohesion: 0.5
Nodes (4): Requirement: Tarjeta del tablero, Scenario: Abrir el detalle, Scenario: Datos opcionales ausentes, Scenario: Pedido con modo de entrega
...
Cohesion: 0.67
Nodes (3): Requirement: Creación de contactos al vuelo, Scenario: El contacto creado queda seleccionado, Scenario: Nombre inexistente ofrece crearlo

## Knowledge Gaps
- **996 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+991 more)
...
- **Why does `cn()` connect `Community 2` to `Community 0`, `Community 33`, `Community 4`, `Community 5`, `Community 6`, `Community 71`, `Community 8`, `Community 70`, `Community 10`, `Community 13`, `Community 49`, `Community 21`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `StatusService` connect `Community 22` to `Community 0`, `Community 36`, `Community 85`, `Community 57`, `Community 26`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `OrganizationService` connect `Community 58` to `Community 20`, `Community 126`?**
