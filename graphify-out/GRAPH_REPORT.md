...
## Corpus Check
- 823 files · ~686,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7886 nodes · 13167 edges · 603 communities (578 shown, 25 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad4af98d`
...
- `TaskDetailPage()` --calls--> `getSessionContext()`  [EXTRACTED]
  app/(app)/tasks/[id]/page.tsx → lib/auth/session-context.ts

## Communities (603 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (81): LineOption(), LineSelector(), ItemThumbnail(), user, ThemeToggle(), Indicator(), IndicatorProps, money() (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (64): DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, Assignee, View, ContactCombobox(), ContactComboboxRole, TaskFieldsProps (+56 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (68): FormValues, schema, ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item() (+60 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (78): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+70 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (62): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine() (+54 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (68): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+60 more)
...
Cohesion: 0.05
Nodes (56): moveOrderToStatus(), CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, StatusInput, StatusRow, LineBadge() (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (49): createTask(), BoardTask, BoardView(), CalendarView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn (+41 more)
...
Cohesion: 0.06
Nodes (54): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, reorderQueue(), revalidateOrders() (+46 more)
...
Cohesion: 0.07
Nodes (35): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), InviteForm() (+27 more)
...
Cohesion: 0.06
Nodes (34): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+26 more)
...
Cohesion: 0.07
Nodes (33): useOnlineStatus(), ConsumptionDialog(), CountDialog(), AppSidebar(), nav, pathname, Header(), AVISO (+25 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (30): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine(), AssetDetailsForm(), RecoveryBar(), mark (+22 more)

### Community 20 - "Community 20"
Cohesion: 0.12
Nodes (28): ItemPhotos(), ROLE_FILTER_LABELS, DataTableProps, FileDropzoneProps, FilePreview(), isImage(), formatFileSize(), MainContainer() (+20 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (16): AttachmentRow, AttachmentService, NewAttachment, TaskDetail(), ItemLastCost, ItemLastCostService, toNumber(), ItemDetailPage() (+8 more)
...
Cohesion: 0.09
Nodes (31): ExpenseCard(), ACTION_LABELS, DetailBody(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS, ReceiptView, ExpenseFilters() (+23 more)

### Community 29 - "Community 29"
Cohesion: 0.1
Nodes (28): SessionContext, ExpenseCategoryRow, ExpenseCategoryService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange (+20 more)
...
Cohesion: 0.09
Nodes (27): addEntry(), createHandlerBoundToUrl(), deleteEntry(), G(), getAll(), getAllEntriesByQueueName(), getDb(), getEndEntryFromIndex() (+19 more)
...
Cohesion: 0.1
Nodes (18): MobileContextBar(), tira, countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items (+10 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (14): EmailMessage, FailingMailer, Mailer, MemoryMailer, client, mailer, [rows], { onMarkAllRead } (+6 more)
...
Cohesion: 0.08
Nodes (19): archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow, client (+11 more)
...
Cohesion: 0.12
Nodes (19): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, batchLimitMessage() (+11 more)
...
Cohesion: 0.11
Nodes (25): archiveTask(), attachmentIdSchema, completeTask(), completeTaskSchema, CreateTaskResult, detachFromTask(), moveTaskSchema, moveTaskToStatus() (+17 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (20): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, OrdersScreen() (+12 more)

### Community 52 - "Community 52"
Cohesion: 0.11
Nodes (14): AllocationRuleService, client, update, GeneralSettingsPage(), metadata, AllocationSettingsInput, allocationSettingsSchema, readAllocationSettings() (+6 more)

### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (14): LowStockReport(), link, row, ROWS, ExpenseBreakdownRow, lineParam(), LowStockRow, ProductRankingRow (+6 more)
...
Cohesion: 0.15
Nodes (16): emailsFor(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron(), emailsFor(), emitTaskEvents() (+8 more)

### Community 56 - "Community 56"
Cohesion: 0.11
Nodes (18): ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle, resultado (+10 more)
...
Cohesion: 0.1
Nodes (18): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta], DirectSaleInput (+10 more)
...
Cohesion: 0.21
Nodes (23): _(), _addSyncListener(), addToPrecacheList(), B(), Be(), constructor(), E(), Fe() (+15 more)
...
Cohesion: 0.17
Nodes (14): emailFor(), escape(), html(), DESTINATARIO, message, trimSlash(), Destination, destinationOf() (+6 more)
...
Cohesion: 0.11
Nodes (18): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Entradas al alta y a la edición, Requirement: Fecha comprometida con atajos, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+10 more)
...
Cohesion: 0.2
Nodes (15): a(), B(), D(), g(), i(), k(), Q(), y() (+7 more)
...
Cohesion: 0.16
Nodes (14): IndicatorCards(), barPercent(), comparisonRows(), comparisonScale(), marginOf(), NO_CASH_FLOW, ALFARERIA, flows (+6 more)
...
Cohesion: 0.12
Nodes (9): FakeClient, client, groups, [payload], [rows, options], client, [patch], paymentRow (+1 more)

### Community 125 - "Community 125"
Cohesion: 0.13
Nodes (13): AssetDetailView, acquisition, breakdown, detail, entries, links, maintenance, AssetDetailsInput (+5 more)
...
Cohesion: 0.19
Nodes (10): FILTERS, push, renderScreen(), ROWS, user, cents(), ExpenseSummary, PurchaseLineAmount (+2 more)
...
Cohesion: 0.14
Nodes (11): ADDED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Numeración visible por organización sin duplicados, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito, Scenario: El número no se reutiliza (+3 more)
...
Cohesion: 0.19
Nodes (7): ContactService, ContactsScreen(), roleSummary(), ContactsPage(), metadata, CONTACT_ROLE_FILTERS, ContactRoleFilter

### Community 159 - "Community 159"
Cohesion: 0.23
Nodes (4): matchesSearch(), normalizeForSearch(), TagRow, TagService

### Community 160 - "Community 160"
Cohesion: 0.14
Nodes (11): archivedCost, archivedPurchase, client, params, purchaseRow, Call, FakeResult, query (+3 more)
...
Cohesion: 0.21
Nodes (12): 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log (), code:sql (create or replace function log_activity()) (+4 more)
...
Cohesion: 0.18
Nodes (8): ADDED Requirements, Purpose, Requirement: Líneas de compra con precio propio, Requirement: Semilla de egresos de Geeko Store, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Precio negativo, Scenario: Reinicio local
...
Cohesion: 0.18
Nodes (7): chico, enviada, enVuelo, lote, sueltas, uploader, uploads
...
Cohesion: 0.2
Nodes (7): TaskForm(), assignees, checkbox, created, lines, select, tags
...
Cohesion: 0.27
Nodes (7): CsvContext, csvFilename(), CsvTable, line(), context, csv, toCsv()
...
Cohesion: 0.22
Nodes (5): ProductRankingReport(), channelNames, itemNames, row, ROWS
...
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Catálogo y contactos accesibles desde la navegación base, Scenario: Alta y cambio quedan en la bitácora, Scenario: El ayudante llega al catálogo, Scenario: Otra organización no ve nada
...
Cohesion: 0.29
Nodes (4): andina, archivado, push, user

### Community 384 - "Community 384"
Cohesion: 0.76
Nodes (5): balance(), cents(), overpayment(), paymentStatus(), safe()
...
Cohesion: 0.29
Nodes (7): 10. Inventario, 12. Tareas, 9. Pedidos y ventas, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), code:sql (create table inventory_movements (), Una decisión que conviene revisar
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: Un activo es un destino vinculable válido para una tarea, Scenario: Vínculo a un activo existente, Scenario: Vínculo a un activo inexistente
...
Cohesion: 0.33
Nodes (4): ActivityItem, RecentActivity(), { container }, items

### Community 472 - "Community 472"
Cohesion: 0.33
Nodes (6): _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), n
...
## Knowledge Gaps
- **4265 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4260 more)
...
- **Why does `cn()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 40`, `Community 10`, `Community 44`, `Community 47`, `Community 80`, `Community 188`, `Community 19`, `Community 20`, `Community 212`, `Community 18`, `Community 119`, `Community 28`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `AttachmentService` connect `Community 21` to `Community 161`, `Community 3`, `Community 4`, `Community 10`, `Community 430`, `Community 50`, `Community 29`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 33`, `Community 2`, `Community 35`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 40`, `Community 12`, `Community 45`, `Community 19`, `Community 20`, `Community 26`, `Community 28`?**
