# Graph Report - kamay-app  (2026-09-15)

## Corpus Check
- 1200 files · ~1,199,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11108 nodes · 19093 edges · 816 communities (787 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `883af7c3`
...
## Communities (816 total, 29 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (100): BoardColumn(), DraggableCard(), ItemThumbnail(), CheckoutSheet(), METHOD_LABELS, monto, onConfirm, { rerender } (+92 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (98): moveOrderToStatus(), ACTION_LABELS, ActivityFiltersProps, FilterOption, CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses (+90 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (82): ActivityListProps, metadata, BoardTask, CalendarView(), ListView(), Assignee, TASK_FILTERS, TasksScreen() (+74 more)
...
Cohesion: 0.07
Nodes (72): FormValues, schema, createTask(), DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, ITEM_KIND_FIELDS, ITEM_CATEGORY_COPY (+64 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (71): selectBusinessLine(), AssetsPage(), metadata, getSessionContext(), PlatformAdminContext, findActiveLine(), preselectedLineId(), resolveActiveLine() (+63 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (71): ProfileForm(), ActivityRow(), Detail(), ORIGIN_LABELS, FormValues, LoginForm(), schema, ACTION_LABELS (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (73): AccountLayout(), NoOrganizationNotice(), ProfileView, ROLE_LABELS, organization, view, UserMenu(), signOut() (+65 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (67): EventDetail, HistoryEntry(), RecordHistory, RecordHistoryItem, ACTION_LABELS, TaskHistory(), TaskHistoryProps, enlace (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (52): AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema, selectOrganization(), updatePassword() (+44 more)
...
Cohesion: 0.05
Nodes (55): relatedTasksFor(), ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps, TaskDetailProps, TaskFields(), assignees, lines (+47 more)
...
Cohesion: 0.05
Nodes (38): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), EmailMessage, FailingMailer (+30 more)
...
Cohesion: 0.05
Nodes (36): estado, Redirect, loadRecordHistory(), NotFound(), SessionContext, CategoriesSettingsPage(), ChannelsSettingsPage(), [archivePayload] (+28 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (37): PlatformActionResult, InviteDialog(), MemberDialog(), MemberFields(), memberName(), OrganizationDetail(), TeamMember, MembershipEmbed (+29 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (45): ActionResult, linkExpenseToAsset(), message(), revalidateAsset(), saveAssetDetails(), acceptInvitation(), archiveMembership(), changeMemberRole() (+37 more)
...
Cohesion: 0.07
Nodes (41): ActionResult, ITEM_KIND_LABELS, BusinessLinesSection(), ConfigEntity, ConfigItem, ConfigList(), ConfigRow, ConfigTables() (+33 more)
...
Cohesion: 0.06
Nodes (37): registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot, renderScreen() (+29 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (33): amount, archivedRow, buffer, detail, entry, expenseUrl, nav, papel (+25 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (41): buildDetail(), ChangePair, DETAIL_MARKERS, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds() (+33 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (36): BoardView(), KanbanBoard(), KanbanColumn, card, Item, onMove, renderBoard(), user (+28 more)
...
Cohesion: 0.06
Nodes (18): original, created, dialog, link, detalle, monto, elapsed, MID_RANGE (+10 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (36): ACTIONS, ActivityAction, activityHref(), ANY, isRealCivilDate(), normalizeRange(), one(), parseFilters() (+28 more)
...
Cohesion: 0.08
Nodes (23): first, row, filas, chunks, csv, download, link, section (+15 more)
...
Cohesion: 0.1
Nodes (27): plan, RUN, sinCorreo, summaries, tasks, adminClient(), countNotifications(), serviceRoleKey() (+19 more)
...
Cohesion: 0.09
Nodes (19): { result }, countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items, SESSION (+11 more)
...
Cohesion: 0.13
Nodes (22): RetentionJobDeps, emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), routes() (+14 more)
...
Cohesion: 0.11
Nodes (16): DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon }, upcomingWindow() (+8 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (17): AssetDetailView, acquisition, breakdown, detail, entries, links, maintenance, relatedTasksFor (+9 more)
...
Cohesion: 0.11
Nodes (15): LowStockReport(), link, renderReport(), row, ROWS, ExpenseBreakdownRow, lineParam(), LowStockRow (+7 more)
...
Cohesion: 0.16
Nodes (17): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine(), AssetDetailsForm(), AssetRowView, RecoveryBar() (+9 more)

### Community 86 - "Community 86"
Cohesion: 0.15
Nodes (17): backoffDelay(), hasExhaustedAttempts(), esperas, DrainDeps, drainOutbox(), resetDrainLock(), runDrain(), failedRecordIdsOf() (+9 more)
...
Cohesion: 0.09
Nodes (20): renderMenu(), renderScreen(), task(), item(), renderDetail(), renderWithCategories(), renderFields(), task() (+12 more)
...
Cohesion: 0.2
Nodes (12): createOutboxDatabase(), OutboxDatabase, { enviados, resolveOperation }, now, { resolveOperation }, discardEntry(), enqueue(), listEntries() (+4 more)
...
Cohesion: 0.15
Nodes (16): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonRows(), marginOf() (+8 more)
...
Cohesion: 0.11
Nodes (11): client, patch, row, FakeClient, client, row, service, client (+3 more)
...
Cohesion: 0.12
Nodes (14): ADDED Requirements, Purpose, Requirement: Confirmación antes de descartar, Requirement: Entradas al alta y a la edición, Requirement: Modelo de pedido con cliente obligatorio, Scenario: Desde el detalle, Scenario: Desde el tablero, Scenario: Modo de entrega fuera del dominio (+6 more)
...
Cohesion: 0.11
Nodes (17): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Líneas desde el catálogo con precio prellenado y editable, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito (+9 more)
...
Cohesion: 0.16
Nodes (10): RetentionJobResult, runRetentionJob(), EMPTY, report, run, describeRun(), RetentionRun, OrganizationRow (+2 more)
...
Cohesion: 0.13
Nodes (14): payments Specification, Requirement: El sobrepago se advierte pero se permite, Requirement: Registrar un pago desde el detalle del egreso, Requirement: Un movimiento registrado no se edita, Requirements, Scenario: Advertencia antes de confirmar, Scenario: Archivar sí está permitido, Scenario: Corrección por la vía prevista (+6 more)
...
Cohesion: 0.14
Nodes (10): client, [payload], primero, segundo, client, update, Call, FakeResult (+2 more)
...
Cohesion: 0.24
Nodes (11): createExpenseCategory(), createSalesChannel(), revalidateConfiguration(), toMessage(), updateExpenseCategory(), updateGeneralSettings(), updateItemCategory(), updateSalesChannel() (+3 more)
...
Cohesion: 0.21
Nodes (9): comparisonScale(), LineCashFlow, LineComparison(), alfareria, bars, { container }, rows, sublimacion (+1 more)
...
Cohesion: 0.31
Nodes (4): formatLabel(), hasLabel(), LabelService, client
...
Cohesion: 0.2
Nodes (9): expenses Specification, Requirement: El último costo de un ítem se deriva de sus compras, Requirement: Semilla de egresos de Geeko Store, Requirements, Scenario: Comprado dos veces, Scenario: El ayudante no obtiene costos, Scenario: La compra archivada no cuenta, Scenario: Nunca comprado (+1 more)
...
Cohesion: 0.25
Nodes (5): ADDED Requirements, Purpose, Requirement: Existing tables are audited and future tables must opt in at creation, Scenario: Changes to organizations are logged, Scenario: The attachment procedure is documented
...
Cohesion: 0.22
Nodes (8): reports Specification, Requirement: Exportación de cualquier informe con sus filtros y su contexto, Requirement: Los informes se adaptan al móvil, Requirements, Scenario: Cifras utilizables, Scenario: El archivo se explica solo, Scenario: Exporta lo que se ve, Scenario: Un informe por pantalla
...
Cohesion: 0.25
Nodes (6): createUnit(), updateUnit(), KG, name, row, U
...
- **Why does `useSearchReset()` connect `Community 2` to `Community 14`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 14` to `Community 2`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 17`, `Community 20`, `Community 44`, `Community 45`, `Community 47`, `Community 58`, `Community 62`, `Community 209`, `Community 85`, `Community 246`?**
