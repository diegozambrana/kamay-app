...
## Summary
- 5366 nodes · 9028 edges · 419 communities (399 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `545beb91`
...
## Communities (419 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (82): ItemThumbnail(), METHOD_LABELS, useIsMobile(), AppSidebar(), nav, pathname, Header(), bell (+74 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (53): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (58): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+50 more)
...
Cohesion: 0.07
Nodes (47): selectBusinessLine(), AppLayout(), getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (47): ActionResult, LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames, PurchaseLinesTable(), HINTS, quantity (+39 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (47): LineColorClasses, LineOption(), LineSelector(), CategoryChips(), ExpenseCard(), DetailBody(), ExpenseDetail(), ExpenseDetailData (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (50): CatalogRow, CatalogScreen(), LINE, push, UNIT, { unmount }, user, ACTION_LABELS (+42 more)
...
Cohesion: 0.08
Nodes (45): ContactCombobox(), ContactComboboxRole, AssignableOrder, CostForm(), ExpensesScreen(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (36): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), InviteForm() (+28 more)
...
Cohesion: 0.06
Nodes (38): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+30 more)
...
Cohesion: 0.07
Nodes (34): addEntry(), _awaitComplete(), B(), createHandlerBoundToUrl(), deleteEntry(), destroy(), doneWaiting(), fetchDidFail() (+26 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (26): DataTableProps, ACTION_LABELS, ReceiptView, ExitFairMode(), salida, FileDropzoneProps, FilePreview(), isImage() (+18 more)
...
Cohesion: 0.12
Nodes (22): FormValues, schema, ContactsScreen(), ROLE_FILTER_LABELS, roleSummary(), andina, archivado, push (+14 more)
...
Cohesion: 0.09
Nodes (21): registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot, saveSnapshot (+13 more)
...
Cohesion: 0.14
Nodes (29): a, C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+21 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (22): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, mas, panel, pathname, barLabelOf() (+14 more)
...
Cohesion: 0.14
Nodes (17): DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon }, upcomingWindow() (+9 more)
...
Cohesion: 0.15
Nodes (17): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonRows(), comparisonScale() (+9 more)
...
Cohesion: 0.14
Nodes (9): SessionContext, AttachmentRow, AttachmentService, NewAttachment, loadExpenseDetail(), ExpenseDetailPage(), ItemDetailPage(), metadata (+1 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (15): Call, FakeClient, FakeResult, query, result, client, [patch], paymentRow (+7 more)
...
Cohesion: 0.13
Nodes (15): MEMBERSHIP, USER, UserState, Attachment, ATTACHMENT_ENTITY_TYPES, CurrentUser, ExpenseTotals, Membership (+7 more)
...
Cohesion: 0.12
Nodes (15): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: Las consultas de ingresos incluyen las ventas directas, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: El cobrado también suma (+7 more)
...
Cohesion: 0.16
Nodes (10): AssistantDashboard(), { container }, deliveries, root, DELIVERY_LABELS, DeliveryItem, items, { rerender, container } (+2 more)

### Community 86 - "Community 86"
Cohesion: 0.18
Nodes (10): LineCashFlow, OwnerDashboard(), OwnerDashboardProps, activity, comparison, deliveries, ActivityItem, RecentActivity() (+2 more)
...
Cohesion: 0.29
Nodes (12): ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone() (+4 more)
...
Cohesion: 0.25
Nodes (6): ItemFilters, ItemRow, toNumber(), ItemFormValues, matchesSearch(), normalizeForSearch()
...
Cohesion: 0.2
Nodes (8): ExpenseFilters, ExpenseRow, ExpenseTotals, NO_MONEY, CostFormValues, PurchaseFormValues, PurchaseLineValues, Expense

### Community 147 - "Community 147"
Cohesion: 0.22
Nodes (5): ActivityService, RecentActivityEntry, RecentOptions, client, ActivityEntry
...
Cohesion: 0.2
Nodes (9): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Semilla de catálogo y directorio de Geeko Store, Requirements, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo, Scenario: La búsqueda de la semilla tolera acentos (+1 more)
...
Cohesion: 0.22
Nodes (8): expenses Specification, Requirement: Líneas de compra con precio propio, Requirement: Semilla de egresos de Geeko Store, Requirements, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Precio negativo, Scenario: Reinicio local
...
Cohesion: 0.25
Nodes (7): LineComparison(), alfareria, bars, { container }, rows, sublimacion, tresD

### Community 218 - "Community 218"
Cohesion: 0.46
Nodes (5): AssistantDashboardProps, LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard(), { container }
...
Cohesion: 0.29
Nodes (7): ADDED Requirements, Requirement: El panel carga dentro de su presupuesto, Requirement: El panel es utilizable en un teléfono, Scenario: Doce meses sembrados, Scenario: El aterrizaje no cambia, Scenario: Nada se precalcula en una columna, Scenario: Una columna en 390 px
...
Cohesion: 0.4
Nodes (4): OrganizationProvider(), MEMBERSHIP, ORG, USER
...
Cohesion: 0.5
Nodes (4): Requirement: Marcadores de posición declarados, Requirements, Scenario: El marcador no engaña, Scenario: Los dos marcadores están rotulados
...
## Knowledge Gaps
- **2807 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2802 more)
...
- **Why does `cn()` connect `Community 0` to `Community 1`, `Community 2`, `Community 33`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 40`, `Community 9`, `Community 10`, `Community 74`, `Community 12`, `Community 47`, `Community 15`, `Community 17`, `Community 85`, `Community 25`, `Community 58`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `captureSale()` connect `Community 3` to `Community 22`, `Community 30`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `InvitationService` connect `Community 29` to `Community 50`, `Community 37`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
