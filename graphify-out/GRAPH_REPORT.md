# Graph Report - kamay-app  (2026-09-10)

## Corpus Check
- 886 files · ~749,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9016 nodes · 14877 edges · 687 communities (658 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4afaf320`
...
1. `cn()` - 217 edges
2. `getSessionContext()` - 86 edges
3. `Button()` - 85 edges
4. `getOwnerContext()` - 80 edges
5. `Input()` - 47 edges
6. `BusinessLine` - 42 edges
7. `Badge()` - 36 edges
8. `ADDED Requirements` - 36 edges
9. `ALL_LINES` - 35 edges
10. `BusinessLineService` - 35 edges
...
- `RetentionSettingsPage()` --calls--> `getOwnerContext()`  [EXTRACTED]
  app/(app)/settings/retention/page.tsx → lib/auth/session-context.ts
...
## Communities (687 total, 29 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (107): LineOption(), LineSelector(), ItemThumbnail(), Count(), useIsMobile(), AppSidebar(), nav, pathname (+99 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (76): ACTION_LABELS, ActivityFiltersProps, FilterOption, DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, ItemFormDialog(), ContactCombobox() (+68 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (68): selectBusinessLine(), loadRecordHistory(), AppLayout(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId() (+60 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (69): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (59): moveOrderToStatus(), createTask(), LineBadge(), BoardTask, CalendarView(), BoardColumn(), DraggableCard(), KanbanBoard() (+51 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (53): ActivityDay, ActivityList(), ActivityListProps, ActivityRow(), ActivityRowItem, RecordHistory, FormValues, schema (+45 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (54): Detail(), ORIGIN_LABELS, DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, columns (+46 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (62): unlinkTask(), ItemForm(), ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (55): ActivityFilterBar(), ActivityPage, ActivityService, decodeCursor(), encodeCursor(), RecentActivityEntry, RecentOptions, client (+47 more)
...
Cohesion: 0.06
Nodes (54): ExpenseCard(), ACTION_LABELS, DetailBody(), KIND_LABELS, LineBadge(), ReceiptView, ExpenseFilters(), ExpenseFilterValues (+46 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (51): AssistantDashboardProps, Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonScale() (+43 more)
...
Cohesion: 0.06
Nodes (38): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), ActivityLayout() (+30 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (37): EventDetail, HistoryEntry(), AssetCard(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine(), AssetDetailsForm(), RecoveryBar() (+29 more)
...
Cohesion: 0.05
Nodes (40): BoardView(), TasksScreen(), columns, extra, pushed, renderScreen(), row, select (+32 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (34): registerDirectSale(), RegisterDirectSaleResult, BestSellerRow, FairProduct, FairSaleService, ProductRow, bolsa, client (+26 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (27): DirectSaleInput, countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items, SESSION (+19 more)
...
Cohesion: 0.06
Nodes (17): AssetDetailsInput, AssetFilters, AssetService, RecoveryRow, toNumber(), SessionContext, AttachmentRow, AttachmentService (+9 more)
...
Cohesion: 0.08
Nodes (26): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, batchLimitMessage() (+18 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (18): comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon } (+10 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (28): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+20 more)
...
Cohesion: 0.09
Nodes (34): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, revalidateOrders(), setArchived(), setOrderAttachmentArchived(), unarchiveOrder() (+26 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (29): declareDeliverable(), ClosingDialog(), closeTaskWithDeliverables, context, enviado, nombre, nombres, onCancel (+21 more)
...
Cohesion: 0.1
Nodes (23): addEntry(), createHandlerBoundToUrl(), deleteEntry(), getAll(), getAllEntriesByQueueName(), getDb(), getEndEntryFromIndex(), getEntryCountByQueueName() (+15 more)

### Community 40 - "Community 40"
Cohesion: 0.08
Nodes (26): AllocatedLine, allocateSharedExpenses(), AllocationResult, ComparisonRow, composeLegend(), distribute(), fromCents(), RULE_LABEL (+18 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (26): ACCEPTED_TYPES, browserCodec, compressImage(), CompressOptions, EXTENSIONS, ImageCodec, ImageSize, isAcceptedImage() (+18 more)
...
Cohesion: 0.09
Nodes (17): AllocationRuleService, client, update, GeneralSettingsPage(), metadata, AllocationSettingsInput, allocationSettingsSchema, readAllocationSettings() (+9 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (29): activity-retention Specification, ADDED Requirements, Purpose, Requirement: La purga exporta y verifica antes de vaciar el detalle, Requirement: La purga resume, nunca borra, Requirement: La retención es una política de la organización, configurable y con valor por defecto, Requirement: La retención solo la ejecuta el sistema, y nunca por sí sola en esta entrega, Requirement: Si la exportación falla, no se vacía nada (+21 more)
...
Cohesion: 0.15
Nodes (29): C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), G(), getCacheKey() (+21 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (18): relatedTasksFor(), list, onConfirm, RelatedTasksPanel(), RelatedTasksPanelProps, RelatedTasks(), RelatedTasksProps, ACTION_LABELS (+10 more)
...
Cohesion: 0.19
Nodes (25): _(), _addSyncListener(), addToPrecacheList(), ae(), B(), Be(), constructor(), E() (+17 more)

### Community 56 - "Community 56"
Cohesion: 0.15
Nodes (18): isLineColor(), LINE_COLOR_LABELS, STATUS_KIND_LABELS, metadata, StatusesSettingsPage(), setIsComplete(), statusFlowSchema, statusFormSchema (+10 more)
...
Cohesion: 0.14
Nodes (17): emailsFor(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron(), emailsFor(), emitTaskEvents() (+9 more)
...
Cohesion: 0.1
Nodes (14): client, opciones, Call, FakeClient, FakeResult, query, result, client (+6 more)
...
Cohesion: 0.19
Nodes (15): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, resolveSearch(), csvOf(), GET() (+7 more)
...
Cohesion: 0.1
Nodes (20): orders Specification, Requirement: Cancelación de pedido, Requirement: Entradas al alta y a la edición, Requirement: Fecha comprometida con atajos, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+12 more)
...
Cohesion: 0.11
Nodes (13): LowStockReport(), link, row, ROWS, ProductRankingReport(), channelNames, itemNames, row (+5 more)
...
Cohesion: 0.11
Nodes (15): ADDED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Las líneas de pedido se archivan, nunca se borran, Requirement: Reordenar la cola renumera al resto, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El detalle y la tarjeta no las muestran (+7 more)
...
Cohesion: 0.18
Nodes (14): CatalogPicker(), LineAmounts, lineTotal(), orderTotal(), PickableItem, pickerCandidates(), prefilledPrice(), catalogo (+6 more)
...
Cohesion: 0.16
Nodes (11): Destination, destinationOf(), GROUP_LABELS, NotificationList(), NotificationListProps, NotificationRow(), { onMarkAllRead }, { onMarkRead } (+3 more)

### Community 109 - "Community 109"
Cohesion: 0.21
Nodes (13): ActivityHeader(), readRetentionMonths(), RETENTION_KEY, retentionCutoff(), retentionLabel(), retentionMonthsSchema, RetentionSettingsInput, retentionSettingsSchema (+5 more)
...
Cohesion: 0.17
Nodes (11): FILTERS, push, renderScreen(), ROWS, user, PurchaseLinesTable(), cents(), ExpenseSummary (+3 more)
...
Cohesion: 0.21
Nodes (10): MobileContextBar(), tira, OrganizationProvider(), MEMBERSHIP, ORG, USER, OrganizationState, MEMBERSHIPS (+2 more)
...
Cohesion: 0.23
Nodes (9): todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn(), first, newId (+1 more)
...
Cohesion: 0.13
Nodes (14): payments Specification, Requirement: Aislamiento por organización de los movimientos, Requirement: Registrar un cobro desde el detalle del pedido, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: Anticipo parcial, Scenario: Cobro del saldo completo, Scenario: Crear en organización ajena (+6 more)
...
Cohesion: 0.18
Nodes (11): scopedToLine(), ScopeItem, shortfallRatio(), sortByUrgency(), balances, critico, holgado, huerfano (+3 more)
...
Cohesion: 0.17
Nodes (8): LastCostHint, PurchaseEditorLine, PurchaseLineNames, HINTS, quantity, row, SUPPLIES, user
...
Cohesion: 0.17
Nodes (7): linkTask, onLinked, searchLinkTargets, refresh, unlinkTask, LinkTarget, ResolvedTaskLink

### Community 205 - "Community 205"
Cohesion: 0.17
Nodes (9): CatalogRow, bajo, distintivo, LINE, push, sano, UNIT, { unmount } (+1 more)
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Purpose, Requirement: Archivar retira de listados y buscadores sin borrar la historia, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo, Scenario: La referencia histórica sobrevive al archivado (+2 more)

### Community 208 - "Community 208"
Cohesion: 0.17
Nodes (11): catalog-directory Specification, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Todo contacto tiene al menos un rol, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: Contacto que es proveedor y cliente a la vez, Scenario: Contacto sin ningún rol (+3 more)
...
Cohesion: 0.18
Nodes (8): StatusRow(), destination, finalStatus, initial, inProgress, name, user, waiting
...
Cohesion: 0.18
Nodes (9): AssetDetailView, acquisition, breakdown, detail, entries, links, maintenance, relatedTasksFor (+1 more)

### Community 233 - "Community 233"
Cohesion: 0.18
Nodes (8): Cómo auditar una tabla nueva, code:sql (select cron.schedule('kamay-log-retention', '0 3 1 * *', $$), Migraciones, No está agendada, y es a propósito, Prueba obligatoria, Qué se audita y qué no, Retención de la bitácora (KAM-22), Trabajos programados
...
Cohesion: 0.2
Nodes (7): ana, andina, archivado, entradas, push, relatedTasksFor, user
...
Cohesion: 0.22
Nodes (8): notifications Specification, Requirement: La bitácora nunca genera notificaciones, Requirement: Un tipo apagado no se genera ni se envía, Requirements, Scenario: Actividad intensa, bandeja tranquila, Scenario: Apagado, no generado, Scenario: El apagado es de quien lo hace, Scenario: Los demás tipos no se ven afectados
...
Cohesion: 0.29
Nodes (4): OrderItemRow, OrderItemService, toNumber(), OrderItem
...
Cohesion: 0.29
Nodes (6): CatalogScreen(), ContactsScreen(), roleSummary(), { result }, { result, rerender }, usePendingToggle()

### Community 401 - "Community 401"
Cohesion: 0.25
Nodes (3): roto, rows, truncado

### Community 402 - "Community 402"
Cohesion: 0.25
Nodes (4): RetentionPolicyService, metadata, RetentionSettingsPage(), RetentionForm()
...
Cohesion: 0.33
Nodes (3): createTask(), resultado, selectLine()

### Community 478 - "Community 478"
Cohesion: 0.29
Nodes (4): CANCELADO, REGISTRADO, renombrado, user
...
Cohesion: 0.29
Nodes (6): client, inserted, newPhoto, path, row, source
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: El tipo de insumo bajo mínimo se declara sin generador, Scenario: Nada se rompe por su ausencia, Scenario: Preferencia presente, aviso ausente
...
## Knowledge Gaps
- **4832 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4827 more)
...
- **Why does `OrderService` connect `Community 59` to `Community 2`, `Community 34`, `Community 398`, `Community 146`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 1`, `Community 227`, `Community 4`, `Community 5`, `Community 6`, `Community 228`, `Community 200`, `Community 10`, `Community 11`, `Community 108`, `Community 14`, `Community 142`, `Community 52`, `Community 21`, `Community 22`, `Community 85`, `Community 56`, `Community 123`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 1` to `Community 0`, `Community 96`, `Community 3`, `Community 4`, `Community 5`, `Community 230`, `Community 7`, `Community 6`, `Community 40`, `Community 10`, `Community 518`, `Community 108`, `Community 142`, `Community 14`, `Community 52`, `Community 22`, `Community 56`, `Community 29`?**
