# Graph Report - kamay-app  (2026-09-08)

## Corpus Check
- 722 files · ~603,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7162 nodes · 11584 edges · 554 communities (532 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dcbf6278`
...
1. `cn()` - 206 edges
2. `getSessionContext()` - 76 edges
3. `Button()` - 65 edges
4. `getOwnerContext()` - 62 edges
5. `BusinessLine` - 38 edges
6. `Input()` - 37 edges
7. `ADDED Requirements` - 35 edges
8. `Badge()` - 31 edges
9. `BusinessLineService` - 29 edges
10. `Requirements` - 28 edges
...
- `StatusesSettingsPage()` --calls--> `getOwnerContext()`  [EXTRACTED]
  app/(app)/settings/statuses/page.tsx → lib/auth/session-context.ts

## Communities (554 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (66): ItemThumbnail(), DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, ExpenseCard(), ACTION_LABELS (+58 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (56): selectBusinessLine(), AppLayout(), getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (60): BoardTask, BoardView(), CalendarView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, ListView() (+52 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (58): ContactCombobox(), ContactComboboxRole, CategoryChips(), AssignableOrder, CostForm(), DetailBody(), occurredAtForDate(), lineIssuesOf() (+50 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (53): backoffDelay(), hasExhaustedAttempts(), esperas, capture(), CaptureDeps, CaptureResult, drain, draining (+45 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (56): LineOption(), LineSelector(), CatalogRow, LINE, push, UNIT, { unmount }, user (+48 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (49): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (56): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue(), revalidateOrders(), setArchived() (+48 more)
...
Cohesion: 0.07
Nodes (47): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+39 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (33): user, ThemeToggle(), AppSidebar(), nav, pathname, Header(), AVISO, bell (+25 more)
...
Cohesion: 0.1
Nodes (26): ActionResult, createTask(), QuickAdd(), created, link, onError, VariantFormDialog(), TaskFieldsProps (+18 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (31): FormValues, schema, Count(), DELIVERY_LABELS, TaskDetailProps, ACTION_LABELS, TaskHistory(), TaskHistoryProps (+23 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (31): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user, LastCostHint (+23 more)
...
Cohesion: 0.08
Nodes (31): a, addEntry(), _awaitComplete(), B(), deleteEntry(), destroy(), doneWaiting(), G() (+23 more)
...
Cohesion: 0.07
Nodes (31): CatalogScreen(), contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name, optionalAmount, optionalText (+23 more)
...
Cohesion: 0.08
Nodes (26): ExpenseRow, OrderRow, RecentCaptureService, CaptureKind, dayBoundsInTimezone(), dayOfInstant(), lineIdOf(), mergeRecentCaptures() (+18 more)
...
Cohesion: 0.09
Nodes (32): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+24 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (21): entregado, moved, order, registrado, NO_MONEY, OrderFilters, OrderRow, OrderService (+13 more)
...
Cohesion: 0.07
Nodes (19): AttachmentRow, AttachmentService, NewAttachment, [archivePayload], channelRow, client, lineRow, [payload] (+11 more)
...
Cohesion: 0.06
Nodes (35): ADDED Requirements, Purpose, Requirement: Cada quien ve sus pendientes según su rol, Requirement: Cuatro grupos por fecha, con contador y en orden fijo, Requirement: Es la pantalla de tareas del teléfono, Requirement: Filtrar dentro de los pendientes, Requirement: La pantalla de pendientes ignora deliberadamente el selector de línea, Requirement: Marcar hecha deja la tarea tachada en su sitio (+27 more)
...
Cohesion: 0.12
Nodes (19): TaskSheet(), ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), METHOD_LABELS, money() (+11 more)
...
Cohesion: 0.08
Nodes (20): BestSellerRow, FairProduct, FairSaleService, ProductRow, captureSale, channels, enlaces, products (+12 more)
...
Cohesion: 0.06
Nodes (22): CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user, add (+14 more)
...
Cohesion: 0.11
Nodes (16): EmailMessage, FailingMailer, Mailer, MemoryMailer, emailFor(), escape(), html(), DESTINATARIO (+8 more)
...
Cohesion: 0.11
Nodes (12): DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon }, upcomingWindow() (+4 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (27): ADDED Requirements, Purpose, Requirement: El reparto no altera el total, Requirement: El reparto se aplica en la lectura y jamás reescribe el egreso, Requirement: La organización elige una regla de reparto entre tres, Requirement: Ningún resultado repartido se muestra sin su regla, Requirement: Reparto a partes iguales, Requirement: Reparto manual con porcentajes que suman 100 (+19 more)
...
Cohesion: 0.12
Nodes (17): Destination, destinationOf(), GROUP_LABELS, NotificationList(), NotificationListProps, NotificationRow(), { onMarkAllRead }, { onMarkRead } (+9 more)
...
Cohesion: 0.15
Nodes (17): SessionContext, ExpenseItemService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate() (+9 more)
...
Cohesion: 0.08
Nodes (24): orders Specification, Requirement: Fecha comprometida con atajos, Requirement: Formulario de nuevo pedido (V5), Requirement: Líneas de pedido con precio propio, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Mover un pedido de estado, Requirements, Scenario: Ambos roles (+16 more)
...
Cohesion: 0.14
Nodes (14): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, batchLimitMessage() (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.12
Nodes (18): ACCEPTED_TYPES, browserCodec, compressImage(), CompressOptions, EXTENSIONS, ImageCodec, ImageSize, isAcceptedImage() (+10 more)

### Community 58 - "Community 58"
Cohesion: 0.12
Nodes (18): barPercent(), comparisonRows(), comparisonScale(), NO_CASH_FLOW, ALFARERIA, flows, rows, scale (+10 more)
...
Cohesion: 0.12
Nodes (22): archiveTask(), attachmentIdSchema, completeTask(), completeTaskSchema, CreateTaskResult, detachFromTask(), moveTaskSchema, moveTaskToStatus() (+14 more)
...
Cohesion: 0.1
Nodes (20): ExpenseFilters, ExpenseRow, ExpenseTotals, ExpenseWithTotal, NO_MONEY, CostFormInput, CostFormValues, expenseIdSchema (+12 more)
...
Cohesion: 0.14
Nodes (7): ContactFilters, ContactRow, ContactService, ContactFormValues, matchesSearch(), normalizeForSearch(), TagService

### Community 69 - "Community 69"
Cohesion: 0.1
Nodes (12): estado, TaskFields(), assignees, lines, onSave, recordatorio, renderFields(), statuses (+4 more)
...
Cohesion: 0.2
Nodes (19): _(), addToPrecacheList(), ae(), Be(), Fe(), findMatchingRoute(), get(), getIntegrityForPrecacheKey() (+11 more)

### Community 87 - "Community 87"
Cohesion: 0.12
Nodes (12): Call, FakeClient, FakeResult, query, result, client, [patch], paymentRow (+4 more)
...
Cohesion: 0.11
Nodes (17): 10. Integraciones y Funcionalidades de Terceros, 14. Próximos Pasos, 1. Resumen Ejecutivo, 3.1 Dueño / administrador, 3.2 Ayudante / operador (1 o 2 personas), 3.3 Organizaciones futuras, 3. Público Objetivo, 4. Tipo de Producto Digital (+9 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (17): MODIFIED Requirements, Requirement: Flujo de caja del periodo por línea, Requirement: Movimiento de caja con su línea y su activo, Scenario: Cada movimiento cae en el mes en que ocurrió, Scenario: Cobrado y pagado del mes, Scenario: El activo del pago aparece en la fila, Scenario: El agregado mensual coincide con el detalle, Scenario: El ayudante obtiene cero filas (+9 more)
...
Cohesion: 0.13
Nodes (13): defaultUploader, hasPendingUploads(), ReceiptUpload, ReceiptUploader, ReceiptUploadState, ReceiptUploadStatus, body, compressed (+5 more)

### Community 104 - "Community 104"
Cohesion: 0.17
Nodes (12): destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, labels, pendientes, tarea, venta (+4 more)
...
Cohesion: 0.16
Nodes (12): LineCashFlow, OwnerDashboard(), OwnerDashboardProps, activity, comparison, deliveries, PENDING, ActivityItem (+4 more)
...
Cohesion: 0.16
Nodes (12): ExpenseRowView, FILTERS, push, renderScreen(), ROWS, user, cents(), ExpenseSummary (+4 more)
...
Cohesion: 0.12
Nodes (16): Cada fila abre su registro, Capabilities, Configuración: la regla de reparto, Dependencias de aplicación, Exportación, Fuera de alcance (copiado del backlog), Impact, KAM-20 · Reportes (+8 more)
...
Cohesion: 0.23
Nodes (12): balance(), cents(), overpayment(), paymentStatus(), safe(), money(), PaymentDialog(), LABELS (+4 more)
...
Cohesion: 0.16
Nodes (10): GeneralSettingsPage(), metadata, OrganizationRow, OrganizationService, client, failing, [payload], row (+2 more)
...
Cohesion: 0.18
Nodes (10): MarkdownEditor(), MarkdownEditorProps, area, { onSave }, user, TOOLS, ToggleGroupContext, ToggleGroupItem() (+2 more)
...
Cohesion: 0.16
Nodes (10): MyTasksScreen(), button, completeTask, headings, postponeTask, row, sections, uncompleteTask (+2 more)

### Community 150 - "Community 150"
Cohesion: 0.14
Nodes (9): EditorLine, cantidad, CATALOGO, { onAdd, user }, { onRemove, user }, precio, TAZA, TAZA_CON_VARIANTES (+1 more)
...
Cohesion: 0.19
Nodes (13): 12. Tareas, 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log () (+5 more)
...
Cohesion: 0.2
Nodes (8): archivedCost, archivedPurchase, client, params, purchaseRow, ItemLastCost, ItemLastCostService, toNumber()
...
Cohesion: 0.17
Nodes (11): ADDED Requirements, Purpose, Requirement: Semilla de activos de Geeko Store, Requirement: Un activo es un destino vinculable válido para una tarea, Requirement: Un activo sin línea propia no muestra porcentaje, Scenario: Activo compartido, Scenario: Las barras no salen todas iguales, Scenario: Semilla presente tras el reinicio (+3 more)
...
Cohesion: 0.29
Nodes (7): AssistantDashboardProps, PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard(), { container }
...
Cohesion: 0.18
Nodes (10): MODIFIED Requirements, Requirement: Detalle del egreso, Scenario: Compra completa, Scenario: Compra completa, Scenario: Compra completa, Scenario: Enlace directo, Scenario: Gasto asignado a un pedido, Scenario: Gasto que pertenece a un activo (+2 more)
...
Cohesion: 0.22
Nodes (3): cuenta(), indicador(), totales
...
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del inventario, Requirement: Archivar una compra no altera el inventario, Scenario: Compra archivada, saldo intacto, Scenario: Escritura cruzada, Scenario: Movimientos de otra organización, Scenario: Ningún movimiento aparece sin autor (+1 more)
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (113 |       .getByTestId("contact-detail")), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.25
Nodes (8): 11. Vistas derivadas, 8. Egresos, 9. Pedidos y ventas, Cobros y pagos, code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Saldo actual por ítem), code:sql (-- Contactos: proveedores, clientes, o ambos)
...
Cohesion: 0.25
Nodes (8): Requirement: Ranking de productos vendidos dentro de un periodo, con unidades y margen, Scenario: El ayudante obtiene cero filas, Scenario: El precio es el que se registró, Scenario: El ranking de feria no cambia, Scenario: Las ventas directas cuentan, Scenario: Lo archivado no suma, Scenario: Un rango que no empieza el día 1, Scenario: Unidades y margen en la misma fila
...
Cohesion: 0.25
Nodes (7): code:block1 (Error: expect(locator).toContainText(expected) failed), code:yaml (- text: Ningún contacto elegido Elige un contacto de la list), code:ts (182 |   });), Error details, Instructions, Test info, Test source
...
Cohesion: 0.29
Nodes (5): AssistantDashboard(), { container }, deliveries, PENDING, root
...
Cohesion: 0.33
Nodes (6): Requirement: Formulario de compra (V8), Scenario: Compra completa, Scenario: El total sigue a las filas, Scenario: Proveedor nuevo al vuelo, Scenario: Quitar una fila, Scenario: Sin proveedor
...
Cohesion: 0.33
Nodes (6): Requirement: Insumos bajo mínimo, Scenario: De la tarjeta al insumo, Scenario: El ayudante también la ve, Scenario: La tarjeta respeta la línea activa, Scenario: Los insumos por debajo del mínimo aparecen, Scenario: Nada por debajo del mínimo
...
Cohesion: 0.4
Nodes (3): ExpensesScreen(), useIsMobile(), SidebarProvider()
...
Cohesion: 0.4
Nodes (3): items, { rerender, container }, UpcomingDeliveries()
...
Cohesion: 0.4
Nodes (5): 10. Inventario, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), code:sql (create table inventory_movements (), Una decisión que conviene revisar
...
Cohesion: 0.4
Nodes (5): Requirement: Informe de rentabilidad, Scenario: Ingresos cero, Scenario: Margen de un pedido con costo, Scenario: Margen negativo, Scenario: Pedido sin costo registrado
...
Cohesion: 0.5
Nodes (4): Requirement: El panel es la puerta de entrada de escritorio y se compone según el rol, Scenario: El ayudante recibe su propia composición, Scenario: El rol se decide antes de pintar, Scenario: La persona dueña recibe la composición completa
...
Cohesion: 0.5
Nodes (4): Requirement: El vínculo refleja el estado actual del registro, nunca una copia, Scenario: El estado del pedido cambia después de vincularlo, Scenario: El nombre del registro cambia después de vincularlo, Scenario: Un destino archivado sigue visible
...
Cohesion: 0.67
Nodes (3): Requirement: Todo movimiento de inventario queda en la bitácora, Scenario: El consumo queda registrado, Scenario: Una sola bitácora
...
## Knowledge Gaps
- **3912 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+3907 more)
...
- **Why does `cn()` connect `Community 0` to `Community 128`, `Community 1`, `Community 2`, `Community 3`, `Community 132`, `Community 5`, `Community 6`, `Community 7`, `Community 12`, `Community 17`, `Community 18`, `Community 149`, `Community 24`, `Community 35`, `Community 421`, `Community 38`, `Community 39`, `Community 40`, `Community 425`, `Community 43`, `Community 50`, `Community 58`, `Community 191`, `Community 104`, `Community 117`, `Community 379`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `OrderService` connect `Community 29` to `Community 1`, `Community 7`, `Community 71`, `Community 46`, `Community 52`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `getSessionContext()` connect `Community 1` to `Community 128`, `Community 7`, `Community 10`, `Community 11`, `Community 45`, `Community 46`, `Community 17`, `Community 53`, `Community 24`, `Community 56`, `Community 28`, `Community 63`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
