...
## Summary
- 9068 nodes · 14928 edges · 683 communities (657 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d152a015`
...
## Communities (683 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (91): Detail(), ORIGIN_LABELS, CatalogRow, CatalogScreen(), bajo, distintivo, LINE, push (+83 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (78): moveOrderToStatus(), relatedTasksFor(), unlinkTask(), buildDetail(), ChangePair, DiffRow, EventDetail, isBlankOnCreate() (+70 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (58): ACTION_LABELS, ActivityFiltersProps, FilterOption, DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, ContactCombobox(), ContactComboboxRole (+50 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (72): ItemThumbnail(), ExpensesScreen(), useIsMobile(), AppSidebar(), nav, pathname, cn(), AlertAction() (+64 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (56): createTask(), BoardTask, BoardView(), CalendarView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (51): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena (+43 more)
...
Cohesion: 0.06
Nodes (41): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), ActivityLayout() (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (31): loadRecordHistory(), AttachmentRow, AttachmentService, CopiedAttachment, NewAttachment, ContactFilters, ContactRow, ContactService (+23 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (56): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+48 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (46): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, resolveSearch(), csvOf(), GET() (+38 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (56): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, reorderQueue(), revalidateOrders(), setArchived(), setOrderAttachmentArchived() (+48 more)
...
Cohesion: 0.09
Nodes (36): ActionResult, FormValues, schema, hasARole(), itemVariantFormSchema, VariantFormDialog(), ContactFormDialog(), ContactsScreen() (+28 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (40): registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot, saveSnapshot (+32 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (41): ExpenseFilters(), ExpenseFilterValues, CheckoutSheet(), METHOD_LABELS, monto, onConfirm, { rerender }, CAPTURE_ROUTES (+33 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (39): ActivityDay, ActivityList(), ActivityListProps, ActivityRow(), ActivityRowItem, LastCostHint, PurchaseEditorLine, PurchaseLineErrors (+31 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (38): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+30 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (34): user, ThemeToggle(), useOnlineStatus(), ConsumptionDialog(), CountDialog(), Header(), AVISO, bell (+26 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (44): LineBadge(), CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineBadge(), ExpenseItemRow, ExpenseItemWithNames (+36 more)
...
Cohesion: 0.06
Nodes (27): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemService (+19 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (34): AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, LOW_STOCK, PENDING, root, LowStockCard() (+26 more)
...
Cohesion: 0.06
Nodes (34): DashboardService, DeliveryRow, MonthCashFlow, PENDING_KINDS, allLines, client, withLine, toNumber() (+26 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (32): actorOf(), capitalize(), contract(), DescribableEvent, describeEvent(), recordHref(), SUBJECTS, sentence (+24 more)
...
Cohesion: 0.06
Nodes (25): client, opciones, client, inserted, newPhoto, path, row, source (+17 more)

### Community 34 - "Community 34"
Cohesion: 0.11
Nodes (34): ActionResult, unarchiveFromEvent(), UNARCHIVERS, unarchiveSchema, ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema (+26 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (21): ActivityHeader(), readRetentionMonths(), RETENTION_KEY, retentionCutoff(), retentionLabel(), retentionMonthsSchema, RetentionSettingsInput, retentionSettingsSchema (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (27): addEntry(), _awaitComplete(), createHandlerBoundToUrl(), deleteEntry(), destroy(), doneWaiting(), getAll(), getAllEntriesByQueueName() (+19 more)
...
Cohesion: 0.06
Nodes (27): CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user, ExitFairMode() (+19 more)
...
Cohesion: 0.08
Nodes (32): withdrawDeliverable(), ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps, TaskFields(), assignees, lines, onSave (+24 more)
...
Cohesion: 0.09
Nodes (27): SIGNAL_CLASSES, SIGNAL_LABELS, TaskCard(), TaskCardData, card(), marca, { onOpen, tarjeta }, renderCard() (+19 more)
...
Cohesion: 0.12
Nodes (33): a, C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), G() (+25 more)
...
Cohesion: 0.13
Nodes (20): AssetCard(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine(), AssetDetailsForm(), AssetRowView, AssetsScreen(), cards (+12 more)
...
Cohesion: 0.09
Nodes (21): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+13 more)
...
Cohesion: 0.14
Nodes (15): emailsFor(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron(), hourInTimezone(), instante (+7 more)

### Community 65 - "Community 65"
Cohesion: 0.23
Nodes (15): ArchiveWarningProps, add, back, remove, { rerender }, user, METHOD_LABELS, AlertDialog() (+7 more)
...
Cohesion: 0.1
Nodes (12): AssetDetailsInput, AssetFilters, AssetService, RecoveryRow, client, [payload], primero, segundo (+4 more)
...
Cohesion: 0.1
Nodes (20): orders Specification, Requirement: Cancelación de pedido, Requirement: Confirmación antes de descartar, Requirement: Líneas de pedido con precio propio, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Cancelar con confirmación, Scenario: Cantidad no positiva (+12 more)
...
Cohesion: 0.11
Nodes (9): groupByType(), NotificationRow, NotificationService, client, groups, [payload], [rows, options], NOTIFICATION_TYPES (+1 more)
...
Cohesion: 0.16
Nodes (17): ActivityFilterBar(), ACTIONS, ActivityAction, activityHref(), hasActiveFilters(), isRealCivilDate(), normalizeRange(), one() (+9 more)

### Community 94 - "Community 94"
Cohesion: 0.18
Nodes (10): ajenos, todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn(), first (+2 more)

### Community 95 - "Community 95"
Cohesion: 0.15
Nodes (11): AllocationRuleService, client, update, GeneralSettingsPage(), metadata, AllocationSettingsInput, allocationSettingsSchema, readAllocationSettings() (+3 more)
...
Cohesion: 0.16
Nodes (15): consumptionSchema, ConsumptionValues, countSchema, CountValues, id, numeric, occurredAt, optionalId (+7 more)
...
Cohesion: 0.12
Nodes (10): closeTaskWithDeliverables, context, enviado, nombre, nombres, onCancel, onClosed, declareDeliverable (+2 more)
...
Cohesion: 0.23
Nodes (12): balance(), cents(), overpayment(), paymentStatus(), safe(), PaymentBlock(), money(), PaymentDialog() (+4 more)
...
Cohesion: 0.17
Nodes (12): scopedToLine(), ScopeItem, shortfallRatio(), sortByUrgency(), balances, critico, holgado, huerfano (+4 more)
...
Cohesion: 0.14
Nodes (11): ADDED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Las líneas de pedido se archivan, nunca se borran, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El detalle y la tarjeta no las muestran, Scenario: El formulario conserva lo escrito (+3 more)
...
Cohesion: 0.27
Nodes (7): LineOption(), LineSelector(), BusinessLineProvider(), BusinessLineState, LINE, useBusinessLineStore, ActiveLine
...
Cohesion: 0.22
Nodes (6): ADDED Requirements, Purpose, Requirement: Una compra necesita al menos una línea, Scenario: Guardado atómico, Scenario: Intento contra la operación de guardado, Scenario: Intento desde el formulario
...
Cohesion: 0.29
Nodes (4): linkTask, onLinked, searchLinkTargets, LinkTarget
...
Cohesion: 0.43
Nodes (6): balanceFromRow(), BalanceRow, movementFromRow(), MovementRow, toNullableNumber(), toNumber()
...
Cohesion: 0.33
Nodes (5): adjustment, consumption, deps, drainOutbox, enqueue
...
Cohesion: 0.4
Nodes (5): Requirement: La pantalla responde dentro de su presupuesto, Requirement: Los informes se adaptan al móvil, Requirements, Scenario: Doce meses de datos, Scenario: Un informe por pantalla
...
## Knowledge Gaps
- **4871 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4866 more)
...
- **Why does `OrderService` connect `Community 66` to `Community 5`, `Community 8`, `Community 392`, `Community 11`, `Community 55`, `Community 94`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 131`, `Community 4`, `Community 134`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 151`, `Community 24`, `Community 26`, `Community 45`, `Community 175`, `Community 56`, `Community 65`, `Community 68`, `Community 205`, `Community 91`, `Community 225`, `Community 229`, `Community 113`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 151`, `Community 30`, `Community 34`, `Community 38`, `Community 40`, `Community 52`, `Community 56`, `Community 65`, `Community 225`, `Community 113`?**
