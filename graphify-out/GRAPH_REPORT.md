...
## Summary
- 5894 nodes · 10037 edges · 465 communities (441 shown, 24 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3db8dede`
...
## Communities (465 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (57): CLASSES, isLineColor(), LINE_COLOR_LABELS, UnitRow, TaskFields(), TaskFieldsProps, assignees, lines (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (54): ContactCombobox(), ContactComboboxRole, CategoryChips(), AssignableOrder, CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+46 more)
...
Cohesion: 0.09
Nodes (40): ACTION_LABELS, ItemFormDialog(), ItemForm(), ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, VariantFormDialog(), VariantsList(), DataTable() (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (42): BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd(), created, link, onError (+34 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (37): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+29 more)
...
Cohesion: 0.08
Nodes (45): LineOption(), LineSelector(), cn(), Figure(), AlertAction(), CardFooter(), DialogOverlay(), EmptyContent() (+37 more)
...
Cohesion: 0.08
Nodes (26): useOnlineStatus(), MobileContextBar(), tira, OrganizationState, MEMBERSHIPS, ORG, useOrganizationStore, countItems() (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (32): createContactInline, createPurchase, LINES, push, SUPPLIERS, SUPPLIES, user, LastCostHint (+24 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (28): ItemPhotos(), ExpenseCard(), ACTION_LABELS, DetailBody(), KIND_LABELS, ReceiptView, ExpenseItemRow, ExpenseItemWithNames (+20 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (28): FormValues, schema, CatalogScreen(), ContactsScreen(), ROLE_FILTER_LABELS, roleSummary(), andina, archivado (+20 more)
...
Cohesion: 0.08
Nodes (30): addEntry(), _awaitComplete(), B(), createHandlerBoundToUrl(), deleteEntry(), destroy(), doneWaiting(), fetchDidFail() (+22 more)
...
Cohesion: 0.06
Nodes (25): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], SalesChannelRow (+17 more)
...
Cohesion: 0.09
Nodes (20): InviteForm(), BusinessLineProvider(), OrganizationProvider(), MEMBERSHIP, ORG, USER, UserProvider(), metadata (+12 more)
...
Cohesion: 0.1
Nodes (30): archiveTask(), attachmentIdSchema, createTask(), CreateTaskResult, detachFromTask(), moveTaskSchema, moveTaskToStatus(), revalidateTasks() (+22 more)
...
Cohesion: 0.1
Nodes (13): SessionContext, AttachmentRow, AttachmentService, NewAttachment, TaskDetail(), ExpenseItemService, loadExpenseDetail(), ExpenseDetailPage() (+5 more)

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (30): a, C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+22 more)
...
Cohesion: 0.11
Nodes (18): isCaptureRoute(), destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, labels, pendientes, tarea (+10 more)

### Community 42 - "Community 42"
Cohesion: 0.13
Nodes (21): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+13 more)
...
Cohesion: 0.13
Nodes (12): user, ThemeToggle(), Header(), bell, barra, mas, panel, pathname (+4 more)
...
Cohesion: 0.17
Nodes (19): CAPTURE_ROUTES, MobileNav(), barHrefOf(), barLabelOf(), bottomBarEntriesFor(), isNavEntryActive(), moreEntriesFor(), NAV_ENTRIES (+11 more)
...
Cohesion: 0.17
Nodes (22): _(), _addSyncListener(), addToPrecacheList(), ae(), Be(), constructor(), Fe(), findMatchingRoute() (+14 more)

### Community 56 - "Community 56"
Cohesion: 0.1
Nodes (19): ExpenseFilters, ExpenseRow, ExpenseTotals, NO_MONEY, CostFormInput, CostFormValues, expenseIdSchema, id (+11 more)
...
Cohesion: 0.14
Nodes (15): BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardState, displayedPlacement(), enCola, otra (+7 more)
...
Cohesion: 0.22
Nodes (11): AssistantDashboardProps, LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard(), { container }, DELIVERY_LABELS, DeliveryItem, items (+3 more)
...
Cohesion: 0.21
Nodes (13): balance(), cents(), overpayment(), paymentStatus(), safe(), PaymentBlock(), money(), PaymentDialog() (+5 more)

### Community 82 - "Community 82"
Cohesion: 0.14
Nodes (12): ACTION_LABELS, DELIVERY_LABELS, OrderDetail(), OrderImage, entregado, moved, order, registrado (+4 more)
...
Cohesion: 0.12
Nodes (16): orders Specification, Requirement: Fecha comprometida con atajos, Requirement: La columna en cola se ordena por llegada y muestra posición, Requirement: Las columnas del tablero salen del juego de estados de la línea, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: Columna que no es cola (+8 more)
...
Cohesion: 0.16
Nodes (14): contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name, optionalAmount, optionalText, quickContactSchema (+6 more)
...
Cohesion: 0.18
Nodes (9): OwnerDashboard(), OwnerDashboardProps, activity, comparison, deliveries, ActivityItem, RecentActivity(), { container } (+1 more)

### Community 121 - "Community 121"
Cohesion: 0.32
Nodes (11): ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone() (+3 more)
...
Cohesion: 0.18
Nodes (8): AppSidebar(), nav, pathname, SidebarProvider(), Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
Cohesion: 0.21
Nodes (12): 12. Tareas, 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log () (+4 more)
...
Cohesion: 0.2
Nodes (8): ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user, ItemPhoto
...
Cohesion: 0.25
Nodes (8): Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Pantalla de contactos (V13), Requirements, Scenario: El ayudante llega al catálogo, Scenario: Filtro por rol, Scenario: Inspección de las columnas del catálogo, Scenario: Selección sin abandonar la pantalla
...
Cohesion: 0.29
Nodes (5): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Un registro archivado no se edita sin desarchivarlo, Scenario: Intento de editar un registro archivado
...
Cohesion: 0.43
Nodes (7): _addRequest(), clone(), fromRequest(), registerSync(), replayRequests(), toObject(), unshiftRequest()
...
Cohesion: 0.29
Nodes (6): expenses Specification, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Requirements, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta, Scenario: Gasto en General
...
Cohesion: 0.33
Nodes (5): ADDED Requirements, Purpose, Requirement: Marcadores de posición declarados, Scenario: El marcador no engaña, Scenario: Los dos marcadores están rotulados
...
Cohesion: 0.33
Nodes (4): AssistantDashboard(), { container }, deliveries, root
...
Cohesion: 0.4
Nodes (4): ADDED Requirements, Purpose, Requirement: Semilla de egresos de Geeko Store, Scenario: Reinicio local
...
Cohesion: 0.5
Nodes (4): Requirement: El vínculo de una tarea con un pedido se guarda desde el primer día, Scenario: El vínculo sigue la visibilidad de su tarea, Scenario: Vínculo a un registro inexistente, Scenario: Vínculo duplicado
...
- **Why does `cn()` connect `Community 10` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 137`, `Community 12`, `Community 14`, `Community 15`, `Community 24`, `Community 25`, `Community 41`, `Community 46`, `Community 48`, `Community 52`, `Community 53`, `Community 54`, `Community 443`, `Community 63`, `Community 68`, `Community 74`, `Community 77`, `Community 81`, `Community 82`, `Community 89`, `Community 225`, `Community 229`, `Community 126`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 0` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 140`, `Community 13`, `Community 14`, `Community 15`, `Community 12`, `Community 19`, `Community 23`, `Community 411`, `Community 37`, `Community 46`, `Community 77`, `Community 82`, `Community 229`, `Community 126`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `captureSale()` connect `Community 2` to `Community 19`, `Community 47`?**
