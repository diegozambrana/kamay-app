...
## Corpus Check
- 90 files · ~76,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 806 nodes · 968 edges · 73 communities (62 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33596196`
...
## Knowledge Gaps
- **420 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `geistSans` (+415 more)
...
- **Why does `Kamay — Documento de Especificación de Producto` connect `Community 20` to `Community 35`, `Community 5`, `Community 41`, `Community 10`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 19`, `Community 28`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `6. Funcionalidades Clave` connect `Community 5` to `Community 20`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `7. Mapa de Vistas / Pantallas` connect `Community 10` to `Community 20`?**
