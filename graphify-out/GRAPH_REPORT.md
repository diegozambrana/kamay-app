...
## Corpus Check
- 844 files · ~715,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8075 nodes · 13582 edges · 605 communities (579 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e2b743b`
...
8. `Badge()` - 34 edges
9. `lineCookieName()` - 33 edges
10. `BusinessLineService` - 33 edges
...
## Communities (605 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (65): FormValues, schema, AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, LOW_STOCK, PENDING (+57 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (73): LineOption(), LineSelector(), ItemThumbnail(), Count(), cn(), AlertAction(), AlertDialogMedia(), AlertDialogOverlay() (+65 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (65): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+57 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (55): DeclarableAsset, DeclareAssetDialog(), ContactCombobox(), ContactComboboxRole, lineIssuesOf(), PurchaseForm(), LastCostHint, PurchaseEditorLine (+47 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (48): ConsumptionDialog(), AppSidebar(), nav, pathname, Header(), AVISO, bell, MobileContextBar() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (50): DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, columns, onAction, Row (+42 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (48): ExpenseCard(), ACTION_LABELS, DetailBody(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS, ReceiptView, data() (+40 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (44): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena (+36 more)
...
Cohesion: 0.05
Nodes (44): estado, item, onOpenChange, LinkSearchProps, money(), outstandingFor(), OutstandingSummary(), rows (+36 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (44): AssetDetailsForm(), CatalogRow, bajo, distintivo, LINE, push, sano, UNIT (+36 more)

### Community 11 - "Community 11"
Cohesion: 0.14
Nodes (33): assetDetailsSchema, ClosingDialogProps, EntryState, TaskFieldsProps, AssignableOrder, useOnlineStatus(), CountDialog(), ACTION_LABELS (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (40): todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn(), allocated, allocation (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (44): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+36 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (35): AllocationRuleService, client, update, GET(), TITLES, GeneralSettingsPage(), metadata, AllocationSettingsInput (+27 more)
...
Cohesion: 0.07
Nodes (35): createTask(), BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd(), created, link (+27 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (38): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, mas, panel, pathname, barHrefOf() (+30 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (22): getSessionContext(), SessionContext, AttachmentRow, AttachmentService, CopiedAttachment, NewAttachment, ContactFilters, ContactRow (+14 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (30): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), InviteForm() (+22 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (33): addEntry(), _addRequest(), B(), clone(), deleteEntry(), fetchDidFail(), fromRequest(), G() (+25 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (35): BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardState, displayedPlacement(), enCola, otra (+27 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (34): declareDeliverable(), withdrawDeliverable(), ClosingDialog(), closeTaskWithDeliverables, context, enviado, nombre, nombres (+26 more)
...
Cohesion: 0.07
Nodes (20): relatedTasksFor(), list, onConfirm, linkTask, onLinked, searchLinkTargets, RelatedTasksPanel(), RelatedTasksPanelProps (+12 more)
...
Cohesion: 0.1
Nodes (24): ActionResult, CartBar(), CheckoutSheet(), METHOD_LABELS, monto, onConfirm, { rerender }, ExitFairMode() (+16 more)
...
Cohesion: 0.08
Nodes (22): UnitRow, UnitService, comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone() (+14 more)
...
Cohesion: 0.07
Nodes (27): toggleTaskChecklistItem(), ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle (+19 more)
...
Cohesion: 0.08
Nodes (21): detachFromTask(), unlinkTask(), TaskDetail(), TaskDetailProps, ACTION_LABELS, TaskHistory(), TaskHistoryProps, filas (+13 more)
...
Cohesion: 0.15
Nodes (23): ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone() (+15 more)
...
Cohesion: 0.1
Nodes (26): archiveTask(), attachmentIdSchema, closeTaskSchema, closeTaskWithDeliverables(), closingEntrySchema, completeTask(), completeTaskSchema, CreateTaskResult (+18 more)
...
Cohesion: 0.15
Nodes (14): MarkdownEditorProps, TOOLS, CategoryChips(), BoardOrder, CalendarView(), View, HOURS, TYPES (+6 more)
...
Cohesion: 0.11
Nodes (10): groupByType(), NotificationRow, NotificationService, client, groups, [payload], [rows, options], NOTIFICATION_TYPES (+2 more)
...
Cohesion: 0.18
Nodes (16): balance(), cents(), overpayment(), paymentStatus(), safe(), Figure(), PaymentBlock(), money() (+8 more)
...
Cohesion: 0.14
Nodes (6): StatusInput, StatusRow, StatusService, defaultSetAsJson(), metadata, StatusesSettingsPage()
...
Cohesion: 0.19
Nodes (14): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), ExpenseLine(), RecoveryBar(), mark, hasAttributableLine() (+6 more)
...
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: Formulario de nuevo pedido (V5), Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Ambos roles, Scenario: Atajo «Mañana» (+11 more)
...
Cohesion: 0.21
Nodes (14): STATUS_KIND_LABELS, setIsComplete(), statusFlowSchema, statusFormSchema, StatusFormValues, result, valid, Mode (+6 more)
...
Cohesion: 0.16
Nodes (13): MyTasksScreen(), button, completeTask, headings, postponeTask, row, sections, uncompleteTask (+5 more)
...
Cohesion: 0.16
Nodes (12): emailsFor(), runForOrganization(), TaskWithStatus, isAuthorizedCron(), hourInTimezone(), instante, madrugada, medianoche (+4 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (15): ADDED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Entradas al alta y a la edición, Requirement: Las líneas de pedido se archivan, nunca se borran, Scenario: Creación con nombre y teléfono, Scenario: Desde el detalle, Scenario: Desde el tablero (+7 more)
...
Cohesion: 0.12
Nodes (14): AssetDetailView, acquisition, breakdown, detail, entries, links, maintenance, relatedTasksFor (+6 more)
...
Cohesion: 0.22
Nodes (10): SIGNAL_CLASSES, SIGNAL_LABELS, TaskCard(), CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineBadge() (+2 more)
...
Cohesion: 0.15
Nodes (10): ADDED Requirements, Purpose, Requirement: Egresos solo en el menú del dueño y redirección por dirección directa, Requirement: Pista del último precio en el formulario de compra, Scenario: Ayudante por dirección directa, Scenario: Insumo comprado antes, Scenario: Insumo nuevo, Scenario: La pista no cambia el valor (+2 more)
...
Cohesion: 0.15
Nodes (9): CostForm(), CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user (+1 more)
...
Cohesion: 0.29
Nodes (8): backoffDelay(), hasExhaustedAttempts(), esperas, DrainDeps, drainOutbox(), runDrain(), failedRecordIdsOf(), holdReason()

### Community 204 - "Community 204"
Cohesion: 0.18
Nodes (9): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Desarchivar devuelve el registro intacto, Scenario: Alta y cambio quedan en la bitácora, Scenario: Desarchivar desde el filtro, Scenario: El filtro no mezcla (+1 more)

### Community 205 - "Community 205"
Cohesion: 0.17
Nodes (12): Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: La búsqueda por nombre tolera acentos y mayúsculas, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Buscar con tilde lo que está sin tilde, Scenario: Buscar sin tilde lo que está con tilde, Scenario: El ayudante llega al catálogo (+4 more)

### Community 206 - "Community 206"
Cohesion: 0.17
Nodes (11): payments Specification, Requirement: Modelo de movimiento de dinero, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: El pago queda en la bitácora, Scenario: Método ausente, Scenario: Método fuera del dominio, Scenario: Monto cero (+3 more)
...
Cohesion: 0.31
Nodes (9): moveTaskToStatus(), uncompleteTask(), POST(), resolveMailer(), emailsFor(), emitTaskEvents(), planAssignment(), planStatusChange() (+1 more)

### Community 226 - "Community 226"
Cohesion: 0.29
Nodes (8): holdMessage(), FairSnapshot, FairSnapshotProduct, HoldReason, OutboxEntry, OutboxState, SessionIdentity, statusOf()
...
Cohesion: 0.29
Nodes (7): DELIVERY_LABELS, OrderCard(), OrderCardData, shortDate(), { container }, { unmount }, isOverdue()
...
Cohesion: 0.25
Nodes (7): DEFAULT_STATUS_SETS, DefaultStatus, kinds, positions, LineColor, STATUS_FLOWS, StatusFlow

### Community 301 - "Community 301"
Cohesion: 0.22
Nodes (6): OrderDetail(), entregado, moved, order, registrado, OrderWithTotal
...
## Knowledge Gaps
- **4353 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4348 more)
...
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 132`, `Community 130`, `Community 10`, `Community 11`, `Community 144`, `Community 19`, `Community 20`, `Community 24`, `Community 28`, `Community 30`, `Community 35`, `Community 39`, `Community 45`, `Community 301`, `Community 50`, `Community 60`, `Community 199`, `Community 73`, `Community 81`, `Community 90`, `Community 91`, `Community 93`, `Community 223`, `Community 242`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 35` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 132`, `Community 6`, `Community 5`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 28`, `Community 36`, `Community 50`, `Community 439`, `Community 60`, `Community 73`, `Community 81`, `Community 90`, `Community 93`, `Community 223`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `FakeQuery` connect `Community 434` to `Community 391`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
