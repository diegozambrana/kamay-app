...
## Corpus Check
- 751 files · ~630,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7374 nodes · 12098 edges · 573 communities (551 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d1c3724f`
...
10. `BusinessLineService` - 29 edges
...
## Communities (573 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (81): LineOption(), LineSelector(), ItemThumbnail(), AppSidebar(), nav, pathname, CAPTURE_ROUTES, isCaptureRoute() (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (56): CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user, createContactInline (+48 more)
...
Cohesion: 0.05
Nodes (50): user, ThemeToggle(), useOnlineStatus(), ConsumptionDialog(), CountDialog(), Header(), AVISO, bell (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (44): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+36 more)
...
Cohesion: 0.06
Nodes (44): BoardTask, CalendarView(), ListView(), SIGNAL_CLASSES, SIGNAL_LABELS, TaskCard(), TaskCardData, card() (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (43): LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames, PurchaseLinesTable(), HINTS, quantity, row (+35 more)

### Community 8 - "Community 8"
Cohesion: 0.1
Nodes (40): Assignee, View, ContactCombobox(), ContactComboboxRole, ROLE_FILTER_LABELS, CategoryChips(), AssignableOrder, CostForm() (+32 more)
...
Cohesion: 0.09
Nodes (34): ItemPhotos(), DataTableAction, DataTableProps, DEFAULT_ROW_ACTIONS, ACTION_LABELS, ExpenseDetail(), ExpenseDetailData, ReceiptView (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (30): createTask(), QuickAdd(), created, link, onError, ItemFormDialog(), ItemForm(), ITEM_KIND_LABELS (+22 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (38): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonRows(), comparisonScale() (+30 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (30): contactFormSchema, hasARole(), ContactFormDialog(), TaskFieldsProps, countAdjustment(), CountOutcome, toScale(), METHOD_LABELS (+22 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (26): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemService (+18 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (31): FormValues, schema, AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, LOW_STOCK, PENDING (+23 more)
...
Cohesion: 0.06
Nodes (29): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, memberLinesSchema (+21 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (29): a, addEntry(), _awaitComplete(), B(), deleteEntry(), destroy(), doneWaiting(), getAll() (+21 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (26): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+18 more)
...
Cohesion: 0.11
Nodes (33): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+25 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (20): OrderItemRow, OrderItemService, toNumber(), NO_MONEY, OrderFilters, OrderRow, OrderService, OrderTotals (+12 more)
...
Cohesion: 0.12
Nodes (28): ACTION_LABELS, VariantFormDialog(), VariantsList(), ItemLastCost, formatDateTime(), KIND_LABELS, movementLabel(), MovementsSection() (+20 more)
...
Cohesion: 0.1
Nodes (20): MobileContextBar(), tira, countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items (+12 more)
...
Cohesion: 0.08
Nodes (16): SessionContext, AttachmentRow, AttachmentService, NewAttachment, ItemLastCostService, toNumber(), loadExpenseDetail(), ExpenseDetailPage() (+8 more)
...
Cohesion: 0.13
Nodes (31): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+23 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (20): metadata, archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow (+12 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (20): ExpenseFilters(), ExpenseFilterValues, ExpensesScreen(), FILTERS, push, renderScreen(), ROWS, user (+12 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (13): ContactFilters, ContactRow, ContactService, ContactFormValues, ContactsPage(), metadata, matchesSearch(), normalizeForSearch() (+5 more)

### Community 45 - "Community 45"
Cohesion: 0.16
Nodes (26): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+18 more)
...
Cohesion: 0.09
Nodes (22): ItemDetail(), BALANCE, InventoryProps, item(), LINE, renderDetail(), UNIT, { unmount } (+14 more)
...
Cohesion: 0.08
Nodes (19): TaskDetail(), TaskDetailProps, ACTION_LABELS, TaskHistory(), TaskHistoryProps, filas, pendiente, CancelOrderButton() (+11 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (19): CatalogRow, CatalogScreen(), bajo, distintivo, LINE, push, sano, UNIT (+11 more)
...
Cohesion: 0.12
Nodes (10): StatusInput, StatusRow, StatusService, DEFAULT_STATUS_SETS, defaultSetAsJson(), DefaultStatus, kinds, positions (+2 more)
...
Cohesion: 0.11
Nodes (17): ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle, resultado (+9 more)

### Community 61 - "Community 61"
Cohesion: 0.09
Nodes (22): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Líneas de pedido con precio propio, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Cantidad no positiva (+14 more)
...
Cohesion: 0.1
Nodes (17): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta], DirectSaleInput (+9 more)

### Community 65 - "Community 65"
Cohesion: 0.15
Nodes (14): UnitRow, UnitService, DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now (+6 more)

### Community 66 - "Community 66"
Cohesion: 0.16
Nodes (12): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, batchLimitMessage() (+4 more)
...
Cohesion: 0.12
Nodes (7): metadata, MyTasksPage(), nextDay(), TaskFilters, TaskRow, TaskService, toTask()

### Community 73 - "Community 73"
Cohesion: 0.13
Nodes (16): BoardView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardState, displayedPlacement(), enCola (+8 more)
...
Cohesion: 0.16
Nodes (7): NotificationRow, NotificationService, NOTIFICATION_TYPES, OrganizationPlanInput, PlannableMember, PlannedNotification, Notification

### Community 109 - "Community 109"
Cohesion: 0.12
Nodes (16): 13. Riesgos, Dudas y Decisiones Pendientes, 14. Próximos Pasos, 1. Resumen Ejecutivo, 3.1 Dueño / administrador, 3.2 Ayudante / operador (1 o 2 personas), 3.3 Organizaciones futuras, 3. Público Objetivo, 4. Tipo de Producto Digital (+8 more)
...
Cohesion: 0.17
Nodes (10): Destination, destinationOf(), GROUP_LABELS, NotificationList(), NotificationListProps, NotificationRow(), { onMarkAllRead }, { onMarkRead } (+2 more)
...
Cohesion: 0.23
Nodes (8): emailFor(), escape(), html(), DESTINATARIO, message, trimSlash(), NotificationGenerator, travelsByEmail()
...
Cohesion: 0.35
Nodes (10): ExpensesPage(), currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone(), startOfNextDayInTimezone() (+2 more)
...
Cohesion: 0.21
Nodes (12): 11. Vistas derivadas, 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (-- Saldo actual por ítem), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log () (+4 more)
...
Cohesion: 0.2
Nodes (9): TasksScreen(), columns, extra, pushed, renderScreen(), row, select, tags (+1 more)
...
Cohesion: 0.18
Nodes (10): expenses Specification, Requirement: Pista del último precio en el formulario de compra, Requirement: Una compra necesita al menos una línea, Requirements, Scenario: Guardado atómico, Scenario: Insumo comprado antes, Scenario: Insumo nuevo, Scenario: Intento contra la operación de guardado (+2 more)

### Community 206 - "Community 206"
Cohesion: 0.2
Nodes (8): ADDED Requirements, Purpose, Requirement: Semilla de egresos de Geeko Store, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta, Scenario: Gasto en General, Scenario: Reinicio local
...
Cohesion: 0.31
Nodes (5): DUE_DATE_SHORTCUTS, DueDateShortcut, DueDateField(), { onChange, user }, shiftDate()

### Community 221 - "Community 221"
Cohesion: 0.2
Nodes (7): destination, finalStatus, initial, inProgress, name, user, waiting
...
Cohesion: 0.42
Nodes (8): balance(), cents(), overpayment(), paymentStatus(), safe(), PaymentBlock(), money(), PaymentDialog()
...
Cohesion: 0.25
Nodes (6): MarkdownEditor(), MarkdownEditorProps, area, { onSave }, user, TOOLS
...
Cohesion: 0.28
Nodes (4): InviteForm(), metadata, createClient(), metadata
...
Cohesion: 0.22
Nodes (5): FakeClient, client, [patch], paymentRow, [row]
...
Cohesion: 0.22
Nodes (7): DataTable(), DataTableColumn, columns, onAction, Row, rows, user
...
Cohesion: 0.25
Nodes (8): 8. Egresos, 9. Pedidos y ventas, Cobros y pagos, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Contactos: proveedores, clientes, o ambos), Una decisión que conviene revisar
...
Cohesion: 0.29
Nodes (5): Call, FakeResult, query, result, client
...
Cohesion: 0.4
Nodes (5): 10. Inventario, 12. Tareas, code:sql (create table orders (), code:sql (create table inventory_movements (), code:sql (create table tasks ()
...
## Knowledge Gaps
- **4012 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4007 more)
...
- **Why does `cn()` connect `Community 0` to `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 138`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 22`, `Community 278`, `Community 27`, `Community 31`, `Community 34`, `Community 40`, `Community 296`, `Community 178`, `Community 73`, `Community 204`, `Community 86`, `Community 231`, `Community 124`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `getSessionContext()` connect `Community 45` to `Community 32`, `Community 65`, `Community 66`, `Community 4`, `Community 37`, `Community 72`, `Community 137`, `Community 42`, `Community 40`, `Community 44`, `Community 41`, `Community 14`, `Community 47`, `Community 17`, `Community 86`, `Community 24`, `Community 57`, `Community 29`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `OrderService` connect `Community 28` to `Community 65`, `Community 67`, `Community 4`, `Community 37`, `Community 137`, `Community 42`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
