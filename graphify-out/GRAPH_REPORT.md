...
## Corpus Check
- 320 files · ~240,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2805 nodes · 4844 edges · 234 communities (219 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e123fe9e`
...
1. `cn()` - 164 edges
2. `getOwnerContext()` - 43 edges
3. `Button()` - 40 edges
4. `getSessionContext()` - 40 edges
5. `ADDED Requirements` - 30 edges
6. `Requirements` - 27 edges
7. `Input()` - 24 edges
8. `7. Mapa de Vistas / Pantallas` - 24 edges
9. `Kamay — Esquema de Base de Datos (Supabase / PostgreSQL)` - 21 edges
10. `BusinessLine` - 20 edges
...
Cohesion: 0.06
Nodes (53): ItemThumbnail(), useIsMobile(), nav, pathname, cn(), Avatar(), AvatarBadge(), AvatarFallback() (+45 more)
...
Cohesion: 0.1
Nodes (37): FormValues, LoginForm(), schema, ACTION_LABELS, ItemPhoto, ItemPhotos(), VariantsList(), ContactComboboxRole (+29 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (33): LineOption(), LineSelector(), user, ThemeToggle(), AppSidebar(), Header(), MobileContextBar(), CAPTURE_ROUTES (+25 more)
...
Cohesion: 0.08
Nodes (30): DataTableProps, DEFAULT_ROW_ACTIONS, DiscardGuard(), add, back, remove, { rerender }, user (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (35): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+27 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (20): AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, OrderDetailPage() (+12 more)
...
Cohesion: 0.1
Nodes (26): DataTable(), DataTableAction, DataTableColumn, columns, onAction, Row, rows, user (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (24): CatalogPicker(), LineAmounts, lineTotal(), orderTotal(), PickableItem, pickerCandidates(), prefilledPrice(), catalogo (+16 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (22): selectBusinessLine(), AppLayout(), SessionContext, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+14 more)
...
Cohesion: 0.1
Nodes (23): CatalogRow, LINE, push, UNIT, { unmount }, user, ItemForm(), ITEM_KIND_LABELS (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (24): CatalogScreen(), ItemFormDialog(), FileDropzone(), { result }, { result, rerender }, usePendingToggle(), DELIVERY_LABELS, lineIssuesOf() (+16 more)

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (22): CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, STATUS_KIND_LABELS, metadata, StatusesSettingsPage(), setIsComplete() (+14 more)
...
Cohesion: 0.1
Nodes (24): ActionResult, CreateOrderResult, id, MoveOrderInput, moveOrderSchema, numeric, optionalDeliveryMode, optionalDueDate (+16 more)
...
Cohesion: 0.15
Nodes (20): hasARole(), VariantFormDialog(), ContactFormDialog(), Dialog(), DialogClose(), DialogContent(), DialogDescription(), DialogFooter() (+12 more)
...
Cohesion: 0.09
Nodes (15): ContactCombobox(), AMBOS, ANDINA, CLIENTA, CREATED, onSelect, step, user (+7 more)

### Community 32 - "Community 32"
Cohesion: 0.14
Nodes (13): BoardOrder, CalendarView(), ListView(), View, metadata, SettingsLayout(), SETTINGS_SECTIONS, SettingsNav() (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (15): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+7 more)
...
Cohesion: 0.14
Nodes (12): ItemDetail(), ItemFilters, ItemRow, ItemVariantService, toNumber(), variantFromRow(), VariantRow, ItemFormValues (+4 more)
...
Cohesion: 0.22
Nodes (18): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+10 more)

### Community 39 - "Community 39"
Cohesion: 0.14
Nodes (15): archiveOrder(), createOrder(), moveOrderToStatus(), revalidateOrders(), setArchived(), setOrderAttachmentArchived(), unarchiveOrder(), updateOrder() (+7 more)
...
Cohesion: 0.11
Nodes (17): Context, D10 · Reparto por capas, D1 · El estado de pago se deriva de `payments`; la tabla se adelanta desde KAM-10 solo como almacenamiento, D2 · El egreso, sus líneas y su pago inicial se insertan con una función de base de datos, en una transacción, D3 · `item_last_cost` se crea ahora, y la pista se lee una vez por formulario, D4 · El comprobante se comprime en el navegador sin dependencia nueva y sube después de guardar, D5 · V9 en cuatro interacciones: monto con foco, chips, línea heredada, "Pagado" por defecto, D6 · V7 lleva los filtros en la dirección, calcula los totales al leer y abre el detalle en un panel (+9 more)
...
Cohesion: 0.16
Nodes (13): contactFormSchema, itemFormSchema, itemKindSchema, itemVariantFormSchema, name, optionalAmount, optionalText, quickContactSchema (+5 more)
...
Cohesion: 0.2
Nodes (7): InviteForm(), sanitizeInternalPath(), GET(), metadata, metadata, createClient(), metadata
...
Cohesion: 0.17
Nodes (8): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], UnitService
...
Cohesion: 0.27
Nodes (6): DUE_DATE_SHORTCUTS, DueDateShortcut, DueDateField(), { onChange, user }, shiftDate(), FieldError()

### Community 75 - "Community 75"
Cohesion: 0.24
Nodes (11): 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), code:sql (create table activity_log (), code:sql (create or replace function log_activity()), code:sql (-- Tarea programada mensual (pg_cron): exportar y luego resu) (+3 more)

### Community 76 - "Community 76"
Cohesion: 0.18
Nodes (10): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Líneas de pedido con precio propio, Requirements, Scenario: Cantidad no positiva, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito (+2 more)
...
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: El sobrepago se advierte pero se permite, Requirement: Registrar un pago desde el detalle del egreso, Scenario: Advertencia antes de confirmar, Scenario: El importe no se recorta, Scenario: El pago queda en la bitácora, Scenario: Pago parcial de una compra (+1 more)
...
Cohesion: 0.33
Nodes (6): defaultLandingPath(), isProtectedPath(), PROTECTED_PREFIXES, config, proxy(), updateSession()
...
Cohesion: 0.2
Nodes (8): OrderFilters, OrderRow, OrderWithTotal, OrderFormValues, OrderLineValues, DeliveryMode, Order, OrderKind
...
Cohesion: 0.2
Nodes (9): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Pantalla de contactos (V13), Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: El ayudante llega al catálogo, Scenario: Filtro por rol, Scenario: Intento de editar un registro archivado (+1 more)
...
Cohesion: 0.25
Nodes (6): item(), LINE, renderDetail(), UNIT, { unmount }, user
...
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: El catálogo no almacena nada derivado, Requirement: Semilla de catálogo y directorio de Geeko Store, Scenario: Inspección de las columnas del catálogo, Scenario: La búsqueda de la semilla tolera acentos, Scenario: Semilla presente tras el reinicio
...
Cohesion: 0.29
Nodes (3): ExpenseCategoryRow, ExpenseCategoryService, ExpenseCategory
...
Cohesion: 0.33
Nodes (6): Requirement: El total del egreso se deriva, nunca se almacena, Scenario: Coincide con la suma manual, Scenario: Compra sin pagos, Scenario: Ninguna columna almacena el derivado, Scenario: Total de un gasto, Scenario: Total de una compra con líneas
...
Cohesion: 0.4
Nodes (5): Requirement: Detalle del egreso, Scenario: Compra completa, Scenario: Enlace directo, Scenario: Gasto asignado a un pedido, Scenario: Historial
...
## Knowledge Gaps
- **1420 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+1415 more)
...
- **Why does `cn()` connect `Community 0` to `Community 32`, `Community 33`, `Community 2`, `Community 3`, `Community 5`, `Community 73`, `Community 10`, `Community 11`, `Community 42`, `Community 15`, `Community 16`, `Community 25`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `StatusService` connect `Community 64` to `Community 65`, `Community 38`, `Community 7`, `Community 12`, `Community 16`, `Community 113`, `Community 20`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 2` to `Community 32`, `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 73`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 50`, `Community 25`, `Community 27`, `Community 63`?**
