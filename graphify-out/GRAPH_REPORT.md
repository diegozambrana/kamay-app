...
## Summary
- 10517 nodes · 18010 edges · 773 communities (750 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 150 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76530893`
...
## Communities (773 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (98): relatedTasksFor(), ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item(), LINE (+90 more)
...
Cohesion: 0.07
Nodes (69): ACTION_LABELS, ActivityFiltersProps, FilterOption, assetDetailsSchema, ContactComboboxRole, ClosingDialogProps, EntryState, DeliverablesSection() (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (59): selectBusinessLine(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena (+51 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (54): ActivityListProps, AssetRowView, AssetsScreen(), cards, first, push, Assignee, TASK_FILTERS (+46 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (53): EventDetail, HistoryEntry(), RecordHistory, ACTION_LABELS, TaskHistory(), TaskHistoryProps, enlace, filas (+45 more)
...
Cohesion: 0.04
Nodes (61): Detail(), AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetDetailsForm() (+53 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (46): AuthActionResult, emailSchema, enterOrganization(), login(), loginSchema, passwordSchema, selectOrganization(), updatePassword() (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (52): ActivityRow(), ActivityRowItem, ORIGIN_LABELS, BoardTask, BoardView(), CalendarView(), KanbanBoard(), KanbanColumn (+44 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (46): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, AllocationRuleService, CsvContext, csvFilename() (+38 more)
...
Cohesion: 0.08
Nodes (34): FormValues, schema, ActionResult, createTask(), metadata, QuickAdd(), created, link (+26 more)
...
Cohesion: 0.07
Nodes (38): AccountLayout(), NoOrganizationNotice(), ProfileView, ROLE_LABELS, organization, view, signOut(), changePassword() (+30 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (39): client, opciones, client, [payload], primero, segundo, client, update (+31 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (29): joinsContactWindow(), ContactsPage(), metadata, chunk(), takeWindow(), OrderItemRow, OrderItemService, OrderItemWithNames (+21 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (32): estado, Redirect, recordActivityHref(), loadRecordHistory(), RecordHistoryItem, NotFound(), SessionContext, [archivePayload] (+24 more)
...
Cohesion: 0.11
Nodes (33): DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, columns, onAction, renderTable() (+25 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (41): useIsMobile(), links, nav, pathname, OrganizationSwitcher(), enterOrganization, [geeko], options (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (31): { result }, useSignOut(), LineSelector(), user, ThemeToggle(), captureSale, channels, enlaces (+23 more)
...
Cohesion: 0.07
Nodes (41): ActionResult, CreateOrderResult, reorderQueue(), BoardColumn(), Midpoint, Queueable, queuePositions(), renormalize() (+33 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (36): barra, block, mas, panel, pathname, renderNav(), errors, OldSidebar() (+28 more)
...
Cohesion: 0.07
Nodes (33): DeclarableAsset, DeclareAssetDialog(), LoginForm(), ContactCombobox(), CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm() (+25 more)
...
Cohesion: 0.13
Nodes (24): ProfileForm(), FormValues, schema, ClosingDialog(), TaskDetailProps, TaskFields(), balance(), cents() (+16 more)
...
Cohesion: 0.13
Nodes (24): AppSidebar(), Header(), AVISO, bell, menu, MobileContextBar(), tira, groupByType() (+16 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (14): original, link, first, row, alreadyThere, cambios, option, recorrido (+6 more)
...
Cohesion: 0.12
Nodes (24): updateTaskFields(), RetentionJobDeps, runRetentionJob(), emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus (+16 more)
...
Cohesion: 0.11
Nodes (13): DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon }, upcomingWindow() (+5 more)
...
Cohesion: 0.12
Nodes (20): attachToTask(), AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, renderPanel(), uno (+12 more)
...
Cohesion: 0.12
Nodes (19): UserDetailPage(), ROLE_LABELS, UserListFilters, UserRow, activeMemberships(), displayNameOf(), matchesName(), normalize() (+11 more)
...
Cohesion: 0.1
Nodes (25): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonRows(), comparisonScale() (+17 more)
...
Cohesion: 0.11
Nodes (20): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), UserMenu(), BoardColumn(), DraggableCard(), ActionItem(), RowAction, RowActionsMenu() (+12 more)

### Community 68 - "Community 68"
Cohesion: 0.12
Nodes (19): AssistantDashboard(), AssistantDashboardProps, { container }, deliveries, LOW_STOCK, PENDING, root, LowStockCard() (+11 more)

### Community 69 - "Community 69"
Cohesion: 0.13
Nodes (23): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barHrefOf(), barLabelOf(), bottomBarEntriesFor(), isNavEntryActive(), moreEntriesFor() (+15 more)
...
Cohesion: 0.21
Nodes (21): inviteMember(), addAccountByEmail(), AddUserResult, addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue() (+13 more)
...
Cohesion: 0.12
Nodes (18): plan, RUN, sinCorreo, summaries, tasks, adminClient(), countNotifications(), serviceRoleKey() (+10 more)
...
Cohesion: 0.11
Nodes (19): declareDeliverable(), declareDeliverable, renderSection(), withdrawDeliverable, canDeclare(), closesWithoutDeliverables(), DELIVERABLE_TYPES, DeliverableDefinition (+11 more)
...
Cohesion: 0.08
Nodes (24): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Requirement: Mínimos obligatorios del pedido, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Alta mínima (+16 more)
...
Cohesion: 0.1
Nodes (19): renderMenu(), card(), marca, { onOpen, tarjeta }, renderCard(), renderWith(), area, { onSave } (+11 more)
...
Cohesion: 0.13
Nodes (17): registerDirectSale(), RegisterDirectSaleResult, archiveOrder(), createOrder(), moveOrderToStatus(), revalidateOrders(), setArchived(), setOrderAttachmentArchived() (+9 more)
...
Cohesion: 0.13
Nodes (14): DirectSaleInput, DirectSaleLineInput, directSaleLineSchema, DirectSalePaymentInput, directSalePaymentSchema, directSaleSchema, id, CaptureSaleDeps (+6 more)
...
Cohesion: 0.13
Nodes (13): CheckoutSheet(), monto, onConfirm, { rerender }, ExitFairMode(), salida, FairStart(), channels (+5 more)
...
Cohesion: 0.11
Nodes (15): OwnerDashboard(), OwnerDashboardProps, activity, card, comparison, { container }, deliveries, LOW_STOCK (+7 more)
...
Cohesion: 0.17
Nodes (13): ConsumptionValues, CountValues, capture(), captureAdjustment(), captureConsumption(), CaptureMovementDeps, outboxDeps(), adjustment (+5 more)
...
Cohesion: 0.15
Nodes (9): hasPendingUploads(), TaskUploader, chico, enviada, enVuelo, lote, sueltas, uploader (+1 more)
...
Cohesion: 0.18
Nodes (8): ADDED Requirements, Purpose, Requirement: El estado de pago se deriva de los pagos registrados, Scenario: El estado no se guarda, Scenario: Monto parcial fuera de rango, Scenario: Registrado como pagado, Scenario: Registrado como parcial, Scenario: Registrado como pendiente
...
Cohesion: 0.22
Nodes (8): activity-log Specification, Requirement: Action kind is derived from the nature of the change, Requirement: Updates record only the fields that changed, Requirements, Scenario: Archiving is logged as archived, not updated, Scenario: Single-field update stores only that field, Scenario: Touching only updated_at produces no event, Scenario: Unarchiving is logged as unarchived
...
Cohesion: 0.25
Nodes (6): StatusInput, StatusRow, metadata, StatusesSettingsPage(), statusFlowSchema, StatusesSection()
...
Cohesion: 0.25
Nodes (7): notifications Specification, Requirement: El tipo de insumo bajo mínimo se declara sin generador, Requirement: La bitácora nunca genera notificaciones, Requirements, Scenario: Actividad intensa, bandeja tranquila, Scenario: Nada se rompe por su ausencia, Scenario: Preferencia presente, aviso ausente
...
- **Why does `useSearchReset()` connect `Community 4` to `Community 14`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 14` to `Community 4`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `boot()` connect `Community 14` to `Community 1`?**
