...
## Corpus Check
- 1072 files · ~1,097,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10031 nodes · 16819 edges · 757 communities (734 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c0a69aa8`
...
1. `cn()` - 224 edges
2. `Button()` - 101 edges
3. `getSessionContext()` - 97 edges
4. `getOwnerContext()` - 80 edges
5. `Input()` - 48 edges
6. `RENDER` - 45 edges
7. `BusinessLine` - 42 edges
8. `test` - 36 edges
9. `Badge()` - 36 edges
10. `ADDED Requirements` - 36 edges
...
## Communities (757 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (97): SignOutConfirmDialog(), UserMenu(), BoardColumn(), DraggableCard(), ItemThumbnail(), METHOD_LABELS, useReturnFocus(), AppSidebar() (+89 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (69): FormValues, schema, ActionResult, ACTION_LABELS, ActivityFiltersProps, FilterOption, DeclarableAsset, DeclareAssetDialog() (+61 more)
...
Cohesion: 0.04
Nodes (84): metadata, BoardTask, BoardView(), CalendarView(), KanbanBoard(), KanbanColumn, ListView(), QuickAdd() (+76 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (75): relatedTasksFor(), ActivityListProps, ActivityRow(), ActivityRowItem, TasksScreen(), CATALOG_FILTERS, CatalogScreen(), ACTION_LABELS (+67 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (51): changePassword(), changePasswordSchema, displayNameSchema, ProfileActionResult, updateDisplayName(), recordActivityHref(), loadRecordHistory(), RecordHistoryItem (+43 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (45): ProfileForm(), Detail(), ORIGIN_LABELS, EventDetail, HistoryEntry(), FormValues, schema, itemVariantFormSchema (+37 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (43): NoOrganizationNotice(), AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), signOut() (+35 more)
...
Cohesion: 0.05
Nodes (55): CLASSES, isLineColor(), LINE_COLOR_LABELS, FairStart(), channels, lines, onStart, estado (+47 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (57): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+49 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (43): selectBusinessLine(), AppLayout(), getRequestMemberships, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+35 more)
...
Cohesion: 0.06
Nodes (47): LoginForm(), CostForm(), ExpenseCard(), ACTION_LABELS, DetailBody(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS (+39 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (41): { result }, registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot (+33 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (39): LineOption(), LineSelector(), user, ThemeToggle(), ConsumptionDialog(), CountDialog(), Header(), AVISO (+31 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (39): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+31 more)
...
Cohesion: 0.06
Nodes (31): AllocationRuleService, client, update, ExpenseCategoryService, TITLES, GeneralSettingsPage(), metadata, AllocationSettingsInput (+23 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (40): RecordHistory, ClosingDialog(), DeliverablesSection(), DeliverablesSectionProps, TaskDetailProps, TaskFields(), assignees, lines (+32 more)
...
Cohesion: 0.08
Nodes (24): RetentionJobResult, runRetentionJob(), EMPTY, report, run, readRetentionMonths(), RETENTION_KEY, retentionCutoff() (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (38): buildDetail(), ChangePair, DETAIL_MARKERS, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds() (+30 more)
...
Cohesion: 0.09
Nodes (34): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue(), revalidateOrders(), setArchived() (+26 more)
...
Cohesion: 0.1
Nodes (23): CatalogPage(), metadata, CatalogScope, ContactScope, joinsCatalogWindow(), joinsContactWindow(), all, archived (+15 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (29): ActivityFilterBar(), ActivityPage, ActivityService, decodeCursor(), encodeCursor(), RecentActivityEntry, RecentOptions, client (+21 more)
...
Cohesion: 0.09
Nodes (21): UnitRow, UnitService, DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now (+13 more)
...
Cohesion: 0.09
Nodes (24): LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames, PurchaseLinesTable(), HINTS, quantity, row (+16 more)
...
Cohesion: 0.08
Nodes (21): detalle, monto, form, more, rows, elapsed, MID_RANGE, started (+13 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (28): ACCOUNT_ACTION_LABELS, useSignOut(), CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, block, mas (+20 more)
...
Cohesion: 0.08
Nodes (14): entregado, moved, order, registrado, renderDetail(), NO_MONEY, OrderFilters, OrderRow (+6 more)

### Community 47 - "Community 47"
Cohesion: 0.1
Nodes (19): signOutButton, errors, match, link, toggle, empty, error, filtered (+11 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (32): archiveTask(), attachmentIdSchema, closeTaskSchema, closeTaskWithDeliverables(), closingEntrySchema, completeTask(), completeTaskSchema, createTask() (+24 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (22): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), DEFAULT_PREFERENCES, PreferencesRow (+14 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (11): original, first, row, filas, alreadyThere, cambios, option, recorrido (+3 more)
...
Cohesion: 0.12
Nodes (22): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, CsvContext, csvFilename(), CsvTable (+14 more)
...
Cohesion: 0.12
Nodes (18): ActivityHeader(), ActivityDay, ActivityList(), formatLabel(), hasLabel(), LABEL_COLUMNS, LabelMap, LabelService (+10 more)
...
Cohesion: 0.16
Nodes (18): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetDetailsForm(), AssetRowView (+10 more)
...
Cohesion: 0.08
Nodes (24): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Requirement: Las líneas de pedido se archivan, nunca se borran, Requirement: Mover un pedido de estado, Requirements, Scenario: Arrastre exitoso (+16 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (9): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemService (+1 more)
...
Cohesion: 0.11
Nodes (15): archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow, client (+7 more)
...
Cohesion: 0.09
Nodes (20): renderMenu(), renderScreen(), task(), item(), renderDetail(), renderFields(), task(), area (+12 more)
...
Cohesion: 0.09
Nodes (13): general, name, nav, option, row, handle, initialRow, list (+5 more)
...
Cohesion: 0.15
Nodes (16): GROUP_KEYS, GROUP_LABELS, GroupableTask, groupByDue(), GroupKey, keyOf(), pendingCounts(), TaskGroup (+8 more)

### Community 108 - "Community 108"
Cohesion: 0.14
Nodes (9): NotificationRow, NotificationService, NOTIFICATION_TYPES, OrganizationPlanInput, PlannableMember, PlannableTask, PlannedNotification, StatusKind (+1 more)
...
Cohesion: 0.16
Nodes (11): metadata, SettingsLayout(), SETTINGS_SECTIONS, SettingsNav(), abiertas, enDisco, enMenu, layout (+3 more)
...
Cohesion: 0.14
Nodes (10): AssistantDashboard(), { container }, deliveries, LOW_STOCK, PENDING, root, DeliveryItem, items (+2 more)
...
Cohesion: 0.18
Nodes (7): EmailMessage, FailingMailer, Mailer, MemoryMailer, client, mailer, [rows]
...
Cohesion: 0.19
Nodes (13): 12. Tareas, 13. Adjuntos, 14. Bitácora de actividad, Agrupación de ruido, code:sql (create table inventory_movements (), code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización") (+5 more)
...
Cohesion: 0.15
Nodes (13): Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Archivar retira de listados y buscadores sin borrar la historia, Requirement: Desarchivar devuelve el registro intacto, Requirement: El catálogo no almacena nada derivado, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: Desarchivar desde el filtro, Scenario: El filtro no mezcla (+5 more)
...
Cohesion: 0.15
Nodes (12): expenses Specification, Requirement: Comprobante comprimido en el cliente y subido en segundo plano, Requirement: Líneas de compra con precio propio, Requirements, Scenario: Cantidad no positiva, Scenario: El guardado no espera, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Formato no admitido (+4 more)
...
Cohesion: 0.18
Nodes (8): ADDED Requirements, Purpose, Requirement: Pista del último precio en el formulario de compra, Requirement: Semilla de egresos de Geeko Store, Scenario: Insumo comprado antes, Scenario: Insumo nuevo, Scenario: La pista no cambia el valor, Scenario: Reinicio local
...
Cohesion: 0.18
Nodes (10): assets Specification, Requirement: El costo total del activo suma su mantenimiento, Requirement: Un activo sin línea propia no muestra porcentaje, Requirements, Scenario: Activo compartido, Scenario: El costo total no vive en una columna, Scenario: El egreso de adquisición no se cuenta dos veces, Scenario: Mantenimiento archivado (+2 more)

### Community 270 - "Community 270"
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: Alta de un activo desde el catálogo, Requirement: Semilla de activos de Geeko Store, Scenario: Alta desde el detalle del ítem, Scenario: El ayudante no ve la sección, Scenario: Las barras no salen todas iguales, Scenario: No se ofrece donde no corresponde (+1 more)
...
Cohesion: 0.2
Nodes (5): TaskAttachment, enqueued, onDetach, renderPanel(), uno
...
Cohesion: 0.2
Nodes (10): 15. Notificaciones, 18. Orden de migraciones, code:sql (create trigger audit after insert or update on orders), code:sql (create table notifications (), code:sql (create policy "tasks: ayudante ve su línea o lo asignado"), code:sql (alter table activity_log enable row level security;), code:block27 (001_extensions_and_helpers    -- pgcrypto, is_member(), is_o), code:sql (-- Líneas) (+2 more)
...
Cohesion: 0.22
Nodes (7): ADDED Requirements, catalog-directory Specification, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Un registro archivado no se edita sin desarchivarlo, Scenario: El ayudante llega al catálogo, Scenario: Intento de editar un registro archivado
...
Cohesion: 0.2
Nodes (9): activity-screen Specification, Requirement: Desde el evento se llega al registro afectado, Requirement: El vacío inicial y el resultado sin coincidencias se distinguen, Requirements, Scenario: El evento de un pedido lleva a su pedido, Scenario: Lo archivado sigue siendo alcanzable, Scenario: Ningún evento coincide, Scenario: Sin eventos todavía (+1 more)
...
Cohesion: 0.33
Nodes (5): emailsFor(), emitTaskEvents(), NotificationGenerator, planAssignment(), planStatusChange()
...
Cohesion: 0.22
Nodes (9): Requirement: El tipo de insumo bajo mínimo se declara sin generador, Requirement: La bitácora nunca genera notificaciones, Requirement: La generación privilegiada se limita al trabajo programado y a la creación de avisos, Requirements, Scenario: Actividad intensa, bandeja tranquila, Scenario: Cada aviso a su organización, Scenario: Disparo sin credencial, Scenario: Nada se rompe por su ausencia (+1 more)

### Community 419 - "Community 419"
Cohesion: 0.22
Nodes (8): activity-log Specification, Requirement: Action kind is derived from the nature of the change, Requirement: Existing tables are audited and future tables must opt in at creation, Requirements, Scenario: Archiving is logged as archived, not updated, Scenario: Changes to organizations are logged, Scenario: The attachment procedure is documented, Scenario: Unarchiving is logged as unarchived
...
Cohesion: 0.33
Nodes (7): 16. Seguridad a nivel de fila (RLS), Bitácora: inalterable de verdad, Cómo se ocultan los costos al ayudante, code:sql (-- Tarea programada mensual (pg_cron): exportar y luego resu), code:sql (alter table orders enable row level security;), Matriz de acceso, Patrón general

### Community 530 - "Community 530"
Cohesion: 0.29
Nodes (7): 11. Vistas derivadas, 8. Egresos, Cobros y pagos, code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Saldo actual por ítem), code:sql (-- Contactos: proveedores, clientes, o ambos)
...
Cohesion: 0.4
Nodes (5): 10. Inventario, 9. Pedidos y ventas, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), Una decisión que conviene revisar
...
Cohesion: 0.5
Nodes (4): Requirement: An account without an organization can sign out, Scenario: After signing out, the notice is no longer reachable, Scenario: Signing out from the notice goes to login, Scenario: The notice offers a way out
...
Cohesion: 0.67
Nodes (3): Requirement: Sign-in lands on the device-appropriate home, Scenario: Desktop lands on the dashboard, Scenario: Mobile lands on quick capture

### Community 736 - "Community 736"
Cohesion: 0.67
Nodes (3): Requirement: Users with multiple organizations must choose one, Scenario: Multi-organization user selects before continuing, Scenario: Single-organization user skips selection
...
## Knowledge Gaps
- **5331 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+5326 more)
...
- **Why does `useSearchReset()` connect `Community 4` to `Community 3`, `Community 13`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 13` to `Community 4`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AttachmentService` connect `Community 61` to `Community 32`, `Community 163`, `Community 35`, `Community 5`, `Community 202`, `Community 110`, `Community 48`?**
...
- **What connects `config`, `config`, `eslintConfig` to the rest of the system?**
  _5331 weakly-connected nodes found - possible documentation gaps or missing edges._
