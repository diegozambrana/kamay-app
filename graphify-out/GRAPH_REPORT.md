...
## Summary
- 3201 nodes · 5735 edges · 257 communities (243 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db732901`
...
- `ChannelsSettingsPage()` --calls--> `getOwnerContext()`  [EXTRACTED]
  app/(app)/settings/channels/page.tsx → lib/auth/session-context.ts

## Communities (257 total, 14 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (66): LineOption(), LineSelector(), ItemThumbnail(), cn(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+58 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (48): ContactCombobox(), ContactComboboxRole, CategoryChips(), CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm(), LastCostHint (+40 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (46): FormValues, schema, LineColorClasses, ACTION_LABELS, VariantsList(), ExpenseCard(), ACTION_LABELS, DetailBody() (+38 more)
...
Cohesion: 0.06
Nodes (32): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+24 more)
...
Cohesion: 0.09
Nodes (29): CLASSES, isLineColor(), LINE_COLOR_LABELS, STATUS_KIND_LABELS, metadata, StatusesSettingsPage(), setIsComplete(), statusFlowSchema (+21 more)

### Community 11 - "Community 11"
Cohesion: 0.14
Nodes (27): ItemFormDialog(), ItemForm(), ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, AssignableOrder, ListView(), View, BusinessLine (+19 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (32): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+24 more)
...
Cohesion: 0.13
Nodes (25): ItemPhoto, ItemPhotos(), DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, columns (+17 more)
...
Cohesion: 0.15
Nodes (21): AppLayout(), preselectedLineId(), resolveActiveLine(), CatalogPage(), metadata, BusinessLineRow, BusinessLineService, lineCookieName() (+13 more)
...
Cohesion: 0.11
Nodes (15): selectBusinessLine(), getSessionContext(), SessionContext, AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService (+7 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (18): ROLE_FILTER_LABELS, metadata, ReceiptField(), FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), formatFileSize() (+10 more)
...
Cohesion: 0.17
Nodes (18): VariantFormDialog(), Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, Dialog(), DialogClose() (+10 more)
...
Cohesion: 0.13
Nodes (13): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemVariantService (+5 more)
...
Cohesion: 0.15
Nodes (15): contactFormSchema, ContactFormValues, hasARole(), itemFormSchema, itemKindSchema, itemVariantFormSchema, name, optionalAmount (+7 more)
...
Cohesion: 0.14
Nodes (11): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), client, formValues, orderRow, { p_items } (+3 more)
...
Cohesion: 0.17
Nodes (10): findActiveLine(), ajena, ALFARERIA, SUBLIMACION, BusinessLineProvider(), BusinessLineState, LINE, useBusinessLineStore (+2 more)

### Community 58 - "Community 58"
Cohesion: 0.16
Nodes (10): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Tarjeta del tablero, Scenario: Abrir el detalle, Scenario: Datos opcionales ausentes, Scenario: La señal de pago no depende del estado del pedido, Scenario: Pedido con modo de entrega (+2 more)

### Community 59 - "Community 59"
Cohesion: 0.13
Nodes (14): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Creación con nombre y teléfono, Scenario: El contacto es un cliente, Scenario: El formulario conserva lo escrito (+6 more)
...
Cohesion: 0.15
Nodes (9): [archivePayload], channelRow, client, lineRow, [payload], service, [unarchivePayload], UnitRow (+1 more)
...
Cohesion: 0.21
Nodes (7): updateGeneralSettings(), GeneralSettingsPage(), metadata, OrganizationRow, OrganizationService, toEntity(), GeneralForm()
...
Cohesion: 0.25
Nodes (7): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Pantalla de contactos (V13), Requirements, Scenario: El ayudante llega al catálogo, Scenario: Filtro por rol, Scenario: Selección sin abandonar la pantalla
...
Cohesion: 0.29
Nodes (6): ADDED Requirements, Purpose, Requirement: El catálogo no almacena nada derivado, Requirement: Un registro archivado no se edita sin desarchivarlo, Scenario: Inspección de las columnas del catálogo, Scenario: Intento de editar un registro archivado
...
- **Why does `cn()` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 43`, `Community 14`, `Community 49`, `Community 19`, `Community 28`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `OrderService` connect `Community 30` to `Community 16`, `Community 18`, `Community 56`, `Community 50`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `ItemService` connect `Community 76` to `Community 32`, `Community 38`, `Community 45`, `Community 16`, `Community 18`?**
