...
## Summary
- 4576 nodes · 7914 edges · 351 communities (333 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf95c49c`
...
## Communities (351 total, 18 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (59): itemVariantFormSchema, VariantFormDialog(), ContactCombobox(), ContactComboboxRole, ContactFormDialog(), ROLE_FILTER_LABELS, metadata, AssignableOrder (+51 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (64): ItemThumbnail(), METHOD_LABELS, useIsMobile(), cn(), PaymentMethod, AlertAction(), AlertDialogMedia(), AlertDialogOverlay() (+56 more)
...
Cohesion: 0.09
Nodes (38): selectBusinessLine(), AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (43): ACTION_LABELS, ItemDetail(), item(), LINE, renderDetail(), UNIT, { unmount }, user (+35 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (35): FormValues, schema, ItemPhotos(), ACTION_LABELS, ReceiptView, CancelOrderButton(), ACTION_LABELS, DELIVERY_LABELS (+27 more)
...
Cohesion: 0.07
Nodes (35): addEntry(), _addRequest(), B(), createHandlerBoundToUrl(), deleteEntry(), fetchDidFail(), fromRequest(), G() (+27 more)
...
Cohesion: 0.09
Nodes (29): LineColorClasses, ExpenseCard(), DetailBody(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS, LineBadge(), ExpenseFilters() (+21 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (21): AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, ItemDetailPage() (+13 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (32): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+24 more)
...
Cohesion: 0.08
Nodes (27): LineSelector(), AppSidebar(), nav, pathname, CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), pathname (+19 more)
...
Cohesion: 0.08
Nodes (25): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemVariantService (+17 more)
...
Cohesion: 0.09
Nodes (23): CategoryChips(), FileDropzone(), FileDropzoneProps, FilePreview(), isImage(), formatFileSize(), DueDateField(), { onChange, user } (+15 more)
...
Cohesion: 0.09
Nodes (26): StatusInput, StatusRow, CANCELADO, REGISTRADO, renombrado, user, DEFAULT_STATUS_SETS, DefaultStatus (+18 more)
...
Cohesion: 0.12
Nodes (18): SessionContext, ExpenseCategoryRow, ExpenseCategoryService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (20): registerDirectSale(), RegisterDirectSaleResult, captureSale, channels, enlaces, products, readSnapshot, saveSnapshot (+12 more)
...
Cohesion: 0.08
Nodes (19): client, inserted, newPhoto, path, row, [archivePayload], channelRow, client (+11 more)
...
Cohesion: 0.13
Nodes (14): user, ThemeToggle(), Header(), MobileContextBar(), OrganizationState, MEMBERSHIPS, ORG, useOrganizationStore (+6 more)
...
Cohesion: 0.12
Nodes (15): countItems(), EMPTY, resolveItems(), SyncCounts, SyncItem, SyncState, items, SESSION (+7 more)
...
Cohesion: 0.12
Nodes (9): StatusService, client, first, inserted, orgRow, params, second, statusRow (+1 more)
...
Cohesion: 0.17
Nodes (14): BoardColumn(), BoardOrder, DraggableCard(), CalendarView(), DELIVERY_LABELS, OrderCard(), OrderCardData, shortDate() (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.16
Nodes (14): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+6 more)

### Community 58 - "Community 58"
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Requirement: Las columnas del tablero salen del juego de estados de la línea, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha (+11 more)
...
Cohesion: 0.18
Nodes (11): amount, CollectionValues, id, method, movement, occurredAt, optionalText, PaymentValues (+3 more)
...
Cohesion: 0.22
Nodes (8): expenses Specification, Requirement: Semilla de egresos de Geeko Store, Requirement: Una compra necesita al menos una línea, Requirements, Scenario: Guardado atómico, Scenario: Intento contra la operación de guardado, Scenario: Intento desde el formulario, Scenario: Reinicio local
...
Cohesion: 0.25
Nodes (7): catalog-directory Specification, Requirement: Pantalla de contactos (V13), Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Filtro por rol, Scenario: Intento de editar un registro archivado, Scenario: Selección sin abandonar la pantalla
...
Cohesion: 0.38
Nodes (3): useOnlineStatus(), registerOfflineOperations(), SyncProvider()
...
Cohesion: 0.29
Nodes (7): 12. Tareas, 13. Adjuntos, code:sql (-- Saldo actual por ítem), code:sql (create table tasks (), code:sql (create table attachments (), code:sql (create policy "storage: solo la propia organización"), Storage
...
Cohesion: 0.33
Nodes (4): amount, onRegistered, [payload], user

### Community 269 - "Community 269"
Cohesion: 0.33
Nodes (6): 11. Vistas derivadas, 8. Egresos, Cobros y pagos, code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Contactos: proveedores, clientes, o ambos)
...
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 34`, `Community 4`, `Community 5`, `Community 6`, `Community 42`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 115`, `Community 23`, `Community 56`, `Community 29`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `PaymentService` connect `Community 66` to `Community 4`, `Community 14`, `Community 57`, `Community 27`, `Community 92`, `Community 286`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `ItemService` connect `Community 100` to `Community 4`, `Community 14`, `Community 47`, `Community 20`, `Community 30`?**
