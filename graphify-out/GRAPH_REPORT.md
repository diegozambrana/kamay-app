...
## Corpus Check
- 778 files · ~656,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7601 nodes · 12553 edges · 590 communities (567 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b3b810b`
...
3. `Button()` - 71 edges
4. `getOwnerContext()` - 67 edges
5. `Input()` - 41 edges
6. `BusinessLine` - 38 edges
7. `ADDED Requirements` - 35 edges
8. `Badge()` - 32 edges
9. `useUserStore` - 31 edges
10. `BusinessLineService` - 30 edges
...
## Communities (590 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (100): DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, Assignee, View, VariantFormDialog(), ContactCombobox(), ContactComboboxRole (+92 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (70): FormValues, schema, ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item() (+62 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (76): LineOption(), LineSelector(), ItemThumbnail(), Count(), useIsMobile(), AppSidebar(), nav, pathname (+68 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (60): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine() (+52 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (66): ActionResult, CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, ItemFormDialog(), ItemForm(), ITEM_KIND_LABELS (+58 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (61): BoardTask, BoardView(), CalendarView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, ListView() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (61): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+53 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (49): backoffDelay(), hasExhaustedAttempts(), esperas, CaptureDeps, CaptureResult, drain, draining, enqueue (+41 more)
...
Cohesion: 0.05
Nodes (43): ACCEPTED_TYPES, ActionResult, archiveExpense(), attachReceipt(), createExpense(), CreateExpenseResult, createPurchase(), revalidateExpenses() (+35 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (38): useOnlineStatus(), ConsumptionDialog(), CountDialog(), Header(), AVISO, bell, MobileContextBar(), tira (+30 more)
...
Cohesion: 0.09
Nodes (34): createTask(), QuickAdd(), ItemPhotos(), CheckoutSheet(), METHOD_LABELS, ExitFairMode(), salida, FileDropzone() (+26 more)
...
Cohesion: 0.07
Nodes (29): getOperation(), ConsumptionRow, ExpenseRow, OrderRow, RecentCaptureService, CaptureKind, dayBoundsInTimezone(), dayOfInstant() (+21 more)
...
Cohesion: 0.08
Nodes (31): a, addEntry(), _addRequest(), _awaitComplete(), B(), deleteEntry(), destroy(), doneWaiting() (+23 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (22): DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon }, upcomingWindow() (+14 more)
...
Cohesion: 0.06
Nodes (21): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), NO_MONEY, OrderFilters, OrderRow, OrderService (+13 more)
...
Cohesion: 0.07
Nodes (26): BestSellerRow, FairProduct, FairSaleService, ProductRow, bolsa, client, maceta, params (+18 more)
...
Cohesion: 0.09
Nodes (27): balanceFromRow(), BalanceRow, movementFromRow(), MovementRow, toNullableNumber(), toNumber(), consumptionSchema, ConsumptionValues (+19 more)
...
Cohesion: 0.13
Nodes (21): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetDetailsForm(), AssetRowView (+13 more)
...
Cohesion: 0.1
Nodes (12): StatusInput, StatusRow, StatusService, DEFAULT_STATUS_SETS, defaultSetAsJson(), DefaultStatus, kinds, positions (+4 more)
...
Cohesion: 0.11
Nodes (18): Destination, destinationOf(), GROUP_LABELS, NotificationList(), NotificationListProps, NotificationRow(), { onMarkAllRead }, { onMarkRead } (+10 more)

### Community 46 - "Community 46"
Cohesion: 0.17
Nodes (27): C(), cacheMatch(), cachePut(), clone(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey() (+19 more)
...
Cohesion: 0.13
Nodes (22): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+14 more)
...
Cohesion: 0.11
Nodes (9): AttachmentRow, AttachmentService, NewAttachment, ItemLastCostService, toNumber(), ItemDetailPage(), metadata, TaskDetailPage() (+1 more)
...
Cohesion: 0.08
Nodes (23): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Fecha comprometida con atajos, Requirement: La columna en cola se ordena por llegada y muestra posición, Requirement: Modelo de pedido con cliente obligatorio, Requirements, Scenario: Atajo «Mañana» (+15 more)
...
Cohesion: 0.17
Nodes (17): SessionContext, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate(), pad() (+9 more)
...
Cohesion: 0.14
Nodes (16): contactFormSchema, ContactFormValues, hasARole(), itemFormSchema, ItemFormValues, itemKindSchema, itemVariantFormSchema, name (+8 more)
...
Cohesion: 0.16
Nodes (11): countItems(), EMPTY, resolveItems(), SyncCounts, SyncState, items, SESSION, onDiscard (+3 more)

### Community 122 - "Community 122"
Cohesion: 0.23
Nodes (13): balance(), cents(), overpayment(), paymentStatus(), safe(), Figure(), PaymentBlock(), money() (+5 more)
...
Cohesion: 0.14
Nodes (13): dashboard Specification, Requirement: El panel carga dentro de su presupuesto, Requirement: El panel es utilizable en un teléfono, Requirement: La variante del ayudante es un diseño propio, sin dinero y sin huecos, Requirements, Scenario: Doce meses sembrados, Scenario: El aterrizaje no cambia, Scenario: Las entregas encabezan su pantalla (+5 more)
...
Cohesion: 0.23
Nodes (7): ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock(), MovementService
...
Cohesion: 0.17
Nodes (11): expenses Specification, Requirement: El último costo de un ítem se deriva de sus compras, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Requirements, Scenario: Comprado dos veces, Scenario: El ayudante no obtiene costos, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta (+3 more)
...
Cohesion: 0.18
Nodes (10): payments Specification, Requirement: Registrar un cobro desde el detalle del pedido, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: Anticipo parcial, Scenario: Cobro del saldo completo, Scenario: El cobro queda en la bitácora, Scenario: El pago queda en la bitácora (+2 more)
...
Cohesion: 0.2
Nodes (8): ADDED Requirements, Purpose, Requirement: Semilla de egresos de Geeko Store, Requirement: Una compra necesita al menos una línea, Scenario: Guardado atómico, Scenario: Intento contra la operación de guardado, Scenario: Intento desde el formulario, Scenario: Reinicio local
...
Cohesion: 0.29
Nodes (7): MarkdownEditor(), MarkdownEditorProps, TOOLS, ToggleGroupContext, ToggleGroupItem(), Toggle(), toggleVariants
...
Cohesion: 0.22
Nodes (6): ContactsScreen(), roleSummary(), andina, archivado, push, user
...
Cohesion: 0.19
Nodes (9): Requirement: Formulario de nuevo pedido (V5), Requirement: Líneas de pedido con precio propio, Scenario: Ambos roles, Scenario: Cantidad no positiva, Scenario: El precio del catálogo cambia después, Scenario: Línea activa preseleccionada, Scenario: Pantalla completa en móvil, Scenario: Precio negativo (+1 more)
...
Cohesion: 0.22
Nodes (8): assets Specification, Requirement: Semilla de activos de Geeko Store, Requirement: Un activo es un destino vinculable válido para una tarea, Requirements, Scenario: Las barras no salen todas iguales, Scenario: Semilla presente tras el reinicio, Scenario: Vínculo a un activo existente, Scenario: Vínculo a un activo inexistente

### Community 294 - "Community 294"
Cohesion: 0.22
Nodes (8): notifications Specification, Requirement: El tipo de insumo bajo mínimo se declara sin generador, Requirement: La generación privilegiada se limita al trabajo programado y a la creación de avisos, Requirements, Scenario: Cada aviso a su organización, Scenario: Disparo sin credencial, Scenario: Nada se rompe por su ausencia, Scenario: Preferencia presente, aviso ausente
...
Cohesion: 0.4
Nodes (4): CatalogScreen(), { result }, { result, rerender }, usePendingToggle()
...
Cohesion: 0.33
Nodes (6): 10. Inventario, 9. Pedidos y ventas, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), code:sql (create table inventory_movements (), Una decisión que conviene revisar
...
Cohesion: 0.5
Nodes (3): created, link, onError

### Community 513 - "Community 513"
Cohesion: 0.5
Nodes (3): monto, onConfirm, { rerender }
...
## Knowledge Gaps
- **4140 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4135 more)
...
- **Why does `cn()` connect `Community 2` to `Community 0`, `Community 225`, `Community 1`, `Community 35`, `Community 4`, `Community 5`, `Community 136`, `Community 41`, `Community 10`, `Community 200`, `Community 13`, `Community 45`, `Community 83`, `Community 85`, `Community 122`, `Community 27`, `Community 61`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `getSessionContext()` connect `Community 3` to `Community 224`, `Community 162`, `Community 34`, `Community 38`, `Community 135`, `Community 136`, `Community 40`, `Community 6`, `Community 12`, `Community 13`, `Community 47`, `Community 82`, `Community 50`, `Community 21`, `Community 53`, `Community 85`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `ItemService` connect `Community 164` to `Community 3`, `Community 68`, `Community 82`, `Community 21`, `Community 53`, `Community 86`?**
