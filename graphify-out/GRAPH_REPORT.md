# Graph Report - kamay-app  (2026-09-14)

## Corpus Check
- 1175 files · ~1,165,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10790 nodes · 18634 edges · 786 communities (761 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 153 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a11a9dc7`
...
## Communities (786 total, 25 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (86): ActivityListProps, ActivityRowItem, metadata, BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd() (+78 more)
...
Cohesion: 0.04
Nodes (93): ActionResult, ActivityRow(), CLASSES, isLineColor(), LINE_COLOR_LABELS, LineColorClasses, LineOption(), LineBadge() (+85 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (65): AccountLayout(), ProfileView, ROLE_LABELS, organization, view, AuthActionResult, emailSchema, enterOrganization() (+57 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (56): ClosingDialogProps, EntryState, DeliverablesSectionProps, TaskFieldsProps, AssignableOrder, useOnlineStatus(), useReturnFocus(), CountDialog() (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (72): archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities, Entity (+64 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (57): selectBusinessLine(), AssetsPage(), metadata, findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+49 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (58): ORIGIN_LABELS, ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item(), LINE (+50 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (56): FormValues, schema, DeclarableAsset, DeclareAssetDialog(), LoginForm(), ContactCombobox(), ContactComboboxRole, CategoryChips() (+48 more)
...
Cohesion: 0.06
Nodes (50): ProfileForm(), RecordHistory, FormValues, schema, DeliveryRow, MonthCashFlow, PENDING_KINDS, UpcomingDelivery (+42 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (47): estado, Redirect, changePassword(), changePasswordSchema, displayNameSchema, ProfileActionResult, updateDisplayName(), loadRecordHistory() (+39 more)
...
Cohesion: 0.05
Nodes (51): registerDirectSale(), RegisterDirectSaleResult, ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock() (+43 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (50): renderMenu(), card(), marca, { onOpen, tarjeta }, renderCard(), renderWith(), renderSection(), area (+42 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (42): AllocationRuleService, GeneralSettingsPage(), metadata, AllocatedLine, allocateSharedExpenses(), AllocationResult, ComparisonRow, composeLegend() (+34 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (41): TaskSheet(), CatalogScope, ContactScope, all, archived, CONTACT, ITEM, SCOPE (+33 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (45): EventDetail, HistoryEntry(), ExpenseCard(), DetailBody(), ExpenseDetail(), ExpenseDetailData, KIND_LABELS, ExpenseFilters() (+37 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (36): NoOrganizationNotice(), signOut(), AppShell(), AppSidebar(), links, nav, pathname, renderSidebar() (+28 more)
...
Cohesion: 0.05
Nodes (26): entregado, moved, order, registrado, renderDetail(), OrderItemRow, OrderItemService, OrderItemWithNames (+18 more)
...
Cohesion: 0.13
Nodes (23): DataTableProps, ACTION_LABELS, ReceiptView, ExpenseItemRow, ExpenseItemWithNames, formatFileSize(), ArchiveWarning(), ArchiveWarningProps (+15 more)
...
Cohesion: 0.05
Nodes (22): original, created, dialog, link, filas, detalle, monto, elapsed (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (25): { result }, MobileContextBar(), tira, MEMBERSHIPS, ORG, useOrganizationStore, countItems(), EMPTY (+17 more)
...
Cohesion: 0.07
Nodes (34): Detail(), ItemThumbnail(), Count(), MarkdownEditor(), MarkdownEditorProps, TOOLS, cn(), Figure() (+26 more)
...
Cohesion: 0.07
Nodes (8): matchesSearch(), normalizeForSearch(), TagRow, TagService, TaskFilters, TaskRow, TaskService, toTask()

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (33): activity, bell, box, button, comparison, deliveries, dialogo, fab (+25 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (28): activityExportFilename(), EXPORT_HEADERS, exportPeriodLabel(), fitsExport(), csv, CsvContext, csvFilename(), CsvTable (+20 more)
...
Cohesion: 0.05
Nodes (39): ADDED Requirements, Purpose, Requirement: A rejected submission keeps the dialog open, Requirement: Archived entries are listed in their own table, Requirement: Configuration lists are tables with a row actions menu, Requirement: Creating a configuration entry happens in a dialog, Requirement: Dialogs return focus to what opened them, Requirement: Editing a configuration entry happens in a dialog (+31 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (23): UnitRow, UnitService, comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone() (+15 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (24): first, row, chunks, csv, download, link, section, started (+16 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (22): EmailMessage, FailingMailer, Mailer, MemoryMailer, emailFor(), escape(), html(), DESTINATARIO (+14 more)
...
Cohesion: 0.1
Nodes (25): relatedTasksFor(), AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetDetailsForm() (+17 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (27): closeTaskWithDeliverables, context, enviado, nombre, nombres, onCancel, onClosed, renderDialog() (+19 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (25): ACCOUNT_ACTION_LABELS, SignOutConfirmDialog(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, card, Item (+17 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (30): useIsMobile(), OrganizationSwitcher(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup() (+22 more)
...
Cohesion: 0.11
Nodes (18): GET(), ArchiveEntry, exportFilename(), files, zipStream(), csvLine(), ExportService, Row (+10 more)
...
Cohesion: 0.11
Nodes (19): PlatformActionResult, OrganizationDetail(), TeamMember, OrganizationSummary, OrganizationOption, OrganizationRow, UserListFilters, UserRow (+11 more)
...
Cohesion: 0.12
Nodes (25): useSignOut(), UserMenu(), CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barHrefOf(), barLabelOf(), bottomBarEntriesFor() (+17 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (25): buildDetail(), ChangePair, DETAIL_MARKERS, DiffRow, isBlankOnCreate(), isPair(), NEVER_SHOWN, referencedIds() (+17 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (8): client, contactRow, inserted, itemRow, productRow, ContactService, ItemService, toNumber()
...
Cohesion: 0.17
Nodes (26): addAccountByEmail(), AddUserResult, addUserToOrganization(), archiveMembership(), assignMemberships(), createOrganization(), firstIssue(), inviteToOrganization() (+18 more)
...
Cohesion: 0.14
Nodes (20): dueSummaryKey(), taskAssignedKey(), taskOverdueKey(), taskReviewKey(), taskStalledKey(), claves, dia1, dia2 (+12 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (20): cantidad, CATALOGO, { onAdd, user }, { onRemove, user }, precio, renderEditor(), TAZA, TAZA_CON_VARIANTES (+12 more)
...
Cohesion: 0.14
Nodes (22): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), revalidateOrders(), setArchived(), setOrderAttachmentArchived() (+14 more)
...
Cohesion: 0.12
Nodes (20): ACTION_LABELS, ActivityFilterBar(), ActivityFiltersProps, FilterOption, ACTIONS, ActivityAction, activityHref(), hasActiveFilters() (+12 more)
...
Cohesion: 0.1
Nodes (17): allocated, allocation, byEqual, byRevenue, direct, fromBreakdown, fromComparison, fromReport (+9 more)

### Community 85 - "Community 85"
Cohesion: 0.15
Nodes (18): ActivityDay, ActivityList(), capitalize(), civilDayOf(), dayLabel(), groupByDay(), longDate(), shiftDays() (+10 more)
...
Cohesion: 0.14
Nodes (16): CartBar(), onCheckout, onRemove, CartLine, cartTotal(), cents(), clear(), removeLine() (+8 more)

### Community 92 - "Community 92"
Cohesion: 0.17
Nodes (15): RetentionJobDeps, emailsFor(), GET(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron() (+7 more)
...
Cohesion: 0.12
Nodes (13): BestSellerRow, FairSaleService, ProductRow, bolsa, client, maceta, params, sale (+5 more)

### Community 107 - "Community 107"
Cohesion: 0.16
Nodes (18): reorderQueue(), BoardColumn(), DraggableCard(), Midpoint, Queueable, queuePositions(), renormalize(), reorderedIds() (+10 more)
...
Cohesion: 0.13
Nodes (7): StatusInput, StatusRow, StatusService, defaultSetAsJson(), metadata, StatusesSettingsPage(), statusFlowSchema
...
Cohesion: 0.1
Nodes (19): orders Specification, Requirement: Confirmación antes de descartar, Requirement: Entradas al alta y a la edición, Requirement: Las líneas de pedido se archivan, nunca se borran, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Desde el detalle, Scenario: Desde el tablero (+11 more)
...
Cohesion: 0.12
Nodes (14): ADDED Requirements, Purpose, Requirement: Fecha comprometida con atajos, Requirement: Líneas de pedido con precio propio, Requirement: Modelo de pedido con cliente obligatorio, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: Cantidad no positiva (+6 more)
...
Cohesion: 0.21
Nodes (9): formatLabel(), hasLabel(), LABEL_COLUMNS, LabelMap, LabelService, referencesOf(), referenceTableOf(), resolveSearch() (+1 more)
...
Cohesion: 0.16
Nodes (14): contactFormSchema, ContactFormValues, hasARole(), itemFormSchema, ItemFormValues, itemKindSchema, name, optionalAmount (+6 more)

### Community 164 - "Community 164"
Cohesion: 0.12
Nodes (16): 6.1 Modelo conceptual — el contrato del sistema, 6.3 Módulo de Tareas, 6.5 Archivado en lugar de eliminación *(decisión tomada)*, 6.6 Imprescindibles (núcleo), 6.7 Deseables (fases posteriores), 6.8 Fuera de alcance, 6. Funcionalidades Clave, Contenido de una tarea (+8 more)
...
Cohesion: 0.15
Nodes (11): SETTINGS_SECTIONS, SettingsGroup, SettingsNav(), SettingsSection, abiertas, enDisco, enMenu, layout (+3 more)
...
Cohesion: 0.13
Nodes (14): id, MoveOrderInput, numeric, optionalDeliveryMode, optionalDueDate, optionalId, optionalText, OrderFormInput (+6 more)
...
Cohesion: 0.31
Nodes (9): cartUnits(), CartState, useCartStore, useCartTotal(), useCartUnits(), ExitFairMode(), salida, FairScreen() (+1 more)
...
Cohesion: 0.31
Nodes (8): AssistantDashboardProps, LowStockItem, PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard(), { container }
...
Cohesion: 0.24
Nodes (10): EXCLUDED_COLUMNS, EXCLUDED_TABLES, EXPORT_TABLES, catalog, catalogTables(), expected, files, organizationTables (+2 more)
...
Cohesion: 0.24
Nodes (9): actorOf(), capitalize(), contract(), DescribableEvent, describeEvent(), recordHref(), SUBJECTS, sentence (+1 more)

### Community 244 - "Community 244"
Cohesion: 0.2
Nodes (9): BoardView(), BoardState, displayedPlacement(), enCola, otra, { pending, pendingQueue }, registro, state (+1 more)
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Desarchivar devuelve el registro intacto, Scenario: Alta y cambio quedan en la bitácora, Scenario: Desarchivar desde el filtro, Scenario: El ayudante llega al catálogo (+2 more)
...
Cohesion: 0.22
Nodes (8): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore
...
Cohesion: 0.18
Nodes (10): catalog-directory Specification, Requirement: Archivar retira de listados y buscadores sin borrar la historia, Requirement: El catálogo no almacena nada derivado, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Inspección de las columnas del catálogo, Scenario: Intento de editar un registro archivado, Scenario: La referencia histórica sobrevive al archivado (+2 more)
...
Cohesion: 0.18
Nodes (10): activity-log Specification, Requirement: Activity log table stores every audited event, Requirement: Existing tables are audited and future tables must opt in at creation, Requirement: Updates record only the fields that changed, Requirements, Scenario: Changes to organizations are logged, Scenario: Invalid action is rejected, Scenario: Single-field update stores only that field (+2 more)
...
Cohesion: 0.22
Nodes (6): ADDED Requirements, Purpose, Requirement: Líneas de compra con precio propio, Scenario: Cantidad no positiva, Scenario: El precio de una compra posterior no reescribe la anterior, Scenario: Precio negativo
...
Cohesion: 0.24
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f4e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.28
Nodes (6): FairProduct, ProductGrid(), boton, { container }, nombres, onPick

### Community 424 - "Community 424"
Cohesion: 0.22
Nodes (8): addLine(), buildSaleEnvelope(), base, carrito, conCliente, maceta, sobre, taza
...
Cohesion: 0.22
Nodes (8): platform-administration Specification, Requirement: A platform admin's profile reflects platform access, Requirement: A platform admin without an active organization gets the platform shell, Requirements, Scenario: Organization-scoped routes need an organization, Scenario: Profile inside a foreign organization, Scenario: Profile without an active organization, Scenario: The platform shell omits organization controls
...
Cohesion: 0.22
Nodes (8): notifications Specification, Requirement: El resumen llega a la hora que cada persona eligió, en la hora local de su organización, Requirement: Ningún hecho genera dos avisos, Requirements, Scenario: Dos horas distintas en la misma organización, Scenario: La zona horaria manda, Scenario: Reejecución sin duplicados, Scenario: Vencida una vez, no cada día
...
Cohesion: 0.4
Nodes (4): LineSelector(), BusinessLineState, LINE, useBusinessLineStore
...
Cohesion: 0.33
Nodes (6): Requirement: Pantalla de catálogo (V10), Scenario: Distintivo de insumo bajo mínimo, Scenario: Fila que abre el detalle, Scenario: Insumo sin mínimo declarado, Scenario: Pestañas por tipo, Scenario: Sin columnas de inventario ni costo
...
Cohesion: 0.4
Nodes (4): ADDED Requirements, Purpose, Requirement: Platform views fit a phone, Scenario: Platform views at 390 px
...
Cohesion: 0.4
Nodes (4): ADDED Requirements, Purpose, Requirement: La bitácora nunca genera notificaciones, Scenario: Actividad intensa, bandeja tranquila
...
Cohesion: 0.33
Nodes (4): DeliveryItem, items, { rerender, container }, UpcomingDeliveries()
...
Cohesion: 0.5
Nodes (4): Requirement: Tablas del catálogo y el directorio con la forma canónica, Scenario: Mismo nombre de variante en ítems distintos, Scenario: Tipo de ítem fuera del juego permitido, Scenario: Variante duplicada dentro del mismo ítem
...
## Knowledge Gaps
- **5728 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+5723 more)
...
- **Why does `useSearchReset()` connect `Community 0` to `Community 13`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `setState()` connect `Community 13` to `Community 0`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 40` to `Community 0`, `Community 2`, `Community 4`, `Community 644`, `Community 7`, `Community 8`, `Community 10`, `Community 17`, `Community 18`, `Community 19`, `Community 273`, `Community 157`, `Community 31`, `Community 34`, `Community 423`, `Community 174`, `Community 51`, `Community 53`, `Community 54`, `Community 64`, `Community 590`, `Community 107`?**
...
- **What connects `config`, `config`, `eslintConfig` to the rest of the system?**
  _5728 weakly-connected nodes found - possible documentation gaps or missing edges._
