...
## Corpus Check
- Large corpus: 868 files · ~719,722 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8029 nodes · 13461 edges · 607 communities (583 shown, 24 thin omitted)
...
## Communities (607 total, 24 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (59): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine() (+51 more)

### Community 1 - "Community 1"
Cohesion: 0.1
Nodes (53): DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, ContactCombobox(), ContactComboboxRole, TaskFieldsProps, CategoryChips(), AssignableOrder (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (64): LineOption(), LineSelector(), ItemThumbnail(), useIsMobile(), AppSidebar(), nav, pathname, NotificationBell() (+56 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (54): useOnlineStatus(), ConsumptionDialog(), CountDialog(), estado, item, onOpenChange, Header(), AVISO (+46 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (47): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), acceptInvitation() (+39 more)
...
Cohesion: 0.05
Nodes (51): AssetCard(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), acquisition, breakdown, detail (+43 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (53): LineBadge(), SIGNAL_CLASSES, SIGNAL_LABELS, TaskCard(), TaskCardData, card(), marca, { onOpen, tarjeta } (+45 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (48): AssetDetailsForm(), ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item(), LINE (+40 more)
...
Cohesion: 0.06
Nodes (46): CalendarView(), ListView(), Assignee, View, MarkdownEditor(), MarkdownEditorProps, TOOLS, ExpenseCard() (+38 more)
...
Cohesion: 0.07
Nodes (45): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+37 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (34): linkTask(), relatedTasksFor(), searchLinkTargets(), unlinkTask(), first, newId, second, list (+26 more)
...
Cohesion: 0.07
Nodes (36): declareDeliverable(), withdrawDeliverable(), ClosingDialog(), ClosingDialogProps, EntryState, closeTaskWithDeliverables, context, enviado (+28 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (22): SessionContext, AttachmentRow, AttachmentService, CopiedAttachment, NewAttachment, ContactService, StatusInput, StatusRow (+14 more)
...
Cohesion: 0.06
Nodes (29): CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user, CheckoutSheet() (+21 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (31): addEntry(), _addRequest(), clone(), deleteEntry(), fetchDidFail(), fromRequest(), G(), getAll() (+23 more)

### Community 25 - "Community 25"
Cohesion: 0.14
Nodes (22): user, ThemeToggle(), ACTION_LABELS, DetailBody(), ReceiptView, formatDateTime(), formatFileSize(), METHOD_LABELS (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (31): emailsFor(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron(), dueSummaryKey(), taskAssignedKey() (+23 more)
...
Cohesion: 0.07
Nodes (34): archiveTask(), attachmentIdSchema, closeTaskSchema, closeTaskWithDeliverables(), closingEntrySchema, completeTask(), completeTaskSchema, createTask() (+26 more)

### Community 34 - "Community 34"
Cohesion: 0.08
Nodes (28): DEFAULT_PREFERENCES, PreferencesRow, resolvePreferences(), resolved, validHour(), metadata, NotificationSettingsPage(), alasSeis (+20 more)
...
Cohesion: 0.17
Nodes (23): PriceHistorySection(), DELIVERY_LABELS, ListView(), ExpenseBreakdownReport(), Group, ProfitabilityReport(), SortKey, ReportChart() (+15 more)
...
Cohesion: 0.11
Nodes (21): emailFor(), escape(), html(), DESTINATARIO, message, trimSlash(), Destination, destinationOf() (+13 more)
...
Cohesion: 0.09
Nodes (24): BoardTask, BoardView(), BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, TaskSheet(), TasksScreen() (+16 more)
...
Cohesion: 0.1
Nodes (20): CaptureKind, dayOfInstant(), lineIdOf(), mergeRecentCaptures(), PENDING_KINDS, pendingCapturesToday(), RecentCapture, ayer (+12 more)
...
Cohesion: 0.08
Nodes (22): DataTable(), DataTableAction, DataTableColumn, DataTableProps, DEFAULT_ROW_ACTIONS, columns, onAction, Row (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (19): ActionResult, linkExpenseToAsset(), message(), revalidateAsset(), saveAssetDetails(), AssetDetailsInput, AssetExpense, AssetFilters (+11 more)
...
Cohesion: 0.1
Nodes (24): Indicator(), IndicatorCards(), IndicatorProps, money(), barPercent(), CashFlow, comparisonScale(), LineCashFlow (+16 more)
...
Cohesion: 0.09
Nodes (18): countItems(), EMPTY, resolveItems(), SyncCounts, SyncItem, SyncState, items, SESSION (+10 more)
...
Cohesion: 0.18
Nodes (25): C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey(), _getNetworkPromise() (+17 more)
...
Cohesion: 0.2
Nodes (24): _(), _addSyncListener(), addToPrecacheList(), B(), Be(), constructor(), E(), Fe() (+16 more)

### Community 61 - "Community 61"
Cohesion: 0.1
Nodes (15): Call, FakeClient, FakeResult, query, result, client, s, service (+7 more)
...
Cohesion: 0.18
Nodes (19): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue() (+11 more)
...
Cohesion: 0.11
Nodes (14): ExpenseCategoryRow, ExpenseCategoryService, metadata, ReportHeader(), LINES, push, { rerender }, url (+6 more)
...
Cohesion: 0.19
Nodes (15): comparisonRows(), DashboardPage(), metadata, localDate(), monthLabel(), monthStartInTimezone(), now, { today, horizon } (+7 more)
...
Cohesion: 0.15
Nodes (16): consumptionSchema, ConsumptionValues, countSchema, CountValues, id, numeric, occurredAt, optionalId (+8 more)

### Community 89 - "Community 89"
Cohesion: 0.16
Nodes (9): LowStockReport(), link, row, ROWS, ExpenseBreakdownRow, lineParam(), LowStockRow, rangeParams() (+1 more)
...
Cohesion: 0.16
Nodes (14): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+6 more)
...
Cohesion: 0.11
Nodes (18): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Entradas al alta y a la edición, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Creación con nombre y teléfono, Scenario: Desde el detalle (+10 more)
...
Cohesion: 0.12
Nodes (13): CatalogRow, CatalogScreen(), bajo, distintivo, LINE, push, sano, UNIT (+5 more)
...
Cohesion: 0.14
Nodes (8): EmailMessage, FailingMailer, Mailer, MemoryMailer, NotificationGenerator, client, mailer, [rows]
...
Cohesion: 0.14
Nodes (14): BoardOrder, OrdersScreen(), alfareriaSet(), codigos, lines, nombres, orders, orgSet (+6 more)
...
Cohesion: 0.29
Nodes (9): AssistantDashboardProps, LowStockCard(), LowStockItem, PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard() (+1 more)
...
Cohesion: 0.14
Nodes (11): ADDED Requirements, Purpose, Requirement: Líneas de pedido con precio propio, Requirement: Las columnas del tablero salen del juego de estados de la línea, Scenario: Cantidad no positiva, Scenario: El precio del catálogo cambia después, Scenario: Línea con juego propio de seis estados, Scenario: Línea con juego propio de tres estados (+3 more)
...
Cohesion: 0.18
Nodes (11): ScopeItem, shortfallRatio(), sortByUrgency(), balances, critico, holgado, huerfano, items (+3 more)
...
Cohesion: 0.26
Nodes (9): ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock(), describeAdjustment(), describeConsumption() (+1 more)
...
Cohesion: 0.14
Nodes (7): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), NotificationService
...
Cohesion: 0.14
Nodes (13): MODIFIED Requirements, Requirement: El vínculo de una tarea con un pedido se guarda desde el primer día, Requirement: Tarjeta de tarea, Scenario: Color de línea con el filtro en Todas, Scenario: Íconos de vínculos y entregables, Scenario: El vínculo sigue la visibilidad de su tarea, Scenario: Fecha límite vencida, Scenario: La marca de cerrada sin entregables es sobria (+5 more)
...
Cohesion: 0.15
Nodes (12): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Todo contacto tiene al menos un rol, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Contacto que es proveedor y cliente a la vez, Scenario: Contacto sin ningún rol (+4 more)
...
Cohesion: 0.25
Nodes (8): KIND_LABELS, movementLabel(), MovementsSection(), signedQuantity(), sortByRecency(), SOURCE_SUFFIX, rows, InventoryMovement

### Community 223 - "Community 223"
Cohesion: 0.18
Nodes (8): ContactsScreen(), roleSummary(), ana, andina, archivado, push, relatedTasksFor, user
...
Cohesion: 0.2
Nodes (9): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Tablas del catálogo y el directorio con la forma canónica, Scenario: Alta y cambio quedan en la bitácora, Scenario: Mismo nombre de variante en ítems distintos, Scenario: Otra organización no ve nada, Scenario: Tipo de ítem fuera del juego permitido (+1 more)
...
Cohesion: 0.2
Nodes (6): ProductRankingReport(), channelNames, itemNames, row, ROWS, ProductRankingRow

### Community 246 - "Community 246"
Cohesion: 0.24
Nodes (10): a, _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), n, o (+2 more)
...
Cohesion: 0.29
Nodes (7): 10. Inventario, 12. Tareas, code:sql (create table orders (), code:sql (create table inventory_movements (), code:sql (create table tasks (), code:sql (create policy "storage: solo la propia organización"), Storage

### Community 401 - "Community 401"
Cohesion: 0.29
Nodes (7): 8. Egresos, 9. Pedidos y ventas, Cobros y pagos, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (-- Contactos: proveedores, clientes, o ambos), Una decisión que conviene revisar
...
Cohesion: 0.4
Nodes (6): 16. Seguridad a nivel de fila (RLS), Bitácora: inalterable de verdad, Cómo se ocultan los costos al ayudante, code:sql (alter table orders enable row level security;), Matriz de acceso, Patrón general
...
Cohesion: 0.4
Nodes (5): 11. Vistas derivadas, 13. Adjuntos, code:sql (create table payments (), code:sql (-- Saldo actual por ítem), code:sql (create table attachments ()
...
## Knowledge Gaps
- **4320 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4315 more)
...
- **Why does `cn()` connect `Community 2` to `Community 1`, `Community 129`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 25`, `Community 38`, `Community 39`, `Community 170`, `Community 42`, `Community 44`, `Community 47`, `Community 48`, `Community 52`, `Community 53`, `Community 199`, `Community 93`, `Community 221`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `AttachmentService` connect `Community 20` to `Community 0`, `Community 33`, `Community 64`, `Community 395`, `Community 172`, `Community 90`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `capture()` connect `Community 88` to `Community 5`?**
