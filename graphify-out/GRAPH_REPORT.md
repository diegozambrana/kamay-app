# Graph Report - kamay-app  (2026-09-09)

## Corpus Check
- 829 files · ~695,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7836 nodes · 13116 edges · 595 communities (569 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a894a1dc`
...
1. `cn()` - 214 edges
2. `getSessionContext()` - 79 edges
3. `Button()` - 75 edges
4. `getOwnerContext()` - 72 edges
5. `Input()` - 43 edges
6. `BusinessLine` - 42 edges
7. `ADDED Requirements` - 35 edges
8. `lineCookieName()` - 33 edges
9. `BusinessLineService` - 33 edges
10. `Badge()` - 32 edges
...
- `NotificationSettingsPage()` --calls--> `getSessionContext()`  [EXTRACTED]
  app/(app)/settings/notifications/page.tsx → lib/auth/session-context.ts
- `boot()` --calls--> `fetch()`  [INFERRED]
  specs/design/# Kamay, gestión operativa/support.js → public/sw.js

## Communities (595 total, 26 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (89): createTask(), BoardTask, BoardView(), CalendarView(), ListView(), QuickAdd(), created, link (+81 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (70): selectBusinessLine(), AppLayout(), AssetsPage(), metadata, getSessionContext(), findActiveLine(), preselectedLineId(), resolveActiveLine() (+62 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (55): DeclarableAsset, DeclareAssetDialog(), assetDetailsSchema, ContactCombobox(), ContactComboboxRole, TaskFieldsProps, AssignableOrder, CostForm() (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (65): AssetDetailsForm(), ACTION_LABELS, ItemDetail(), BALANCE, form, InventoryProps, item(), LINE (+57 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (58): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+50 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (62): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+54 more)
...
Cohesion: 0.05
Nodes (61): ItemThumbnail(), cn(), AlertAction(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+53 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (48): MarkdownEditor(), MarkdownEditorProps, TOOLS, CategoryChips(), LastCostHint, PurchaseEditorLine, PurchaseLineErrors, PurchaseLineNames (+40 more)
...
Cohesion: 0.05
Nodes (42): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+34 more)
...
Cohesion: 0.05
Nodes (38): AllocationRuleService, client, update, GET(), TITLES, GeneralSettingsPage(), metadata, AllocationSettingsInput (+30 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (43): registerDirectSale(), RegisterDirectSaleResult, ActionResult, isDuplicate(), message(), registerConsumption(), registerCountAdjustment(), revalidateStock() (+35 more)
...
Cohesion: 0.05
Nodes (33): AllocatedLine, allocateSharedExpenses(), AllocationResult, ComparisonRow, composeLegend(), distribute(), fromCents(), RULE_LABEL (+25 more)
...
Cohesion: 0.06
Nodes (34): useOnlineStatus(), ConsumptionDialog(), CountDialog(), AppSidebar(), nav, pathname, lineIssuesOf(), OrderForm() (+26 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (30): AssetCard(), LineBadge(), ACTION_LABELS, AssetDetailPanel(), AssetDetailView, ExpenseLine(), AssetRowView, RecoveryBar() (+22 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (29): ACTION_LABELS, DetailBody(), ExpenseDetail(), ExpenseDetailData, ReceiptView, data(), expense(), field (+21 more)
...
Cohesion: 0.08
Nodes (30): columns, onAction, Row, rows, user, ExpenseCard(), KIND_LABELS, ExpenseRows() (+22 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (39): ADDED Requirements, MODIFIED Requirements, org-configuration Specification, Purpose, Requirement: A new business line is usable immediately, Requirement: Archiving hides a line from new work without erasing its history, Requirement: Configuration tables exist with the canonical shape, Requirement: Exactly one shared business line exists and cannot be archived (+31 more)
...
Cohesion: 0.1
Nodes (29): FormValues, schema, DELIVERY_LABELS, TaskDetailProps, TaskFields(), ACTION_LABELS, TaskHistory(), TaskHistoryProps (+21 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (38): ADDED Requirements, MODIFIED Requirements, project-foundation Specification, project-foundation Specification (delta), Purpose, Requirement: Application shell boots with theme switching, Requirement: Continuous integration enforces the pipeline, Requirement: Knowledge graph is versioned and self-updating (+30 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (28): amount, archivedRow, buffer, detail, entry, expenseUrl, nav, papel (+20 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (28): addEntry(), B(), createHandlerBoundToUrl(), deleteEntry(), G(), getAll(), getAllEntriesByQueueName(), getDb() (+20 more)
...
Cohesion: 0.09
Nodes (21): user, ThemeToggle(), Header(), AVISO, bell, MobileContextBar(), tira, OrganizationProvider() (+13 more)
...
Cohesion: 0.08
Nodes (23): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, memberLinesSchema (+15 more)

### Community 37 - "Community 37"
Cohesion: 0.1
Nodes (19): EmailMessage, FailingMailer, Mailer, MemoryMailer, emailFor(), escape(), html(), DESTINATARIO (+11 more)
...
Cohesion: 0.08
Nodes (21): AttachmentPanel(), AttachmentPanelProps, TaskAttachment, enqueued, onDetach, uno, defaultUploader, hasPendingUploads() (+13 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (22): captureSale, channels, enlaces, products, readSnapshot, saveSnapshot, [taza, maceta], countItems() (+14 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (21): ActionResult, linkExpenseToAsset(), message(), revalidateAsset(), saveAssetDetails(), AssetDetailsInput, AssetFilters, AssetService (+13 more)
...
Cohesion: 0.12
Nodes (24): CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), barra, mas, panel, pathname, barHrefOf() (+16 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (27): ADDED Requirements, Purpose, Requirement: La purga exporta y verifica antes de vaciar el detalle, Requirement: La purga resume, nunca borra, Requirement: La retención es una política de la organización, configurable y con valor por defecto, Requirement: La retención solo la ejecuta el sistema, y nunca por sí sola en esta entrega, Requirement: Si la exportación falla, no se vacía nada, Requirement: Solo se vacían los eventos vencidos de la organización tratada (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (24): archiveTask(), attachmentIdSchema, completeTask(), completeTaskSchema, CreateTaskResult, detachFromTask(), moveTaskSchema, moveTaskToStatus() (+16 more)

### Community 50 - "Community 50"
Cohesion: 0.17
Nodes (26): C(), cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), getCacheKey(), _getNetworkPromise() (+18 more)

### Community 51 - "Community 51"
Cohesion: 0.17
Nodes (21): ExpensesPage(), currentMonthRange(), DateRange, isCivilDate(), pad(), resolvePeriod(), startOfDayInTimezone(), startOfNextDayInTimezone() (+13 more)

### Community 52 - "Community 52"
Cohesion: 0.11
Nodes (18): markAllNotificationsRead(), markNotificationRead(), NotificationActionResult, notificationIdSchema, preferencesSchema, saveNotificationPreferences(), NotificationBell(), Destination (+10 more)

### Community 53 - "Community 53"
Cohesion: 0.13
Nodes (18): emailsFor(), POST(), runForOrganization(), TaskWithStatus, resolveMailer(), isAuthorizedCron(), emailsFor(), emitTaskEvents() (+10 more)

### Community 54 - "Community 54"
Cohesion: 0.11
Nodes (19): toggleTaskChecklistItem(), ChecklistItemContext, ChecklistItemHandle, ChecklistPreview(), ChecklistPreviewProps, casillas, HORNADA, onToggle (+11 more)
...
Cohesion: 0.1
Nodes (16): Call, FakeClient, FakeResult, query, result, client, [patch], paymentRow (+8 more)

### Community 58 - "Community 58"
Cohesion: 0.11
Nodes (9): NO_MONEY, OrderFilters, OrderRow, OrderService, OrderTotals, toNumber(), OrderLineValues, Order (+1 more)
...
Cohesion: 0.21
Nodes (23): _(), _addSyncListener(), addToPrecacheList(), ae(), Be(), constructor(), E(), Fe() (+15 more)
...
Cohesion: 0.16
Nodes (15): todo, GEEKO, lineTotals(), localSupabaseEnv(), sellDirect(), signIn(), plan, RUN (+7 more)

### Community 67 - "Community 67"
Cohesion: 0.14
Nodes (13): DEFAULT_PREFERENCES, PreferencesRow, resolvePreferences(), resolved, validHour(), metadata, NotificationSettingsPage(), PreferenceService (+5 more)
...
Cohesion: 0.1
Nodes (21): MODIFIED Requirements, Requirement: Flujo de caja del periodo por línea, Requirement: Movimiento de caja con su línea y su activo, Scenario: Cada movimiento cae en el mes en que ocurrió, Scenario: Cobrado y pagado del mes, Scenario: El activo del pago aparece en la fila, Scenario: El agregado mensual coincide con el detalle, Scenario: El ayudante obtiene cero filas (+13 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (21): ADDED Requirements, Purpose, Requirement: Every data view presents a human error state with retry, Requirement: Every data view presents a loading state with skeletons, Requirement: Every data view presents an initial empty state, Requirement: Filtered-empty is distinct from initially-empty and offers to clear filters, Requirement: The four states are consistent across the application, Requirement: The offline indicator is not one of these states (+13 more)
...
Cohesion: 0.15
Nodes (5): ContactService, matchesSearch(), normalizeForSearch(), TagRow, TagService
...
Cohesion: 0.1
Nodes (16): archived, archivedRow, confirm, contactForm, contactName, detail, form, itemForm (+8 more)
...
Cohesion: 0.1
Nodes (19): Context, D10 · `views_security.test.sql` interroga al catálogo, no a una lista, D11 · El despliegue fija la frontera de secretos con una prueba, no con una convención, D12 · El cambio se ejecuta en dos olas, y `tasks.md` marca la frontera, D1 · Los cuatro estados son un juego de componentes en `components/shared/`, y el nivel de ruta los cablea, D2 · La distinción «vacío inicial» / «sin resultados» la decide el estado de los filtros, no el conteo, D3 · Una prueba recorre `app/` y exige `loading.tsx` y `error.tsx` en todo segmento con datos, D4 · La intermitencia se persigue con `retries: 0` en un trabajo dedicado, no bajando los reintentos del pipeline (+11 more)

### Community 82 - "Community 82"
Cohesion: 0.1
Nodes (19): accessibility Specification, ADDED Requirements, Purpose, Requirement: Board cards can be moved without a pointer, Requirement: Every action is reachable by keyboard, Requirement: Every control has an accessible name, Requirement: Focus is always visible, Requirement: Text and interactive elements meet contrast thresholds (+11 more)
...
Cohesion: 0.11
Nodes (18): Context, D10 · Los filtros son la dirección; la pantalla es un componente de servidor, D11 · El historial contextual es un componente compartido en `components/`, no en `features/`, D12 · El origen se fija en el servidor a partir del agente de usuario, D1 · La lectura filtrada es PostgREST desde `ActivityService`, no una función `security definer`, D2 · Paginación por cursor `(occurred_at, id)`, nunca por desplazamiento, D3 · Tres índices nuevos, y uno viejo que se retira, D4 · Los rótulos de registro se resuelven en lote, una consulta por tabla (+10 more)
...
Cohesion: 0.13
Nodes (13): OwnerDashboard(), OwnerDashboardProps, activity, card, comparison, { container }, deliveries, LOW_STOCK (+5 more)
...
Cohesion: 0.11
Nodes (18): Requirement: Aislamiento, roles y archivado de pedidos, Requirement: Edición de pedido, Scenario: Cambiar fecha y agregar una línea, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita (+10 more)
...
Cohesion: 0.11
Nodes (17): ADDED Requirements, data-export Specification, Purpose, Requirement: A full export produces every table the requester can read, Requirement: Exported values preserve their meaning, Requirement: Exporting is recorded in the activity log, Requirement: The export is available at any moment and reports its progress, Requirement: The export never exceeds what the requester may read (+9 more)
...
Cohesion: 0.12
Nodes (15): activity, bell, box, button, comparison, deliveries, fab, fila (+7 more)

### Community 106 - "Community 106"
Cohesion: 0.12
Nodes (8): count, duraciones, enlaces, gestos, inicio, primera, productos, req

### Community 107 - "Community 107"
Cohesion: 0.25
Nodes (11): AssistantDashboardProps, LowStockItem, Count(), PendingCounts, PendingTasksCard(), LOW_STOCK_PLACEHOLDER, PENDING_TASKS_PLACEHOLDER, PlaceholderCard() (+3 more)

### Community 108 - "Community 108"
Cohesion: 0.26
Nodes (16): ActionResult, archiveOrder(), createOrder(), CreateOrderResult, moveOrderToStatus(), reorderQueue(), revalidateOrders(), setArchived() (+8 more)

### Community 109 - "Community 109"
Cohesion: 0.14
Nodes (4): TaskFilters, TaskRow, TaskService, toTask()
...
Cohesion: 0.12
Nodes (16): Accesibilidad, Capabilities, Copias de seguridad y restauración probada, Despliegue y operación, Estados transversales en toda vista con datos, Exportación completa, Impact, KAM-23 · Endurecimiento y puesta en producción (+8 more)
...
Cohesion: 0.15
Nodes (13): OrdersScreen(), alfareriaSet(), codigos, lines, nombres, orders, orgSet, posiciones (+5 more)

### Community 124 - "Community 124"
Cohesion: 0.16
Nodes (10): BusinessLineState, LINE, useBusinessLineStore, QuickAddLine, resolveQuickAddLine(), archivada, GENERAL, resuelta (+2 more)

### Community 125 - "Community 125"
Cohesion: 0.17
Nodes (11): FILTERS, push, renderScreen(), ROWS, user, cents(), ExpenseSummary, PurchaseLineAmount (+3 more)
...
Cohesion: 0.14
Nodes (13): 0. Condición de arranque, 10. Copias de seguridad y restauración probada (D6, D7), 11. Ola B — bloqueada hasta que existan KAM-17 a KAM-22 (D12), 12. Cierre, 1. Controles de catálogo — el anexo §20 primero (D10), 2. Juego de componentes de estado (D1, D2), 3. Aplicación de los estados a las vistas existentes (D1, D3), 4. Estabilidad de la suite de extremo a extremo (D4) (+5 more)
...
Cohesion: 0.15
Nodes (8): cantidad, CATALOGO, { onAdd, user }, { onRemove, user }, precio, TAZA, TAZA_CON_VARIANTES, { user }
...
Cohesion: 0.18
Nodes (10): useBoardStore, BoardView(), BoardState, displayedPlacement(), enCola, otra, { pending, pendingQueue }, registro (+2 more)

### Community 170 - "Community 170"
Cohesion: 0.15
Nodes (12): 14. Próximos Pasos, 1. Resumen Ejecutivo, 2. Objetivo del Negocio, 4. Tipo de Producto Digital, 9. Necesidad de Datos y Persistencia, Cómo se mide el éxito, Consecuencias de diseño, Justificación (+4 more)
...
Cohesion: 0.15
Nodes (12): Capa de lectura, Capabilities, Historial contextual unificado (V4, V11, V13, V18), Impact, KAM-22 · Bitácora: pantalla, filtros y retención, Modified Capabilities, New Capabilities, Retención y purga (+4 more)
...
Cohesion: 0.17
Nodes (11): byAssignee, client, entrada, filtered, inserted, otra, patch, read (+3 more)
...
Cohesion: 0.27
Nodes (9): BoardColumn(), DraggableCard(), KanbanBoard(), KanbanColumn, BoardColumn(), DraggableCard(), Queueable, queuePositions() (+1 more)
...
Cohesion: 0.18
Nodes (7): CATEGORIES, createExpense, LINES, ORDERS, push, refresh, user
...
Cohesion: 0.18
Nodes (10): catalog-directory Specification, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: El catálogo no almacena nada derivado, Requirement: Tablas del catálogo y el directorio con la forma canónica, Requirements, Scenario: El ayudante llega al catálogo, Scenario: Inspección de las columnas del catálogo, Scenario: Mismo nombre de variante en ítems distintos (+2 more)
...
Cohesion: 0.2
Nodes (7): ADDED Requirements, expenses Specification, Purpose, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta, Scenario: Gasto en General
...
Cohesion: 0.2
Nodes (7): button, completeTask, headings, postponeTask, row, sections, uncompleteTask
...
Cohesion: 0.2
Nodes (10): 10. Inventario, 12. Tareas, 9. Pedidos y ventas, code:sql (-- Ítems: insumos, productos y activos en una sola tabla, di), code:sql (create table orders (), code:sql (create table inventory_movements (), code:sql (create table tasks (), code:sql (create policy "storage: solo la propia organización") (+2 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 240 - "Community 240"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f3e1]:), code:ts (26  |  * suites afirman —`seed_geeko` cuenta la cola de Subl), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 241 - "Community 241"
Cohesion: 0.2
Nodes (10): Requirement: Pantalla de detalle de ítem (V11), Scenario: El ayudante no ve los datos de activo, Scenario: Historial en el detalle, Scenario: Los datos de activo en el detalle de un activo, Scenario: Secciones de inventario en un insumo, Scenario: Sin proveedores habituales ni tareas relacionadas, Scenario: Sin secciones de inventario ni costos, Scenario: Tareas relacionadas en el detalle (+2 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: expect(locator).toContainText(expected) failed), code:yaml (- generic [active] [ref=f1e1]:), code:ts (1   | import { expect, test, type Locator, type Page } from ), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=e1]:), code:ts (36  |       await locator.fill(texto);), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 274 - "Community 274"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f1e1]:), code:ts (80  |), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [ref=f1e1]:), code:ts (5   | const GEEKO_OWNER = "geeko@kamay.test";), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 279 - "Community 279"
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.waitForURL: Test timeout of 30000ms exceeded.), code:yaml (- generic [active] [ref=f1e1]:), code:ts (51  |     let interactions = 0;), Error details, Instructions, Page snapshot, Test info (+1 more)
...
Cohesion: 0.25
Nodes (4): ActivityService, RecentActivityEntry, RecentOptions, client
...
Cohesion: 0.25
Nodes (5): OrderItemRow, OrderItemService, OrderItemWithNames, toNumber(), OrderItem
...
Cohesion: 0.22
Nodes (7): acquisition, breakdown, detail, entries, links, maintenance, AssetExpense
...
Cohesion: 0.22
Nodes (9): 11. Vistas derivadas, 13. Adjuntos, 8. Egresos, Cobros y pagos, code:sql (-- Una sola bandeja: compras (traen material) y gastos (no t), code:sql (create table payments (), code:sql (-- Saldo actual por ítem), code:sql (create table attachments () (+1 more)
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (123 |), Error details, Instructions, Page snapshot, Test info, Test source

### Community 302 - "Community 302"
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: Un registro archivado no se edita sin desarchivarlo, Scenario: Alta y cambio quedan en la bitácora, Scenario: Intento de editar un registro archivado, Scenario: Otra organización no ve nada
...
Cohesion: 0.22
Nodes (8): assets Specification, Requirement: Un activo es un destino vinculable válido para una tarea, Requirement: Un activo sin línea propia no muestra porcentaje, Requirements, Scenario: Activo compartido, Scenario: Sin reparto inventado, Scenario: Vínculo a un activo existente, Scenario: Vínculo a un activo inexistente
...
Cohesion: 0.22
Nodes (8): ADDED Requirements, Purpose, Requirement: El vacío inicial y el resultado sin coincidencias se distinguen, Requirement: La cabecera declara que la bitácora no se edita y cuál es la retención vigente, Scenario: El aviso refleja la política guardada, Scenario: La inmutabilidad se declara, Scenario: Ningún evento coincide, Scenario: Sin eventos todavía
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Page snapshot, Test info, Test source

### Community 315 - "Community 315"
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active]:), code:ts (48  |     const itemUrl = page.url();), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.25
Nodes (8): a, _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), n, o
...
Cohesion: 0.25
Nodes (5): CancelOrderButton(), CANCELADO, REGISTRADO, renombrado, user
...
Cohesion: 0.25
Nodes (7): code:block1 (Error: expect(locator).toContainText(expected) failed), code:yaml (- text: Ningún contacto elegido Elige un contacto de la list), code:ts (192 |   });), Error details, Instructions, Test info, Test source
...
Cohesion: 0.25
Nodes (7): code:block1 (Error: expect(locator).toBeVisible() failed), code:yaml (- main:), code:ts (165 |       });), Error details, Instructions, Test info, Test source
...
Cohesion: 0.25
Nodes (7): code:block1 (Error: expect(locator).toBeVisible() failed), code:yaml (- img), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Test info, Test source
...
Cohesion: 0.25
Nodes (7): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:ts (186 |), Error details, Instructions, Test info, Test source
...
Cohesion: 0.25
Nodes (7): code:block1 (Error: expect(locator).toBeEnabled() failed), code:yaml (- button "Línea de negocio" [disabled]: Alfarería), code:ts (1   | import { expect, test, type Page } from "@playwright/t), Error details, Instructions, Test info, Test source
...
Cohesion: 0.25
Nodes (7): code:block1 (Test timeout of 30000ms exceeded.), code:block2 (Error: page.goto: Test timeout of 30000ms exceeded.), code:ts (78  |     await page.getByRole("button", { name: "Quitar lín), Error details, Instructions, Test info, Test source
...
Cohesion: 0.29
Nodes (7): Requirement: Un buscador único resuelve los tipos vinculables, Scenario: Elegir vincula sin más pasos, Scenario: La búsqueda ignora acentos y mayúsculas, Scenario: Los registros archivados no se ofrecen, Scenario: No se ofrecen registros de otra organización, Scenario: Un destino ya vinculado no se ofrece dos veces, Scenario: Un término encuentra registros de varios tipos

### Community 410 - "Community 410"
Cohesion: 0.29
Nodes (6): ADDED Requirements, Purpose, Requirement: El vínculo refleja el estado actual del registro, nunca una copia, Scenario: El estado del pedido cambia después de vincularlo, Scenario: El nombre del registro cambia después de vincularlo, Scenario: Un destino archivado sigue visible
...
Cohesion: 0.33
Nodes (5): client, inserted, newPhoto, path, row
...
Cohesion: 0.33
Nodes (6): Requirement: Una tarea declara qué debe existir al terminarla, Scenario: Declarar dos entregables, Scenario: El activo no se ofrece todavía, Scenario: No se declara dos veces el mismo tipo, Scenario: Retirar un entregable no cumplido, Scenario: Una tarea puede no declarar ninguno
...
Cohesion: 0.4
Nodes (5): Requirement: Los registros vinculados muestran sus tareas relacionadas, Scenario: Desde la tarea relacionada se llega a la tarea, Scenario: El ayudante solo ve lo que le corresponde, Scenario: El pedido muestra sus tareas, Scenario: Sin tareas relacionadas el bloque queda vacío
...
Cohesion: 0.5
Nodes (4): Requirement: Los pagos alimentan los totales derivados, Scenario: Dos pagos, Scenario: Pago archivado, Scenario: Sin pagos
...
Cohesion: 0.5
Nodes (4): Requirement: Detalle del activo en panel, Scenario: Del gasto a su egreso, Scenario: Detalle con sus gastos, Scenario: Historial del activo
...
Cohesion: 0.5
Nodes (4): Requirement: El asistente ofrece un formulario prellenado por entregable, Scenario: Dos entregables, dos formularios prellenados, Scenario: Lo prellenado se puede cambiar, Scenario: Se elige cuál incluir

### Community 556 - "Community 556"
Cohesion: 0.5
Nodes (4): Requirement: Los vínculos se quitan sin tocar el registro apuntado, Scenario: No hay vínculos duplicados, Scenario: Quitar el vínculo no toca el pedido, Scenario: Se puede volver a vincular
...
Cohesion: 0.5
Nodes (4): Requirement: El detalle del pedido, del ítem, del contacto y de la tarea tienen historial con paso a la bitácora, Scenario: Del historial a la bitácora filtrada, Scenario: El contacto estrena historial, Scenario: Ya no queda ningún aviso de pantalla pendiente

### Community 574 - "Community 574"
Cohesion: 0.67
Nodes (3): Requirement: Desarchivar devuelve el registro intacto, Scenario: Desarchivar desde el filtro, Scenario: El filtro no mezcla
...
## Knowledge Gaps
- **4230 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `TaskLink` (+4225 more)
...
- **Why does `cn()` connect `Community 7` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 27`, `Community 33`, `Community 36`, `Community 41`, `Community 45`, `Community 47`, `Community 52`, `Community 184`, `Community 187`, `Community 63`, `Community 204`, `Community 107`, `Community 121`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `AttachmentService` connect `Community 233` to `Community 1`, `Community 5`, `Community 42`, `Community 138`, `Community 108`, `Community 426`, `Community 49`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 2` to `Community 0`, `Community 33`, `Community 3`, `Community 4`, `Community 36`, `Community 5`, `Community 7`, `Community 40`, `Community 8`, `Community 41`, `Community 12`, `Community 14`, `Community 52`, `Community 21`, `Community 22`, `Community 24`, `Community 27`, `Community 31`?**
