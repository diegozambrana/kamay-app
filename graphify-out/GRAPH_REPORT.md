# Graph Report - kamay-app  (2026-09-04)

## Corpus Check
- 491 files · ~379,493 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4576 nodes · 7914 edges · 351 communities (331 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c84dc9bb`
...
## Communities (351 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (71): ItemThumbnail(), METHOD_LABELS, useIsMobile(), cn(), PaymentMethod, AlertAction(), AlertDialogMedia(), AlertDialogOverlay() (+63 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (60): LineColorClasses, DataTable(), DataTableAction, DataTableColumn, DataTableProps, columns, onAction, Row (+52 more)
...
Cohesion: 0.09
Nodes (49): ItemFormDialog(), ItemForm(), ITEM_KIND_LABELS, ITEM_KIND_SINGULAR, itemVariantFormSchema, VariantFormDialog(), ContactFormDialog(), DEFAULT_ROW_ACTIONS (+41 more)
...
Cohesion: 0.09
Nodes (39): FormValues, schema, ACTION_LABELS, ItemPhoto, ItemPhotos(), VariantsList(), ContactCombobox(), ContactComboboxRole (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (37): AppLayout(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA, SUBLIMACION, CatalogPage() (+29 more)
...
Cohesion: 0.09
Nodes (40): ActionResult, archiveConfigurationItem(), archiveSchema, createBusinessLine(), createExpenseCategory(), createSalesChannel(), createUnit(), entities (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (36): ActionResult, applyOrganizationStatuses(), archiveSchema, archiveStatus(), createOwnStatusSet(), createStatus(), id, reorderSchema (+28 more)
...
Cohesion: 0.09
Nodes (25): LineSelector(), useOnlineStatus(), Header(), MobileContextBar(), useOrganizationStore, countItems(), EMPTY, resolveItems() (+17 more)
...
Cohesion: 0.09
Nodes (28): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+20 more)
...
Cohesion: 0.09
Nodes (26): addEntry(), _addRequest(), B(), createHandlerBoundToUrl(), deleteEntry(), fetchDidFail(), fromRequest(), G() (+18 more)
...
Cohesion: 0.07
Nodes (17): AttachmentRow, AttachmentService, NewAttachment, client, inserted, newPhoto, path, row (+9 more)
...
Cohesion: 0.1
Nodes (23): AppSidebar(), nav, pathname, CAPTURE_ROUTES, isCaptureRoute(), MobileNav(), pathname, isNavEntryActive() (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (21): SessionContext, archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow (+13 more)
...
Cohesion: 0.09
Nodes (27): StatusInput, StatusRow, CANCELADO, REGISTRADO, renombrado, user, DEFAULT_STATUS_SETS, defaultSetAsJson() (+19 more)
...
Cohesion: 0.1
Nodes (21): ItemFilters, ItemRow, ItemVariantService, toNumber(), variantFromRow(), VariantRow, contactFormSchema, hasARole() (+13 more)
...
Cohesion: 0.08
Nodes (23): CostForm(), ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpenseWithTotal, ExpensesScreen() (+15 more)
...
Cohesion: 0.11
Nodes (11): NO_MONEY, OrderFilters, OrderRow, OrderService, OrderTotals, OrderWithTotal, toNumber(), OrderLineValues (+3 more)
...
Cohesion: 0.09
Nodes (16): CatalogRow, CatalogScreen(), LINE, push, UNIT, { unmount }, user, ContactsScreen() (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.09
Nodes (17): client, contactRow, inserted, itemRow, productRow, Call, FakeClient, FakeResult (+9 more)
...
Cohesion: 0.14
Nodes (10): ContactFilters, ContactRow, ContactService, ContactFormValues, ContactsPage(), metadata, matchesSearch(), normalizeForSearch() (+2 more)
...
Cohesion: 0.14
Nodes (16): useCartStore, useCartTotal(), useCartUnits(), CheckoutSheet(), monto, onConfirm, { rerender }, ExitFairMode() (+8 more)
...
Cohesion: 0.17
Nodes (13): ActionResult, registerCollection(), registerPayment(), revalidateExpenses(), revalidateOrder(), voidPayment(), [payload], user (+5 more)

### Community 58 - "Community 58"
Cohesion: 0.14
Nodes (5): StatusService, metadata, StatusesSettingsPage(), statusFlowSchema, StatusesSection()
...
Cohesion: 0.13
Nodes (14): ADDED Requirements, Purpose, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Confirmación antes de descartar, Requirement: Entradas al alta y a la edición, Scenario: Creación con nombre y teléfono, Scenario: Desde el detalle, Scenario: Desde el tablero (+6 more)
...
Cohesion: 0.12
Nodes (15): orders Specification, Requirement: Fecha comprometida con atajos, Requirement: Las columnas del tablero salen del juego de estados de la línea, Requirement: Reordenar la cola renumera al resto, Requirements, Scenario: Atajo «Mañana», Scenario: Borrar la fecha, Scenario: El orden persiste (+7 more)
...
Cohesion: 0.16
Nodes (12): amount, collectionSchema, id, method, movement, occurredAt, optionalText, paymentSchema (+4 more)
...
Cohesion: 0.14
Nodes (13): id, MoveOrderInput, numeric, optionalDeliveryMode, optionalDueDate, optionalId, optionalText, OrderFormInput (+5 more)
...
Cohesion: 0.22
Nodes (9): BoardOrder, CalendarView(), DELIVERY_LABELS, OrderCard(), OrderCardData, shortDate(), { container }, { unmount } (+1 more)
...
Cohesion: 0.21
Nodes (8): MEMBERSHIP, ORG, USER, OrganizationState, MEMBERSHIPS, ORG, MembershipWithOrganization, Organization
...
Cohesion: 0.29
Nodes (6): selectBusinessLine(), LineOption(), BusinessLineState, LINE, useBusinessLineStore, ActiveLine

### Community 129 - "Community 129"
Cohesion: 0.2
Nodes (8): CollectionValues, PaymentValues, DocumentPaid, PaymentRow, client, [patch], paymentRow, [row]
...
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Semilla de catálogo y directorio de Geeko Store, Scenario: El ayudante llega al catálogo, Scenario: La búsqueda de la semilla tolera acentos, Scenario: Semilla presente tras el reinicio
...
Cohesion: 0.29
Nodes (6): expenses Specification, Requirement: Egresos solo en el menú del dueño y redirección por dirección directa, Requirements, Scenario: Ayudante por dirección directa, Scenario: Menú del ayudante, Scenario: Menú del dueño
...
## Knowledge Gaps
- **2300 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2295 more)
...
- **Why does `cn()` connect `Community 0` to `Community 128`, `Community 1`, `Community 3`, `Community 5`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 52`, `Community 21`, `Community 27`, `Community 92`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `PaymentService` connect `Community 61` to `Community 129`, `Community 6`, `Community 18`, `Community 22`, `Community 57`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `ItemService` connect `Community 102` to `Community 6`, `Community 39`, `Community 44`, `Community 18`, `Community 26`, `Community 28`?**
