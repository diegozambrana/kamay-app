# Graph Report - kamay-app  (2026-09-07)

## Corpus Check
- 563 files · ~725,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5412 nodes · 9073 edges · 422 communities (405 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd691fd3`
...
1. `cn()` - 189 edges
2. `getOwnerContext()` - 61 edges
3. `Button()` - 55 edges
4. `getSessionContext()` - 48 edges
5. `ADDED Requirements` - 33 edges
6. `BusinessLine` - 30 edges
7. `Input()` - 30 edges
8. `Requirements` - 28 edges
9. `useUserStore` - 27 edges
10. `Badge()` - 24 edges
...
## Communities (422 total, 17 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (56): moveOrderToStatus(), CLASSES, LineColorClasses, VariantFormDialog(), VariantsList(), DataTable(), DataTableAction, DataTableColumn (+48 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (54): backoffDelay(), hasExhaustedAttempts(), esperas, capture(), CaptureDeps, CaptureResult, drain, draining (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (59): LineOption(), ItemThumbnail(), AppSidebar(), nav, pathname, cn(), DraggableCard(), AlertAction() (+51 more)
...
Cohesion: 0.07
Nodes (44): CatalogRow, CatalogScreen(), LINE, push, UNIT, { unmount }, user, ACTION_LABELS (+36 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (40): selectBusinessLine(), AppLayout(), InviteForm(), findActiveLine(), preselectedLineId(), resolveActiveLine(), ajena, ALFARERIA (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (39): ContactCombobox(), ContactComboboxRole, CategoryChips(), AssignableOrder, FileDropzone(), DiscardGuard(), DueDateField(), { onChange, user } (+31 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (37): CostForm(), occurredAtForDate(), lineIssuesOf(), PurchaseForm(), createContactInline, createPurchase, LINES, push (+29 more)
...
Cohesion: 0.1
Nodes (29): FormValues, schema, ContactsScreen(), ROLE_FILTER_LABELS, roleSummary(), metadata, METHOD_LABELS, Figure() (+21 more)
...
Cohesion: 0.08
Nodes (29): addEntry(), _awaitComplete(), B(), deleteEntry(), destroy(), doneWaiting(), fetchDidFail(), G() (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (29): AuthActionResult, emailSchema, login(), loginSchema, passwordSchema, selectOrganization(), updatePassword(), LoginForm() (+21 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (23): AttachmentRow, AttachmentService, NewAttachment, SalesChannelRow, SalesChannelService, EditOrderPage(), metadata, metadata (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (34): ActionResult, archiveAttachmentSchema, archiveSchema, archiveVariantSchema, createItem(), createItemVariant(), id, revalidateCatalog() (+26 more)
...
Cohesion: 0.09
Nodes (16): client, contactRow, inserted, itemRow, productRow, ItemFilters, ItemRow, ItemService (+8 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (21): LineSelector(), Header(), bell, MobileContextBar(), tira, OrganizationState, MEMBERSHIPS, ORG (+13 more)
...
Cohesion: 0.18
Nodes (20): DataTableProps, ACTION_LABELS, DetailBody(), ReceiptView, useReceiptUploadStore, ExitFairMode(), salida, formatDateTime() (+12 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (18): StatusInput, StatusRow, StatusService, client, first, inserted, orgRow, params (+10 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (22): ExpenseRow, OrderRow, RecentCaptureService, CaptureKind, dayBoundsInTimezone(), dayOfInstant(), lineIdOf(), mergeRecentCaptures() (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (21): acceptInvitation(), archiveMembership(), changeMemberRole(), inviteMember(), InviteResult, inviteSchema, MemberActionResult, membershipSchema (+13 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (20): archive(), list(), listActive(), listAll(), patch(), [archivePayload], channelRow, client (+12 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (21): SessionContext, ExpenseItemService, loadExpenseDetail(), ExpensesPage(), metadata, currentMonthRange(), DateRange, isCivilDate() (+13 more)
...
Cohesion: 0.08
Nodes (22): andina, archivado, push, user, ExpenseItemRow, ExpenseItemWithNames, FairStart(), channels (+14 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (18): ActivityService, RecentActivityEntry, RecentOptions, client, client, inserted, newPhoto, path (+10 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (22): BoardState, displayedPlacement(), enCola, otra, pedido, { pending, pendingQueue }, state, useBoardStore (+14 more)
...
Cohesion: 0.12
Nodes (17): ExpenseDetail(), ExpenseDetailData, ExpenseFilters(), ExpenseFilterValues, ExpenseRows(), ExpensesScreen(), useIsMobile(), isCaptureRoute() (+9 more)
...
Cohesion: 0.09
Nodes (17): amount, archivedRow, buffer, detail, entry, expenseUrl, nav, papel (+9 more)
...
Cohesion: 0.11
Nodes (17): barra, mas, panel, pathname, MEMBERSHIP, ORG, USER, button (+9 more)
...
Cohesion: 0.11
Nodes (10): NO_MONEY, OrderFilters, OrderRow, OrderService, OrderTotals, OrderWithTotal, toNumber(), OrderFormValues (+2 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (13): filas, inerte, LINEAS, countItems(), EMPTY, SyncCounts, SyncItem, SyncState (+5 more)
...
Cohesion: 0.18
Nodes (17): CAPTURE_ROUTES, MobileNav(), barLabelOf(), bottomBarEntriesFor(), isNavEntryActive(), moreEntriesFor(), NAV_ENTRIES, navEntriesFor() (+9 more)
...
Cohesion: 0.22
Nodes (15): registerDirectSale(), RegisterDirectSaleResult, ActionResult, archiveOrder(), createOrder(), CreateOrderResult, reorderQueue(), revalidateOrders() (+7 more)
...
Cohesion: 0.19
Nodes (11): useCartStore, useCartTotal(), useCartUnits(), CheckoutSheet(), monto, onConfirm, { rerender }, FairScreen() (+3 more)
...
Cohesion: 0.16
Nodes (15): BoardColumn(), Midpoint, Queueable, queuePositions(), renormalize(), sortByArrival(), barajado, cola (+7 more)

### Community 78 - "Community 78"
Cohesion: 0.18
Nodes (6): ContactFilters, ContactRow, ContactService, ContactFormValues, matchesSearch(), normalizeForSearch()

### Community 79 - "Community 79"
Cohesion: 0.12
Nodes (16): 14. Próximos Pasos, 1. Resumen Ejecutivo, 2. Objetivo del Negocio, 3.1 Dueño / administrador, 3.2 Ayudante / operador (1 o 2 personas), 3.3 Organizaciones futuras, 3. Público Objetivo, 4. Tipo de Producto Digital (+8 more)

### Community 80 - "Community 80"
Cohesion: 0.12
Nodes (17): Requirement: Aislamiento, roles y archivado de pedidos, Requirement: Edición de pedido, Scenario: Cambiar fecha y agregar una línea, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita, Scenario: El ayudante edita (+9 more)
...
Cohesion: 0.18
Nodes (11): destinationsFor(), isAvailable(), QUICK_DESTINATIONS, QuickDestination, labels, pendientes, venta, vivos (+3 more)
...
Cohesion: 0.12
Nodes (15): orders Specification, Requirement: Cliente creado al vuelo desde el pedido, Requirement: Modelo de pedido con cliente obligatorio, Requirement: Mover un pedido de estado, Requirements, Scenario: Arrastre exitoso, Scenario: Creación con nombre y teléfono, Scenario: Destino fuera del juego de la línea (+7 more)
...
Cohesion: 0.17
Nodes (13): contactFormSchema, hasARole(), itemFormSchema, itemVariantFormSchema, name, optionalAmount, optionalText, quickContactSchema (+5 more)
...
Cohesion: 0.13
Nodes (13): activity, bell, box, button, comparison, deliveries, fab, income (+5 more)
...
Cohesion: 0.2
Nodes (9): catalog-directory Specification, Requirement: Aislamiento entre organizaciones del catálogo y el directorio, Requirement: El catálogo no almacena nada derivado, Requirement: Un registro archivado no se edita sin desarchivarlo, Requirements, Scenario: Alta y cambio quedan en la bitácora, Scenario: Inspección de las columnas del catálogo, Scenario: Intento de editar un registro archivado (+1 more)

### Community 164 - "Community 164"
Cohesion: 0.2
Nodes (9): payments Specification, Requirement: Aislamiento por organización de los movimientos, Requirement: Registrar un pago desde el detalle del egreso, Requirements, Scenario: Crear en organización ajena, Scenario: Destino de otra organización, Scenario: El pago queda en la bitácora, Scenario: Movimientos de otra organización (+1 more)
...
Cohesion: 0.25
Nodes (7): ADDED Requirements, Purpose, Requirement: Catálogo y contactos accesibles desde la navegación base, Requirement: Desarchivar devuelve el registro intacto, Scenario: Desarchivar desde el filtro, Scenario: El ayudante llega al catálogo, Scenario: El filtro no mezcla
...
Cohesion: 0.22
Nodes (8): expenses Specification, Requirement: Semilla de egresos de Geeko Store, Requirement: Un gasto de la línea General queda disponible para el reparto posterior, Requirements, Scenario: Filtrado por "Todas", Scenario: Filtrado por una línea concreta, Scenario: Gasto en General, Scenario: Reinicio local
...
Cohesion: 0.43
Nodes (4): BusinessLineState, LINE, useBusinessLineStore, ActiveLine
...
Cohesion: 0.33
Nodes (6): Requirement: El Markdown rendido se sanea, Scenario: El formato legítimo sobrevive, Scenario: Un atributo de evento se retira, Scenario: Un cuerpo antiguo también se sanea, Scenario: Un enlace con esquema peligroso no navega, Scenario: Un script no se ejecuta
...
## Knowledge Gaps
- **2838 isolated node(s):** `config`, `config`, `eslintConfig`, `nextConfig`, `ATTACHMENT_ENTITY_TYPES` (+2833 more)
...
- **Why does `cn()` connect `Community 2` to `Community 0`, `Community 4`, `Community 6`, `Community 10`, `Community 15`, `Community 16`, `Community 22`, `Community 27`, `Community 33`, `Community 40`, `Community 44`, `Community 48`, `Community 54`, `Community 60`, `Community 73`, `Community 77`, `Community 84`, `Community 87`, `Community 88`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `captureSale()` connect `Community 1` to `Community 75`, `Community 39`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `InvitationService` connect `Community 30` to `Community 67`, `Community 279`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
