...
> Origen: `specs/PRD/kamay-backlog.md` — KAM-22; `specs/PRD/kamay-especificacion-producto-v6.md` — V23, Flujo G; `specs/PRD/kamay-mapa-navegacion-ui.md` §3 (V23), §6 (V2→V23, V4→V23, V18→V23), §7; `specs/PRD/kamay-esquema-base-de-datos-supabase.md` §14; `specs/PRD/ARCHITECTURE.md` (convención 7: un solo historial).
>
> Presupone la bitácora de KAM-03: la tabla `activity_log`, su trigger genérico y sus reglas de acceso. Esta capacidad la lee y la presenta; no la define.
