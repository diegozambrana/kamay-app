...
> Origen: `specs/PRD/kamay-backlog.md` — KAM-05; `specs/PRD/kamay-esquema-base-de-datos-supabase.md` § Estados, §16, § Semilla; `specs/PRD/kamay-especificacion-producto-v6.md` — V22; `specs/PRD/ARCHITECTURE.md` (convención 5: los estados se comparan por `kind`).
