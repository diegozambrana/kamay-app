...
El panel SHALL reservar el sitio de las dos piezas cuyo contenido llega en tareas posteriores —la tarjeta de pendientes y la de insumos bajo mínimo— rindiéndolas con su rótulo definitivo y una leyenda visible de que aún no están disponibles. Un marcador de posición SHALL NOT ofrecer una acción que no funcione ni presentar cifras inventadas, y SHALL ocupar la misma ranura que ocupará su contenido definitivo.

#### Scenario: Los dos marcadores están rotulados

- **WHEN** se abre el panel con cualquiera de los dos roles
- **THEN** las tarjetas de pendientes y de insumos bajo mínimo aparecen con su rótulo y su leyenda de no disponible

#### Scenario: El marcador no engaña

- **WHEN** se observa un marcador de posición
