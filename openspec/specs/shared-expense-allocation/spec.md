# shared-expense-allocation Specification
...
> Origen: `specs/PRD/kamay-backlog.md` — KAM-20 (criterio 3), KAM-04 (lo difiere); `specs/PRD/kamay-especificacion-producto-v6.md` — §6.1 (lo transversal va a General/Compartido), V14, V15, § Decisiones pendientes nº 2; `specs/PRD/kamay-esquema-base-de-datos-supabase.md` §5 (`organizations.settings`), §6 (`is_shared`); `specs/PRD/ARCHITECTURE.md` (convención 4: nada derivado se almacena).
